(function () {
  ...
  var positions = {};
  try {
    positions["-1016645312"] = [
      "#MM_03 > .megamenu > .megamenu-content > .floatRight > div",
      "#content-wrap div.keymatch",
      "#ph_content .kpn-box:eq(0)",
      ".editableContainer .row.block_a:eq(0) div.col-xs-12:eq(0)",
      ".editableContainer .row.block_a:eq(1) div.col-xs-12:eq(0)",
      ".editableContainer .row.block_a:eq(2) div.col-xs-12:eq(0)",
      ".editableContainer .row.block_b:eq(0) div.col-sm-6:eq(0)",
      ".editableContainer .row.block_b:eq(0) div.col-sm-6:eq(1)",
      ".editableContainer .row.block_b:eq(1) div.col-sm-6:eq(0)",
      ".editableContainer .row.block_b:eq(1) div.col-sm-6:eq(1)",
      ".editableContainer .row.block_b:eq(2) div.col-sm-6:eq(0)",
      ".editableContainer .row.block_b:eq(2) div.col-sm-6:eq(1)",
      ".editableContainer .row.block_c:eq(0) div.col-sm-3:eq(0)",
      ".editableContainer .row.block_c:eq(0) div.col-sm-3:eq(1)",
      ".editableContainer .row.block_c:eq(0) div.col-sm-3:eq(2)",
      ".editableContainer .row.block_c:eq(0) div.col-sm-3:eq(3)",
      ".editableContainer .row.block_c:eq(1) div.col-sm-3:eq(0)",
      ".editableContainer .row.block_c:eq(1) div.col-sm-3:eq(1)",
      ".editableContainer .row.block_c:eq(1) div.col-sm-3:eq(2)",
      ".editableContainer .row.block_c:eq(1) div.col-sm-3:eq(3)",
      ".editableContainer a:has(picture):eq(0)",
      ".editableContainer a:has(picture):eq(1)",
      ".editableContainer a:has(picture):eq(2)",
      ".meest-gekozen .overstappen-banner a",
      ".outer_container.row_height_medium",
      "a.logo > img",
      "a:nth-of-type(3)",
      "div#pa_content > h1",
      "div#ph_content > div:nth-of-type(1)",
      "div#ph_content > div:nth-of-type(2)",
      "div#top-banner",
      "div#top-banner > div.inner_container",
      "div#wrapper",
      "div.col-xs-12 > a:nth-of-type(2) > picture",
      "div.container-fluid > a.logo > img",
      "div.container-fluid > div.row > div.col-xs-12",
      "div.disclaimer-text",
      "div.editableContainer > a.normal",
      "div.editableContainer > div.container-fluid > div.row",
      "div.editableContainer > div.container-fluid > div.row > div.col-xs-12",
      "div.editableContainer > p",
      "div.editableContainer > section.banner",
      "div.inner_container:nth-of-type(1)  > div:nth-of-type(2)",
      "div.inner_container:nth-of-type(1)  > div:nth-of-type(4) > a",
      "div.inner_container:nth-of-type(1)  > div:nth-of-type(5) > a",
      "div.inner_container:nth-of-type(1)  > div:nth-of-type(7) > a",
      "div.inner_container:nth-of-type(1) > div:nth-of-type(3)",
      "div.inner_container:nth-of-type(1) > div:nth-of-type(6) > a",
      "div.xs_height",
      "div:nth-of-type(3) > div.col-xs-12",
      "div:nth-of-type(3) > div.inner_container",
      "html > body > header > nav > div.container-fluid > a.logo > img",
      "img#pa_logo",
      "img.single-image",
      "section.banner > picture",
      "section.banner > picture > img",
      "section.banner.bottom_banner > section.banner:eq(0)",
      "section.banner.bottom_banner > section.banner:eq(1)",
      "section.banner.bottom_banner > section.banner:eq(2)",
      "section.bottom_banner",
      "section.bottom_banner > a:nth-of-type(1)",
      "section.bottom_banner > a:nth-of-type(2)",
      "section.top_banner",
      "ul.megamenu > li:nth-of-type(2) > ul.nav-lvl-2 > li.col-md-4",
      "ul.megamenu > li:nth-of-type(2) > ul.nav-lvl-2 > li.col-md-offset-1 > ul.list-unstyled",
      "ul.megamenu > li:nth-of-type(2) > ul.nav-lvl-2 > li.col-md-offset-1 > ul.list-unstyled > li:nth-of-type(1)",
    ];
    positions["-717397376"] = positions["-1016645312"];
    positions["-1583283872"] = positions["-1016645312"];
    positions["1760905024"] = positions["-1016645312"];
    positions["1738985984"] = positions["-1016645312"];
    positions["-1411288128"] = positions["-1016645312"];
    positions["-283180288"] = positions["-1016645312"];
    positions["1382348288"] = positions["-1016645312"];
    positions["-857976608"] = positions["-1016645312"];
    positions["752439232"] = positions["-1016645312"];
    positions["-997165024"] = positions["-1016645312"];
    positions["1253330208"] = positions["-1016645312"];
    positions["277725536"] = positions["-1016645312"];
    positions["-1905291840"] = positions["-1016645312"];
    positions["759750720"] = positions["-1016645312"];
    positions["-788103712"] = positions["-1016645312"];
    positions["1147113568"] = positions["-1016645312"];
    positions["1546881120"] = positions["-1016645312"];
    positions["-1855464256"] = positions["-1016645312"];
    positions["-1154723488"] = positions["-1016645312"];
    positions["-1451542432"] = positions["-1016645312"];
    positions["-535248032"] = positions["-1016645312"];
    positions["290669792"] = positions["-1016645312"];
    positions["1013478208"] = positions["-1016645312"];
    positions["418980096"] = positions["-1016645312"];
    positions["1857464064"] = positions["-1016645312"];
    positions["-624505248"] = positions["-1016645312"];
    positions["-1579409504"] = positions["-1016645312"];
    positions["-1976733184"] = positions["-1016645312"];
    positions["1710376736"] = positions["-1016645312"];
    positions["1317502144"] = positions["-1016645312"];
    positions["-1789926784"] = positions["-1016645312"];
    positions["-1999980448"] = positions["-1016645312"];
    positions["1781318560"] = positions["-1016645312"];
    positions["1007002432"] = positions["-1016645312"];
    positions["-205755488"] = positions["-1016645312"];
    positions["1765006080"] = positions["-1016645312"];
    positions["-1104497760"] = positions["-1016645312"];
    positions["-1506883520"] = positions["-1016645312"];
    positions["62365280"] = positions["-1016645312"];
    positions["701807456"] = positions["-1016645312"];
    positions["1093416512"] = positions["-1016645312"];
    positions["-1827924576"] = positions["-1016645312"];
    positions["791110848"] = positions["-1016645312"];
    positions["-878137504"] = positions["-1016645312"];
    positions["-1904097408"] = positions["-1016645312"];
    positions["1709524384"] = positions["-1016645312"];
    positions["-1703971552"] = positions["-1016645312"];
    positions["-1287465344"] = positions["-1016645312"];
    positions["-2079001280"] = positions["-1016645312"];
    positions["-15693920"] = positions["-1016645312"];
    positions["1140476640"] = positions["-1016645312"];
    positions["-380764192"] = positions["-1016645312"];
    positions["1436408512"] = positions["-1016645312"];
    positions["2023397856"] = positions["-1016645312"];
    positions["-1082084416"] = [
      "#ph_content .box-g-r .media-image",
      "#ph_content h1",
      ".button--service--secondary.button--service--secondary.lightbox_open:contains(Bel de klantenservice)",
      ".button_contactBox:contains(Bel de klantenservice)",
      ".container .package-image",
      "a.mainLogo",
      "div#ph_content > div:nth-of-type(1)",
      "div.col7 > div.no_box > div.row > div.col12",
      "div.footerInfo_content",
      "div.formElement__formWrapper",
      "div.fullWidthBanner > picture > img",
      "div.information",
      "div.layout--4col",
      "div.mainContent_container > div > div:nth-of-type(2)",
      "div.mainContent_container > div > h1",
      "div.mainContent_container > div > p:nth-of-type(2)",
      "div.subnavMT_intro",
      "div.teaser-verlengen-left > h3",
      "html > body > main",
      "li:nth-of-type(6) > div.subNavigation > div > ul.subNavigation_list",
      "main.mainContent .mainContent_container .fullWidthBanner",
      "p.center > img",
      "ul.list-arrow > li > a",
    ];
    positions["639550816"] = positions["-1082084416"];
    positions["-1868690560"] = positions["-1082084416"];
    positions["1235043232"] = positions["-1082084416"];
    positions["-348698912"] = positions["-1082084416"];
    positions["1194350048"] = positions["-1082084416"];
    positions["-2050265184"] = positions["-1082084416"];
    positions["-628750048"] = positions["-1082084416"];
    positions["478410528"] = positions["-1082084416"];
    positions["-1071168416"] = positions["-1082084416"];
    positions["-1890293408"] = positions["-1082084416"];
    positions["673305088"] = positions["-1082084416"];
    positions["-874644992"] = positions["-1082084416"];
    positions["-1815603616"] = positions["-1082084416"];
    positions["518246880"] = positions["-1082084416"];
    positions["1249884608"] = positions["-1082084416"];
    positions["-588210880"] = positions["-1082084416"];
    positions["-2085363936"] = positions["-1082084416"];
    positions["-640020864"] = positions["-1082084416"];
    positions["571148320"] = positions["-1082084416"];
    positions["-926076800"] = positions["-1082084416"];
    positions["-621567520"] = positions["-1082084416"];
    positions["685517504"] = positions["-1082084416"];
    positions["-324397632"] = positions["-1082084416"];
    positions["701807456"] = positions["-1082084416"];
    positions["-1315677824"] = positions["-1082084416"];
    positions["-97290208"] = positions["-1082084416"];
    positions["2140671616"] = positions["-1082084416"];
    positions["854267616"] = positions["-1082084416"];
    positions["-877324000"] = positions["-1082084416"];
    positions["2045871904"] = positions["-1082084416"];
    positions["-2116872512"] = positions["-1082084416"];
    positions["823786912"] = positions["-1082084416"];
    positions["-225430112"] = positions["-1082084416"];
    positions["535205728"] = positions["-1082084416"];
    positions["824548320"] = [
      ".button--service--secondary.button--service--secondary.lightbox_open:contains(Bel de klantenservice)",
      ".button_contactBox:contains(Bel de klantenservice)",
      "main.mainContent .mainContent_container .fullWidthBanner",
    ];
    positions["-935572416"] = positions["824548320"];
    positions["983258848"] = [
      ".slides li:nth-of-type(3)",
      "div#sidebar",
      "div.media-image > img",
    ];
    positions["-2055279744"] = positions["983258848"];
    positions["-344844448"] = positions["983258848"];
    positions["-1703040960"] = positions["983258848"];
    positions["-304398816"] = positions["983258848"];
    positions["71406592"] = positions["983258848"];
    positions["372744224"] = positions["983258848"];
    positions["249585792"] = positions["983258848"];
    positions["-211222816"] = positions["983258848"];
    positions["1576732800"] = positions["983258848"];
    positions["1122732032"] = positions["983258848"];
    positions["136579136"] = positions["983258848"];
    positions["-1637638528"] = positions["983258848"];
    positions["1318617792"] = positions["983258848"];
    positions["666547264"] = positions["983258848"];
    positions["1599042656"] = [
      "div#dateTimeArea > div:nth-of-type(2)",
      "div.serviceInfoMain > a:nth-of-type(9)",
    ];
    positions["1347014048"] = positions["1599042656"];
    positions["-809097792"] = positions["1599042656"];
    positions["834860992"] = positions["1599042656"];
    positions["406894240"] = ["div.bannerTop"];
    positions["-1650055328"] = positions["406894240"];
    positions["736713600"] = positions["406894240"];
  } catch (err) {}
  (function (a) {
    ...
    (function () {
      var InteractionTypeImpl = InteractionType.extend({
        init: function (a, b) {
          ...
          this.context = b ? b : null;
          this.profile = a.profile.getProfile();
        },
        onPrepare: function () {
          var a = this._getParameterByName("cid");
          a && this.profile.setValue("current_cid_code", a);
        },
        _getParameterByName: function (a) {
          a = a.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
          a = RegExp("[\\?&]" + a + "=([^&#]*)").exec(window.location);
          return null == a ? "" : decodeURIComponent(a[1].replace(/\+/g, " "));
        },
      });
      // end of interaction type

      // Register listener 'kpnprelistener':
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://kpn.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.kpnvandaag.nl/
url: https://kpn.blueconic.net/frontend/static/javascript/blueconic/blueconic.min.js
*/
