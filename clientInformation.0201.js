...
(__sco.v1 = __sco.v1 || {}),
  ...
  (__sco.clients = {
    us: [16646, "6517F3F4-17AF-45A3-9CCF-01730A466B34", !0],
    default: [16579, "699bd7e2-7364-4df7-9f72-f632b0a89be0", !0],
  }),
  (__sco.getCorrectIndex = function (e, t, o) {
    for (var s = -1, c = 0; c < e.length; c++)
      e[c][t] && (("f" == o && s == -1) || "l" == o) && (s = c);
    return s;
  }),
  (__sco.baskeType = ""),
  (__sco.checkStatusOne = function () {
    return document.location.href.indexOf("/basket") > -1
      ? ((__sco.basketType = "DESKTOP"), !0)
      : null != _scs(".basket-items-mobile") &&
          ((__sco.basketType = "MOBILE"), !0);
  }),
  (__sco.checkStatusThree = function () {
    return document.location.href.indexOf("/confirmation") > -1;
  }),
  (__sco.scraper.statusone = function () {
    if ("MOBILE" == __sco.basketType) {
      if (
        ("undefined" == __sco.type(__sco.basketMonitor) &&
          ((__sco.basketMonitor = new __sco.monitor()),
          (__sco.basketMonitor.compare = function () {
            return null != _scs(".basket-items-mobile:first")
              ? _scs(".basket-items-mobile:first").innerHTML
              : "";
          }),
          (__sco.basketMonitor.startstate =
            null != _scs(".basket-items-mobile:first")
              ? _scs(".basket-items-mobile:first").innerHTML
              : ""),
        ...
        null != _scs(".item:first") &&
          null != _scs(".basket-items-mobile:first div.item:first"))
      ) {
        try {
          __scd.b.v = _scs(".totalOrderValue:first", "", ["text", "pricecurr"]);
        } catch (e) {
          (e.description = "201 " + (e.description || "")), __sco.error(e);
        }
        try {
          __sco.each(
            _scs(".basket-items-mobile:first div.item", "1 rows"),
            function (e, t) {
              var o = _scs([t, "h3:first a:first"], "101.1 item name", [
                  "text",
                ]),
                s =
                  "gift card" == o.toLowerCase()
                    ? "gift-card"
                    : __sco.inbetween(
                        "/",
                        ".jpg",
                        __sco.attr(
                          _scs([t, "img:first"], "101.2 item id"),
                          "src"
                        ),
                        "ll"
                      ),
                c =
                  __sco
                    .attr(_scs([t, "img:first"], "101.3 item image"), "src")
                    .indexOf("/120/") > -1
                    ? __sco
                        .attr(_scs([t, "img:first"], "101.3 item image"), "src")
                        .split("/120/")
                        .join("/320/")
                    : __sco.attr(
                        _scs([t, "img:first"], "101.3 item image"),
                        "src"
                      ),
                n = __sco.attr(
                  _scs([t, "h3:first a:first"], "101.4 item link"),
                  "href"
                ),
                _ =
                  null != _scs([t, ".basket-item-quantity:first"])
                    ? __sco.inbetween(
                        "- ",
                        " +",
                        _scs(
                          [t, ".basket-item-quantity:first"],
                          "101.5 item qty",
                          ["text"]
                        ),
                        "ff"
                ...
                a = "";
              (c =
                c.indexOf("/bmi/") > -1 && c.indexOf("/templates") > -1
                  ? window.location.protocol +
                    __sco.inbetween("templates/", "", c, "fl")
                  : c.indexOf("window.location.protocol") > -1
                  ? window.location.protocol +
                    __sco.inbetween(window.location.protocol, "", c, "ll")
                  : window.location.protocol + c),
                null != _scs([t, ".basket-item-details"]) &&
                  ((a = __sco.inbetween(
                    "br>",
                    "",
                    _scs(
                      [t, ".basket-item-details:first p:first"],
                      "101.6 item colour"
                    ).innerHTML,
                    "ll"
                  )),
                  (i = __sco.inbetween(
                    ...
                    "",
                    _scs(
                      [t, ".basket-item-details:first p:nth-child(1)"],
                      "101.7 item size"
                    ).innerHTML,
                    "ll"
                  ))),
                "320" != __sco.inbetween("products/", "/", c, "ff")
                  ? (c = c
                      .split(
                        "/" + __sco.inbetween("products/", "/", c, "ff") + "/"
                      )
                      .join("/320/"))
                  : "",
                __scd.b.i.push({
      ...
      "DESKTOP" == __sco.basketType &&
      null != _scs(".basket-items-desktop:first tr.deleteable:first")
    ) {
      "undefined" == __sco.type(__sco.basketMonitor) &&
        ((__sco.basketMonitor = new __sco.monitor()),
        (__sco.basketMonitor.compare = function () {
          return null != _scs(".basket-desktop:first")
            ? _scs(".basket-desktop:first").innerHTML
            : "";
        }),
        (__sco.basketMonitor.startstate =
          null != _scs(".basket-desktop:first")
            ? _scs(".basket-desktop:first").innerHTML
            : ""),
        (__sco.basketMonitor.action = function () {
          __sco.management.prerun();
        ...
        __sco.basketMonitor.start());
      try {
        __scd.b.v = _scs(".totalOrderValue:first", "202.1 basket value", [
          "text",
          "pricecurr",
        ]);
      } catch (e) {
      ...
      try {
        __sco.each(
          _scs(".basket-items-desktop:first tr.deleteable", "2 rows"),
          function (e, t) {
            var o = _scs(
                [t, ".product-name:first h3:first a:first"],
                "102.1 item name",
                ["text"]
              ),
              s =
                "gift card" == o.toLowerCase()
                  ...
                  : __sco.inbetween(
                      ...
                      __sco.attr(
                        _scs(
                          [t, ".product-thumb:first img:first"],
                          "102.2 item id"
                        ),
                        "src"
                      ),
              ...
              c = __sco.attr(
                _scs([t, ".product-thumb:first img:first"], "102.3 item image"),
                "src"
              ),
              n = __sco.attr(
                _scs(
            ...
            if (
              ...
              __sco.inbetween(
                "- ",
                " +",
                _scs([t, ".basket-item-quantity:first"], "", ["text"]),
                "fl"
              )
            )
              var _ = __sco.inbetween(
                "- ",
                " +",
                _scs([t, ".basket-item-quantity:first"], "102.5 item qty", [
                  "text",
                ]),
                "fl"
              );
            ...
            c.indexOf("/bmi/") > -1 &&
              c.indexOf("/templates") > -1 &&
              (c =
                window.location.protocol +
                __sco.inbetween("templates/", "", c, "fl"));
            var r = _scs([t, "td:nth-child(5)"], "102.6 item price", [
                "text",
                "pricecurr",
              ]),
              i = _scs([t, "td:nth-child(3)"], "102.7 item size", ["text"]),
              a = _scs([t, "td:nth-child(2)"], "102.8 item colour", ["text"]);
            "320" != __sco.inbetween("products/", "/", c, "ff")
              ? (c = c
                  .split("/" + __sco.inbetween("products/", "/", c, "ff") + "/")
                  .join("/320/"))
              : "",
              __scd.b.i.push({
                n: o,
  ...
  (__sco.scraper.statustwo = function () {
    try {
      document.location.href.indexOf("/checkout") > -1 &&
        "undefined" == __sco.type(__sco.URLMonitor) &&
        ((__sco.URLMonitor = new __sco.monitor()),
        (__sco.URLMonitor.compare = function () {
          return null != document.location.href ? document.location.href : "";
        }),
        (__sco.URLMonitor.startstate =
          null != document.location.href ? document.location.href : ""),
        (__sco.URLMonitor.action = function () {
          document.location.href.indexOf("/details") > -1
            ? __sco.processonchange()
            : __sco.management.prerun();
        }),
        __sco.URLMonitor.start());
    } catch (e) {
  ...
  (__sco.scraper.statusthree = function () {
    try {
      var e = "";
      null != _scs(".order-number:first")
        ? (e = __sco.text(_scs(".order-number:first")))
        : "object" == typeof dataLayer &&
          "object" ==
            typeof dataLayer[
              __sco.getCorrectIndex(dataLayer, "transactionId", "f")
            ] &&
          "string" ==
            typeof dataLayer[
              __sco.getCorrectIndex(dataLayer, "transactionId", "f")
          ...
          (e =
            dataLayer[__sco.getCorrectIndex(dataLayer, "transactionId", "f")]
              .transactionId),
        (__scd.s.ordernumber = e),
        (__scd.s.S3Referrer = document.referrer),
        (__scd.s.S3URL = document.location.href);
    } catch (e) {
  ...
  (__sco.management.main = function () {
    ...
    try {
      if (
        ...
        (__sco.region = ""),
        document.location.href.indexOf("us.allsaints") > -1
          ? (__sco.region = "us")
          : (__sco.region = "default"),
        __sco.management.canexec() &&
          ("www.allsaints.com" == document.domain ||
            "www.us.allsaints.com" == document.domain))
      ) {
        if (
        ...
        try {
          (__sco.config.doc.i1 = __sco.clients[__sco.region][0]),
            (__sco.config.timestamptemplate.i1 =
              __sco.clients[__sco.region][0]),
            (__sco.config.v1guid = __sco.clients[__sco.region][1]),
            (__sco.config.live = __sco.clients[__sco.region][2]);
        } catch (e) {
        ...
        try {
          if (__sco.management.isstatus(__sco.config.status3)) {
            var t = "";
            null != _scs(".order-number:first")
              ? (t = __sco.text(_scs(".order-number:first")))
              : "object" == typeof dataLayer &&
                "object" ==
                  typeof dataLayer[
                    __sco.getCorrectIndex(dataLayer, "transactionId", "f")
              ...
              (__sco.config.timestamptemplate.s.ordernumber = t),
              (__sco.config.timestamptemplate.s.S3Referrer = document.referrer),
              (__sco.config.timestamptemplate.s.S3URL = document.location.href);
          }
        } catch (e) {
          (e.title = "MAIN__ClientDecision__"),
            __sco.config.v1 &&
  ...
  (_scs = function (e, t, o) {
    ...
    function i(e, t, o) {
      ...
      return (
        (1 !== e.nodeType && 9 !== e.nodeType) ||
          (t
            ? ((t = __sco.attr(e, o.match(m.ATTR)[1])),
              null != t &&
                null != t.match(new RegExp("^" + o.match(m.ATTR)[5] + "$")) &&
                (s = s.concat(__sco.toarray(e))))
            : ((e = e.getElementsByTagName("*")),
              __sco.each(e, function (e, t) {
                var c = __sco.attr(t, o.match(m.ATTR)[1]);
                null != c &&
                  null != c.match(new RegExp("^" + o.match(m.ATTR)[5] + "$")) &&
    ...
    function a(e, t, o) {
      ...
      return (
        (1 !== e.nodeType && 9 !== e.nodeType) ||
          (t
            ? null != __sco.attr(e, s(o.match(m.ATTR)[1])) &&
              (c = c.concat(__sco.toarray(e)))
            : ((e = e.getElementsByTagName("*")),
              __sco.each(e, function (e, t) {
                __sco.attr(t, s(o.match(m.ATTR)[1])) &&
    ...
    function l(e, t, o, u) {
      if (null != t) {
        if (null != e.match(m.ID)) {
          f[o] = __sco.ltrim(f[o].replace(e.match(m.ID)[0], ""));
          var p = document.getElementById(s(e.match(m.ID)[1])),
            p = null == p ? null : p.id != s(e.match(m.ID)[1]) ? null : p;
          return "" === f[o] ? p : l(f[o], p, o, 1);
        }
        if (null != e.match(m.TAG))
          return (
            (f[o] = __sco.ltrim(f[o].replace(e.match(m.TAG)[0], ""))),
            (p = []),
            "htmlelement" != __sco.type(t) && 0 < t.length
              ? __sco.each(t, function (t, o) {
                  1 === o.nodeType &&
                    (p = p.concat(
                      __sco.toarray(
                        o.getElementsByTagName(s(e.match(m.TAG)[0]))
                      )
                    ));
                })
              : (p =
                  "htmlelement" != __sco.type(t) && 0 == t.length
                    ...
                    : p.concat(
                        __sco.toarray(
                          t.getElementsByTagName(s(e.match(m.TAG)[0]))
                        )
                      )),
            "" === f[o]
              ? 0 === p.length
        ...
        if (null != e.match(m.CLASS))
          return (
            (f[o] = __sco.ltrim(f[o].replace(e.match(m.CLASS)[0], ""))),
            (p = []),
            ...
            -1 <
                ...
                ? __sco.each(t, function (t, o) {
                    1 === o.nodeType &&
                      (p = u
                        ...
                        : p.concat(
                            __sco.toarray(
                              o.getElementsByClassName(s(e.match(m.CLASS)[1]))
                            )
                          ));
                  })
                : (p = p.concat(
                    __sco.toarray(
                      ("htmlelement" != __sco.type(t) && 0 == t.length
                        ? document
                        : t
                      ).getElementsByClassName(s(e.match(m.CLASS)[1]))
                    )
                  ))
              : "htmlelement" != __sco.type(t) && 0 < t.length
              ? __sco.each(t, function (t, o) {
              ...
              : (p =
                  "htmlelement" != __sco.type(t) && 0 == t.length
                    ...
                    ? p.concat(
                        __sco.toarray(
                          _(__sco.toarray(t), s(e.match(m.CLASS)[1]))
                        )
                      )
                    : p.concat(
                        __sco.toarray(
                          _(t.getElementsByTagName("*"), s(e.match(m.CLASS)[1]))
                        )
                      )),
            "" === f[o]
              ? 0 === p.length
        ...
        if (null != e.match(m.ATTR))
          return (
            (f[o] = __sco.ltrim(f[o].replace(e.match(m.ATTR)[0], ""))),
            (p = []),
            "undefined" != typeof e.match(m.ATTR)[5]
              ? "htmlelement" != __sco.type(t) && 0 < t.length
                ? __sco.each(t, function (t, o) {
                    p = p.concat(i(o, u, e));
                  })
        ...
        if (null != e.match(m.CHILD)) {
          var g = e.match(m.CHILD),
            p = [];
          if (
            ((f[o] = __sco.ltrim(f[o].replace(e.match(m.CHILD)[0], ""))),
                ...
                "undefined" != __sco.type(g[2])
                  ? "htmlelement" != __sco.type(t) && 0 < t.length
                    ? __sco.each(t, function (e, t) {
                        p = p.concat(__sco.toarray(c(t.childNodes, g[2])));
                      })
                    : (p =
                        "htmlelement" != __sco.type(t) && 0 == t.length
                          ? []
                          : p.concat(__sco.toarray(c(t.childNodes, g[2]))))
                  : "htmlelement" != __sco.type(t) && 0 < t.length
                  ? __sco.each(t, function (e, t) {
            ...
            if ("elemp" == g[1])
              return (
                "htmlelement" != __sco.type(t) && 0 < t.length
                  ? __sco.each(t, function (e, t) {
                      p = p.concat(__sco.toarray(r(s(g[2]), t)));
                    })
                  : (p =
                      "htmlelement" != __sco.type(t) && 0 == t.length
                        ? []
                        : p.concat(__sco.toarray(r(s(g[2]), t)))),
                "" === f[o]
                  ? 0 === p.length
                    ? null
                    : p
...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    var r = n(64),
      ...
      u = {
        ...
        phone: { mobile: ["#details-telephone"] },
      },
      s = (function () {
        function e(e) {
          this.api = e;
        ...
        return (
          (e.prototype.client = function () {
            var e = this.api;
            return e.fluent.request.url().includes("us.allsaints", !0)
              ? { apiKey: "6517F3F4-17AF-45A3-9CCF-01730A466B34", v1Id: 16646 }
              : { apiKey: "699bd7e2-7364-4df7-9f72-f632b0a89be0", v1Id: 16579 };
          }),
          (e.prototype.isPurchaseComplete = function () {
            return this.api.fluent.request.url().includes("/confirmation", !0);
          }),
          (e.prototype.scrapers = function () {
            var e = this.api;
            return {
              basket: function () {
                var t = e.fluent.querySelector(".basket-items-mobile"),
                  n = e.fluent.querySelectorAll(
                    ".basket-items-mobile div.deleteable"
                  ),
                  i = window.universal_variable,
                  a = i.basket.line_items;
                return t.exists() && i && a
                  ? n.length() !== a.length
                    ? r.default(e)
                    : o.default(e)
              ...
              order: function () {
                ...
                if (
                  e &&
                  "undefined" !=
                    typeof e[a.correctIndex(e, "transactionId", "f")] &&
                  "string" ==
                    typeof e[a.correctIndex(e, "transactionId", "f")]
                      .transactionId
                )
                  return {
                    id:
                      e[a.correctIndex(e, "transactionId", "f")].transactionId,
                  };
                var t = window.universal_variable;
                return t && t.transaction && t.transaction.order_id
                  ? { id: t.transaction.order_id }
                  : null;
              },
              product: function () {
                return i.default(e);
          ...
          (e.prototype.triggers = function () {
            ...
            return (
              ...
              e.push.apply(e, u.phone.mobile),
              {
                events: { change: e },
                watch: [
                  { selector: ".basket-items-mobile" },
                  { selector: ".basket-options" },
                ],
              }
            );
          }),
  ...
  function (e, t) {
    ...
    function n(e) {
      var t = window.universal_variable,
        n = t.basket.line_items;
      if (!t && !n) return null;
      var r = {};
      r.items = n.map(function (e) {
        var t = !0,
          n = e.product.name,
          r = e.product.id,
          o = e.product.url,
          ...
          a = e.product.color,
          u = e.product.size,
          s = parseFloat(e.product.current_price).toFixed(2),
          c = e.product.image_url;
        (c = c.replace("/600/", "/900/")),
          (c = c.replace("/120/", "/900/")),
          (c = c.replace("/320/", "/900/"));
        var l = e.product.currency;
        return {
          product: {
            color: { value: a },
            costs: { singleItem: s },
      ...
      var o = e.fluent.querySelector("div.promo-details"),
        i = parseFloat(t.basket.total).toFixed(2),
        a = i,
        u = "";
      return (
        o.exists() &&
          !o.getAttribute("style").exists() &&
          ((u = e.fluent.getTextContent("span.totalOrderDiscount").done()),
          (a = e.fluent.getTextContent("span.newTotalOrderValue").done())),
        (r.costs = { subtotal: i, total: a }),
        (r.discount = { cost: u }),
        r
      );
    }
  ...
  function (e, t) {
    ...
    function n(e) {
      var t = e.fluent.querySelector(".basket-items-mobile"),
        n = {};
      n.items = t
        .querySelectorAll("div.deleteable")
        .map(function (e) {
          var t = !0,
            n = e.getTextContent("h3 a").done(),
            r = e.querySelector("h3 a").getAttribute("href").done(),
            o = e
              .getTextContent("div.grid p.basket-item-quantity")
              .between("-", "+")
              .toInt()
              .done(),
            i = e
              .getTextContent("div.grid p")
              .replace(/COLOUR  /, "")
              .done(),
            a = e
              .getTextContent("div.grid p:nth-child(2)")
              .replace(/SIZE /, "")
              .done(),
            u = e
              .getTextContent("h3")
              .done()
              .replace(n + " ", ""),
            s = e.querySelector("div.grid img").getAttribute("src").done();
          (s = s.replace("/600/", "/900/")),
            (s = s.replace("/120/", "/900/")),
            (s = s.replace("/320/", "/900/"));
          var c = s.substring(s.lastIndexOf("/") + 1, s.indexOf(".jpg") - 2);
          return {
            product: {
              color: { value: i },
              costs: { singleItem: u },
            ...
            quantity: o,
            tagBag: { f2: "html_basket" },
          };
        })
        .done();
      var r = e.fluent.querySelector("div.promo-details"),
        o = e.fluent
          .getTextContent("span.mini-basket-total span.basket-total")
          .done(),
        i = o,
        a = "";
      return (
        r.exists() &&
          !r.getAttribute("style").exists() &&
          ((a = e.fluent.getTextContent("span.totalOrderDiscount").done()),
          (i = e.fluent.getTextContent("span.newTotalOrderValue").done())),
        (n.costs = { subtotal: o, total: i }),
        (n.discount = { cost: a }),
        n
      );
    }
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("#product-information"),
        n = e.fluent.querySelector("#image img");
      if (
        (!window.universal_variable && !window.universal_variable.product) ||
        (!t.exists() && !n.exists())
      )
        return null;
      var r, o, i, a, u;
      if (window.universal_variable && window.universal_variable.product) {
        var s = window.universal_variable.product;
        (r = s.name.replace(/&quot;/g, "")),
          (o = parseFloat(s.current_price).toFixed(2)),
          (i = s.image_url),
          (a = s.url),
          (u = s.id);
      } else
        (r = e.fluent.getTextContent("div.product_name div").done()),
          (o = e.fluent.getTextContent("div.product_name span").done()),
          (i = n.getAttribute("src").done()),
          (a = e.fluent.request.url().done()),
          (u = i.substring(i.lastIndexOf("/") + 1, i.indexOf(".jpg") - 2));
      var c = e.fluent.request.url().includes("us.allsaints", !0)
        ? "USD"
        : "GBP";
      return {
        costs: { singleItem: o },
...
/*
page: http://www.allsaints.com/
url: https://d16fk4ms6rqz1v.cloudfront.net/capture/allsaints.js
*/
