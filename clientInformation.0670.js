function checkCart() {
  if (__sco.contains(__sco.loc, "/bag")) return (cartType = "mainBasket"), !0;
  if (!__sco.contains(__sco.loc, "/bag")) {
    if (
      _scs("div.mini-cart-content") &&
      null != _scs("div.mini-cart-content:first div.mini-cart-products") &&
      "undefined" != typeof universal_variable &&
      "undefined" != typeof universal_variable.basket &&
      "undefined" != typeof universal_variable.basket.line_items
    )
      return (cartType = "miniBasket"), !0;
    (null == _scs("#add-to-cart") && null == _scs("li.grid-tile")) ||
      ("undefined" == __sco.type(__sco.miniCartmonitor) &&
        ((__sco.miniCartmonitor = new __sco.monitor()),
        (__sco.miniCartmonitor.compare = function () {
          return null != _scs("#mini-cart") ? _scs("#mini-cart").innerHTML : "";
        }),
        (__sco.miniCartmonitor.startstate = function () {
          return null != _scs("#mini-cart") ? _scs("#mini-cart").innerHTML : "";
        }),
        (__sco.miniCartmonitor.action = function () {
          __sco.mainrun ? __sco.management.prerun() : __sco.management.main();
        }),
        __sco.miniCartmonitor.start()));
  }
  return !1;
}
function checkStatusThree() {
  return !(
    !__sco.contains(
      _scs("div.page-header:first h1:first", "", ["text"]),
      "Order confirmation"
    ) || !__sco.contains(_scs("title", "", ["text"]), "Checkout Confirmation")
  );
}
...
(__sco.v1 = __sco.v1 || {}),
  ...
  (__sco.config = {
    ...
    startdate: 0,
    guid: "",
    v1guid: "b2c6b001-aaad-460a-b53f-ce4bf8682381",
    triggers: ["exit", "timeout"],
    status1: [checkCart],
    status2: ["STATUSTWO"],
    status3: [checkStatusThree],
    status4: ["STATUSFOUR"],
    ...
    onchange: {
      email: [
        ...
        "input.email:first",
        "input.email:nth-child(1)",
        "input.email:nth-child(2)",
        "input.email-input:first",
        "input.email-input:nth-child(1)",
        "input.email-input:nth-child(2)",
      ],
      first: [
      ...
      telephone: ["#dwfrm_profile_customer_phone"],
      mobile: [],
      salutation: [],
      optout: [],
    },
...
(__sco.checkStatusTwo = function () {
  return !checkCart() && !checkStatusThree();
}),
  (__sco.scraper.statusone = function () {
    if (
      ((__scd.s.subject = "Donât miss out on your items"),
      "" != __scd.c.f &&
        (__scd.s.subject = "Donât miss out on your items, " + __scd.c.f),
      "miniBasket" == cartType)
    ) {
      "undefined" != __sco.type(__sco.miniCartmonitor) &&
        __sco.miniCartmonitor.stop(),
        "undefined" == __sco.type(__sco.totalmonitor) &&
          ((__sco.totalmonitor = new __sco.monitor()),
          (__sco.totalmonitor.compare = function () {
            return _scs("#mini-cart") ? _scs("#mini-cart").innerHTML : "";
          }),
          (__sco.totalmonitor.startstate = _scs("#mini-cart")
            ? _scs("#mini-cart").innerHTML
            : ""),
      ...
      try {
        "null" ==
        _scs(
          "#mini-cart div.mini-cart-total:first span.mini-cart-total-label",
          "0 total price",
          ["text"]
        )
          ? (__scd.b.v = __sco.pricecurr(
              universal_variable.basket.subtotal.toFixed(2)
            ))
          : (__scd.b.v = _scs(
              "#mini-cart div.mini-cart-total:first span.mini-cart-total-label",
              "0 total price",
      ...
      try {
        __sco.each(
          ...
          function (t, e) {
            if (null == _scs([e, ".promo:first"])) {
              var s = _scs(
                  [e, "div.mini-cart-name:first a:first"],
                  "2 item name",
                  ["text"]
                ),
                o = __sco.inbetween(
                  ...
                  ".html",
                  __sco.attr(
                    _scs([e, "div.mini-cart-name:first a:first"], "3 item id"),
                    "href"
                  ),
                  "lf"
                ),
                c = __sco.attr(
                  _scs([e, "div.mini-cart-name:first a:first"], "4 item url"),
                  "href"
                ),
                n = "",
                _ = null;
              __sco.each(universal_variable.basket.line_items, function (t, e) {
                e.product.id == o && (_ = e);
              }),
                (n = __sco.contains(
                  __sco.attr(
                    _scs(
                      [e, "div.mini-cart-image:first img:first"],
                      "4.11 image check"
                    ),
                    "src"
                  ),
              ...
              var r = _scs(
                  [e, "div.mini-cart-pricing:first span.value"],
                  "7 wty",
                  ["text"]
                ),
                i = __sco.pricecurr(
                  _scs(
                    [
                      e,
                      "div.mini-cart-pricing:first span.mini-cart-price-total",
                    ],
                    "8 temp price",
                    ["text"]
                  ) || _.subtotal.toFixed(2)
                ),
                a = parseFloat(i / r).toFixed(2),
                l =
                  null !=
                  _scs([
                    e,
                    "div.mini-cart-attributes:first div.attribute:first span",
                  ])
                    ? _scs(
                        [
                          e,
                          "div.mini-cart-attributes:first div.attribute:first span.value",
                        ],
                        "9 size",
                        ["text"]
                      )
                ...
                u =
                  ...
                  _scs([
                    e,
                    "div.mini-cart-attributes:first div.attribute:last span",
                  ])
                    ? _scs(
                        [
                          e,
                          "div.mini-cart-attributes:first div.attribute:last span.value",
                        ],
                        "10 colour",
                        ["text"]
                      )
      ...
      ("undefined" == __sco.type(__sco.totalmonitor) &&
        ...
        __sco.totalmonitor.start()),
      null != _scs("#cart-table tbody:first tr.cart-row"))
    ) {
      try {
        __scd.b.v = _scs(
          "div.cart-footer:first tr.order-subtotal:first td:last",
          "0.1 total price",
          ["text", "pricecurr"]
        );
      } catch (t) {
      ...
      try {
        __sco.each(
          _scs("#cart-table tbody:first tr.cart-row", "1.1 rows"),
          function (t, e) {
            if (null == _scs([e, ".promo:first"])) {
              if (
                null !=
                _scs([
                  e,
                  "td.item-details:first div.product-list-item:first div.name:first a:first",
                ])
              )
                var s = _scs(
                  [
              ...
              else if (null != _scs([e, ".name:first"]))
                var s = _scs([e, ".name:first"], "s101 item name", ["text"]);
              if (
                null !=
                _scs([
                  e,
              ...
              else if (null != _scs([e, ".sku .value:first"]))
                var o = _scs([e, ".sku .value:first"], "s102 item id", [
                  "text",
                ]);
              if (
                null !=
              ...
              else if (null != _scs([e, ".name:first a:first"]))
                var c = __sco.attr(
                  _scs([e, ".name:first a:first"], "s102 item link"),
                  "href"
                );
              var n = "";
              n = __sco.contains(
                __sco.attr(
                  _scs([e, "td.item-image:first img:first"], "4.0 image"),
                  "src"
                ),
                "edgesuite"
              )
                ? __sco.attr(
                    _scs([e, "td.item-image:first img:first"], "4.1 image"),
                    "src"
                  )
                : "http://www.mandco.com" +
                  __sco.attr(
                    _scs([e, "td.item-image:first img:first"], "5.1 image"),
                    "src"
                  );
              var _ = _scs(
                [e, "td.item-quantity:first div.set-quantity input"],
                "6.1 qty",
                ["getvt"]
              );
              if (
                null == _scs([e, "td.item-price:first div.price-current"]) &&
                null != _scs([e, "div.price-promotion"])
              )
                var r = _scs(
                  [e, "div.price-promotion:first span.price-sales:first"],
                  "7.1 now price",
                  ["text", "pricecurr"]
                );
              else if (
                ...
                _scs([
                  e,
                  "td.item-price:first div.price-current:first span.price-sales",
                ])
              )
                var r = _scs(
                  [
              ...
              var i =
                  null != _scs([e, "td.item-details div.attribute:first span"])
                    ? _scs(
                        [e, "td.item-details div.attribute:first span.value"],
                        "7.3 size",
                        ["text"]
                      )
                    : "",
                a =
                  null != _scs([e, "td.item-details div.attribute:last span"])
                    ? _scs(
                        [e, "td.item-details div.attribute:last span.value"],
                        "7.4 colour",
                        ["text"]
                      )
                    : "",
  ...
  (__sco.scraper.statusthree = function () {
    try {
      "undefined" != typeof order_id && "string" == typeof order_id
        ? (__scd.s.ordernumber = order_id)
        : (__scd.s.ordernumber = _scs(
            "li.order-number:first span.value:first",
            "",
            ["text"]
          ));
    } catch (t) {
  ...
  (__sco.scraper.onchange = function (t, e) {
    try {
      ("undefined" != typeof __scd.s.subject && "" != __scd.s.subject) ||
        (__scd.s.subject = "Donât miss out on your items"),
        "first" == e &&
          "" != t &&
          (__scd.s.subject = "Donât miss out on your items, " + t);
    } catch (t) {
  ...
  (__sco.management.main = function () {
    ...
    try {
      if (
        ...
        if (((__sco.mainrun = !0), !__sco.support.setsupport()))
        ...
        if (
          ...
          if (
            ...
            __sco.support.storeprovider ||
              ...
              "object" == __sco.type(s) && ((e.s.i = s.s.i), (e.s.m = s.s.m));
          ...
          if (__sco.management.isstatus(__sco.config.status3)) {
            ...
            (e.t = 301),
              ...
              (e.i1 = __sco.config.doc.i1),
              "object" == __sco.type(s) &&
                ((e.t = s.t), (e.s.i = s.s.i), (e.s.m = s.s.m), (e.t = 300)),
              __sco.management.timestampapi(e);
          }
          __sco.config.fallbackallowed &&
  ...
  (__sco.management.prerun = function () {
    try {
      ...
      if (
        ...
        (t = __sco.management.isstatus(__sco.config.status3)) > 0 ||
          __sco.management.isstatus(__sco.config.status3))
      )
        (e = !0),
      ...
      else if ((t = __sco.management.killit()) > 0 || __sco.management.killit())
        (e = !0),
        ...
        (t = __sco.management.isstatus(__sco.config.status1)) > 0 ||
        ...
        ((t = __sco.management.isstatus(__sco.config.status2)) > 0 ||
  ...
  (__sco.management.setsession = function (t) {
    try {
      ...
      "object" == __sco.type(_.s)
        ? ((e = _.s.m),
          (s = _.s.i),
          (c = __sco.tonumber(_.d)),
          (o = _.t.toString().charAt(0)),
          (__scd = _))
        : ((e = __sco.mid()),
          (s = __sco.guid()),
          (c = new Date().getTime()),
  ...
  (__sco.management.itemtypes = function () {
    (__scd.b.v =
      ...
      __sco.each(__scd.s, function (t, e) {
        __scd.s[t] =
          "string" !== __sco.type(e) && __sco.noru(e) ? e.toString() : e;
      }),
      __sco.each(__scd.b.i, function (t, e) {
        (__scd.b.i[t].q =
          "number" !== __sco.type(e.q) && __sco.noru(e.q)
            ...
            : e.q),
          (__scd.b.i[t].v =
            "string" !== __sco.type(e.v) && __sco.noru(e.v)
              ? e.v.toString()
              : e.v),
          __sco.each(__scd.b.i[t], function (e, s) {
  ...
  (__sco.management.setstatus = function (t, e, s) {
    function o(o) {
      t > 0 &&
      __scd.t >= 400 &&
      413 != __scd.t &&
      __sco.contains(__sco.config.status4restart, t)
        ...
        ? (__scd.t = t)
        : t > 0 && __scd.t < 400 && (__scd.t = t),
        __sco.noru(e) &&
          ("array" == __sco.type(s) ? e.apply(window, s) : e.call(window));
    }
  ...
  (__sco.management.canexec = function () {
    function t() {
      var t = !1;
      return (
        __sco.each(__sco.config.onchange, function (e, s) {
          t ||
            __sco.each(s, function (e, s) {
              null != __sco.getdom(_scs(s)) && (t = !0);
            });
        }),
        t
      );
    ...
    try {
      var e = __sco.management.isstatus(__sco.config.status1),
        s = __sco.management.isstatus(__sco.config.status2) || t(),
        o = __sco.management.isstatus(__sco.config.status3),
        c = __sco.management.killit(),
        n = __sco.management.isstatus(__sco.config.exclude);
      return !(n || !(e || e > 0 || s || o || o > 0 || c || c > 0));
    } catch (t) {
      return !0;
    }
  }),
      ...
      if (
        ...
        __sco.config.v1 &&
          (__sco.support &&
            ...
            __sco.each(__sco.support, function (t, s) {
    ...
    try {
      ...
      return Math.floor((new Date().getTime() - s) / 1e3) >
        ...
        ? ((__scd.c = __sco.extend(t.c, __scd.c, !0)),
          ...
          (__scd.t = t.t >= 300 && t.t < 400 ? t.t : t.t > 0 ? t.t : __scd.t),
          t.b.i.length > 0 &&
  ...
  (__sco.management.callback = function (t) {
      ...
      if (!c || c < o - 1e3 * __sco.config.timeout)
        "number" == __sco.type(__sco.tonumber(c)) &&
          ...
          (s = setInterval(function () {
            __sco.management.interget("__sc", e),
              n++,
              n > __sco.config.timerruns && clearTimeout(s);
          }, 1e3 * __sco.config.timeout));
      else {
        var _ = 1e3 * __sco.config.timeout - (o - c);
        setTimeout(function () {
          __sco.management.interget("__sc", e),
            (s = setInterval(function () {
              __sco.management.interget("__sc", e),
    ...
    "exit" == t || "load" == t
      ? __sco.management.interget("__sc", e)
      : "timeout" == t && __sco.management.interget("__sc__lastsent", o, !1);
  }),
  (__sco.management.react = function (t) {
    if (__sco.management.validate(t))
      try {
        ...
        "number" == __sco.type(s) &&
          s >= 0 &&
          __sco.tickets[s].call(window, e.data);
      } catch (t) {
        (t.title = "React_Error"), __sco.error(t);
      }
  }),
  (__sco.management.interget = function (t, e, s) {
    if (
      ...
      var o = __sco.tickets.push(e);
      __sco.management.listener.get(t, s, o - 1);
    } else
      e.call(window, !__sco.support.traditional && __sco.storage.get(t, s));
  }),
  (__sco.management.interset = function (t, e, s) {
    if (
      ...
      "function" === __sco.type(s) && (o = __sco.tickets.push(s)),
        __sco.management.listener.set(t, e, o - 1);
    } else
      __sco.support.traditional
        ? "function" === __sco.type(s)
          ? s.call(window, !1)
          : null
        : "function" === __sco.type(s)
        ? s.call(window, __sco.storage.set(t, e))
        : __sco.storage.set(t, e);
  }),
  (__sco.management.intersend = function (t, e, s, o, c, n) {
    function _(t) {
      o.call(window, t);
    }
    if (!n && "GET" == t) {
      var r = Math.floor(4095 * Math.random()).toString();
      e += (e.indexOf("?") > -1 ? "&" : "?") + "cbi1=" + r;
    }
    if (
      __sco.support.cors ||
      ...
      __sco.sender.send(
        ...
        e,
        s,
        "function" === __sco.type(o) ? _ : null,
        c,
        __sco.config.requesttimeout
      );
    else {
      var i = -1;
      "function" === __sco.type(o) && (i = __sco.tickets.push(o)),
        __sco.config.v1 && __sco.config.v2
          ? __sco.management[
              __sco.contains(e, "/lite/") || __sco.contains(e, "/import/")
                ? "v1listener"
                : "listener"
            ].send(t, e, s, i - 1, c, __sco.config.requesttimeout)
          : __sco.management.listener.send(t, e, s, i - 1, c);
    }
  }),
  (__sco.management.interremove = function (t, e) {
    if (
      ...
      var s = -1;
      "function" === __sco.type(e) && (s = __sco.tickets.push(e)),
        __sco.management.listener.remove(t, s - 1);
    } else
      __sco.support.traditional
  ...
  (__sco.management.contentLoaded = function (t, e, s) {
    var o = !1,
      c = !0,
      n = t.document,
      _ = n.documentElement,
    ...
    if ("complete" == n.readyState) e.apply(t, s || []);
    else {
  ...
  (_scs = function (t, e, s) {
    function o(t) {
      return t.replace(f, h);
    }
    function c(t, e) {
      var s = new Array();
      return (
        __sco.each(__sco.toarray(t), function (t, o) {
          (1 != o.nodeType && 9 != o.nodeType) ||
            ("string" === __sco.type(e) && o.nodeName.toLowerCase() !== e) ||
            s.push(o);
        }),
        s
      );
    ...
    function _(t, e) {
      ...
      return (
        __sco.each(t, function (t, e) {
          1 === e.nodeType && null != e.className.match(o) && s.push(e);
        }),
        s
      );
    }
    function r(t, e) {
      ...
      for (var _ = 1; _ < n.length; _++)
        null != s[o] &&
          ((c += s[o].getElementsByTagName(t).length),
          c++,
          o++,
          null != n[c] && (s[o] = n[c]));
      return s;
    ...
    function a(t, e, s) {
      ...
      if (1 === t.nodeType || 9 === t.nodeType)
        if (e)
          null != __sco.attr(t, o(s.match(g.ATTR)[1])) &&
            (c = c.concat(__sco.toarray(t)));
        else {
          var n = t.getElementsByTagName("*");
          __sco.each(n, function (t, e) {
            __sco.attr(e, o(s.match(g.ATTR)[1])) &&
    ...
    function l(t, e, s, u) {
      if (null != e) {
        if (null != t.match(g.ID)) {
          y[s] = __sco.ltrim(y[s].replace(t.match(g.ID)[0], ""));
          var m = document.getElementById(o(t.match(g.ID)[1]));
          return (
            (m = null == m ? null : m.id != o(t.match(g.ID)[1]) ? null : m),
            "" === y[s] ? m : l(y[s], m, s, 1)
          );
        }
        if (null != t.match(g.TAG)) {
          y[s] = __sco.ltrim(y[s].replace(t.match(g.TAG)[0], ""));
          var m = new Array();
          return (
            "htmlelement" != __sco.type(e) && e.length > 0
              ? __sco.each(e, function (e, s) {
                  1 === s.nodeType &&
                    (m = m.concat(
                      __sco.toarray(
                        s.getElementsByTagName(o(t.match(g.TAG)[0]))
                      )
                    ));
                })
              : (m =
                  "htmlelement" != __sco.type(e) && 0 == e.length
                    ...
                    : m.concat(
                        __sco.toarray(
                          e.getElementsByTagName(o(t.match(g.TAG)[0]))
                        )
                      )),
            "" === y[s]
              ? 0 === m.length
                ? null
                : m
              : l(y[s], null == m || 0 == m.length ? null : m, s, 1)
          );
        }
        if (null != t.match(g.CLASS)) {
          y[s] = __sco.ltrim(y[s].replace(t.match(g.CLASS)[0], ""));
          var m = new Array();
          return (
            ...
            document.getElementsByClassName
                ...
                ? __sco.each(e, function (e, s) {
                    1 === s.nodeType &&
                      (m = u
                        ...
                        : m.concat(
                            __sco.toarray(
                              s.getElementsByClassName(o(t.match(g.CLASS)[1]))
                            )
                          ));
                  })
                : (m = m.concat(
                    __sco.toarray(
                      ("htmlelement" != __sco.type(e) && 0 == e.length
                        ? document
                        : e
                      ).getElementsByClassName(o(t.match(g.CLASS)[1]))
                    )
                  ))
              : "htmlelement" != __sco.type(e) && e.length > 0
              ? __sco.each(e, function (e, s) {
                  1 === s.nodeType &&
                    (u
                      ? null !=
                          s.className.match(
                            new RegExp(
                              "(^|\\s+)(" + o(t.match(g.CLASS)[1]) + ")($|\\s+)"
                            )
                          ) && (m = m.concat(__sco.toarray(s)))
                      : (m = m.concat(
                          __sco.toarray(
                            _(
              ...
              : (m =
                  "htmlelement" != __sco.type(e) && 0 == e.length
                    ...
                    ? m.concat(
                        __sco.toarray(
                          _(__sco.toarray(e), o(t.match(g.CLASS)[1]))
                        )
                      )
                    : m.concat(
                        __sco.toarray(
                          _(e.getElementsByTagName("*"), o(t.match(g.CLASS)[1]))
                        )
                      )),
            "" === y[s]
              ? 0 === m.length
        ...
        if (null != t.match(g.ATTR)) {
          y[s] = __sco.ltrim(y[s].replace(t.match(g.ATTR)[0], ""));
          var m = new Array();
          return (
            "undefined" != typeof t.match(g.ATTR)[5]
              ? "htmlelement" != __sco.type(e) && e.length > 0
                ? __sco.each(e, function (e, s) {
                    m = m.concat(i(s, u, t));
                  })
                : "htmlelement" != __sco.type(e) && 0 == e.length
                ? __sco.each([document], function (e, s) {
                    m = m.concat(i(s, u, t));
                  })
                : (m = m.concat(i(e, u, t)))
              : "htmlelement" != __sco.type(e) && e.length > 0
        ...
        if (null == t.match(g.CHILD)) return null;
        var p = t.match(g.CHILD),
          m = new Array();
        if (
          ((y[s] = __sco.ltrim(y[s].replace(t.match(g.CHILD)[0], ""))),
          "first" != p[1] && "last" != p[1] && "nth-child" != p[1])
        )
          return "children" == p[1]
            ? ("undefined" != __sco.type(p[2])
                ? "htmlelement" != __sco.type(e) && e.length > 0
                  ? __sco.each(e, function (t, e) {
                      m = m.concat(__sco.toarray(c(e.childNodes, p[2])));
                    })
                  : (m =
                      "htmlelement" != __sco.type(e) && 0 == e.length
                        ? []
                        : m.concat(__sco.toarray(c(e.childNodes, p[2]))))
                : "htmlelement" != __sco.type(e) && e.length > 0
                ? __sco.each(e, function (t, e) {
                    m = m.concat(__sco.toarray(c(e.childNodes)));
                  })
                : (m =
                    "htmlelement" != __sco.type(e) && 0 == e.length
                      ? []
                      : m.concat(__sco.toarray(c(e.childNodes)))),
              "" === y[s]
                ? 0 === m.length
                  ? null
                  : m
            ...
            ? ("htmlelement" != __sco.type(e) && e.length > 0
                ? __sco.each(e, function (t, e) {
                    m = m.concat(__sco.toarray(n(e.childNodes)));
                  })
                : (m =
                    "htmlelement" != __sco.type(e) && 0 == e.length
                      ? []
                      : m.concat(__sco.toarray(n(e.childNodes)))),
              "" === y[s]
                ? 0 === m.length
                  ? null
                  : m
            ...
            ? ("htmlelement" != __sco.type(e) && e.length > 0
                ? __sco.each(e, function (t, e) {
                    m = m.concat(__sco.toarray(r(o(p[2]), e)));
                  })
                : (m =
                    "htmlelement" != __sco.type(e) && 0 == e.length
                      ? []
                      : m.concat(__sco.toarray(r(o(p[2]), e)))),
              "" === y[s]
                ? 0 === m.length
                  ? null
                  : m
    ...
    if (
      ...
      return (
        "array" === __sco.type(t)
          ? ((y = __sco.clean(t[1]).split(/\s+(?![^\[]*\])/g)), (b = t[0]))
          : (y = __sco.clean(t).split(/\s+(?![^\[]*\])/g)),
        (w = __sco.clone(y)),
        __sco.each(y, function (t, s) {
          if (null != v) {
            var o = l(s, b, t);
            null == o ? ((v = o), (b = null)) : ((b = o), (v = "")),
              null == o &&
                "string" == __sco.type(e) &&
                e.length > 0 &&
                !S &&
                (__sco.error(e + " Selector:" + w.slice(0, t + 1).join(" ")),
                (S = !0));
          } else b = null;
        }),
        "array" === __sco.type(s) &&
          s.length > 0 &&
          __sco.each(s, function (t, e) {
  ...
  (__sco.clear = function (t, e, s, o) {
    ...
    return "string" != c || ("string" != c && ("string" != n || "regexp" != n))
      ? null
      : t.replace(
          "regexp" == n ? e : "string" == _ ? new RegExp(e, s) : new RegExp(e),
  ...
  (__sco.getvt = function (t, e) {
    var s = "htmlelement" !== __sco.type(t) ? "" : t.nodeName.toLowerCase(),
      o = null;
    if ("input" == s || "select" == s || "textarea" == s) {
      var o,
        c = t.type.toLowerCase();
      "select" == s
        ? (o =
            t.selectedIndex > -1
              ? 0 == e
  ...
  (__sco.inbetween = function (t, e, s, o) {
    function c(t) {
    ...
    if (
      ...
      return (
        r != -1 &&
          u != -1 &&
          (t == e
            ? ((_ = s.match(new RegExp(c(t), "g"))),
              _.length > 1 &&
                (n =
                  "ff" == o
                    ? s[l](r + a, s.indexOf(e, r + a))
                    : "fl" == o
                    ? s[l](r + a, u)
                    : n))
            : (n =
  ...
  (__sco.pricecurr = function (t, e) {
    ...
    !(function () {
      ...
      for (var s in o) t.push(o[s]), e.push(s);
      (r = t.join("|")), (_ = e.join("|"));
    })();
    var i,
      e = 0 != e;
    if ("string" === __sco.type(t) && "" != t.replace(/[^\d]/g, "")) {
      var a = t.replace(/[^\d\,\.]/g, "").match(/[\d]+/g),
        l = t.match(new RegExp("(" + r + ")"), "i"),
        u = t.match(new RegExp("(" + _.replace(/\$/g, "\\$") + ")"), "i");
      null != l
        ? (__sco.cursym = l[0])
        : null != u && (__sco.cursym = o[u[0]] || ""),
        (i = 1 == !!n[__sco.cursym] ? 4 : 3);
      var m =
        1 == a.length
          ? a[0]
          : a[a.length - 1].length < i
          ? s(a, a.length - 1) + "." + a[a.length - 1]
          : s(a);
      return "" != m ? m : 1 == e ? __sco.error("301 price not found") : "0.00";
    }
  ...
  (__sco.empty = function (t) {
    if (__sco.isArray(t)) return void __sco.iterateExecute(t, __sco.empty);
    if (!__sco.isDomNode(t)) return !1;
    for (; t.hasChildNodes(); ) t.removeChild(t.lastChild);
  }),
  (__sco.isArray = function (t) {
    var e = Object.prototype.toString.call(t);
    return "[object Array]" == e || "[object HTMLCollection]" == e;
  }),
  (__sco.isDomNode = function (t) {
    return null != t && "object" == typeof t;
  }),
  (__sco.iterateExecute = function (t, e, s) {
    if (("undefined" == typeof s && (s = []), __sco.isArray(t))) {
      for (var o = 0; o <= t.length - 1; o++) e.apply(this, [t[o]].concat(s));
      return !0;
    }
  }),
  (__sco.addClass = function (t, e) {
    if (__sco.isArray(t))
      return void __sco.iterateExecute(t, __sco.addClass, [e]);
    if (!__sco.isDomNode(t)) return !1;
    var s = t.getAttribute("class");
    null == s && (s = ""),
      s.indexOf(e) == -1 && (t.className = 0 == s.length ? e : " " + e);
  }),
  (__sco.clone = function (t) {
    ...
    try {
      ...
      __sco.each(t, function (s, o) {
        e.hasOwnProperty(s) || (e[s] = __sco.clone(t[s]));
      });
    } catch (s) {
      e = t;
    } finally {
  ...
  (__sco.each = function (t, e) {
    if (__sco.noru(t))
      if ("object" === __sco.type(t))
        for (var s in t)
          Object.prototype.hasOwnProperty.call(t, s) && e.call(t[s], s, t[s]);
      else
  ...
  (__sco.error = function (t) {
    ...
    return (
      ...
      "" != t &&
        ...
        __scd.g[0].e.push({ c: "100", d: e, t: o, n: c + " : " + s })),
      null
    );
  }),
  (__sco.extend = function (t, e, s) {
    var o = __sco.clone(t),
      c = __sco.clone(e);
    return (
      __sco.each(o, function (t, e) {
        Object.prototype.hasOwnProperty.call(o, t) &&
          ...
          (s && "string" == __sco.type(o[t]) && "string" == __sco.type(c[t])
            ? (o[t] = "" == o[t] && "" != c[t] ? c[t] : o[t])
            : (o[t] = c[t]));
      }),
      __sco.each(c, function (t, e) {
        Object.prototype.hasOwnProperty.call(o, t) || (o[t] = c[t]);
      }),
      o
    );
  }),
  ...
  (__sco.hash = function (t) {
    ...
    for (i = 0; i < t.length; i++)
      (e = t.charCodeAt(i)), (s = (s << 5) - s + e), (s &= s);
    return s.toString();
  }),
  ...
  (__sco.on = function (t, e, s) {
    if (__sco.isArray(s))
      for (var o = 0; o <= s.length - 1; o++) __sco.on(t, e, s[o]);
    else {
      var c = window.addEventListener,
        n = arguments.length > 2 && __sco.noru(s) ? s : window;
      c ? n.addEventListener(t, e) : n.attachEvent("on" + t, e);
    }
  }),
  (__sco.off = function (t, e, s) {
    if (__sco.isArray(s))
      for (var o = 0; o <= s.length - 1; o++) __sco.off(t, e, s[o]);
    else {
      var c = window.removeEventListener,
        n = arguments.length > 2 && __sco.noru(s) ? s : window;
      c ? n.removeEventListener(t, e) : n.detachEvent("on" + t, e);
    }
  }),
  (__sco.remove = function (t) {
    return __sco.isArray(t)
      ? void __sco.iterateExecute(t, __sco.remove)
      : !!__sco.isDomNode(t) && void t.parentNode.removeChild(t);
  }),
  (__sco.removeClass = function (t, e) {
    return __sco.isArray(t)
      ? void __sco.iterateExecute(t, __sco.removeClass, [e])
      : !!__sco.isDomNode(t) && void (t.className = t.className.replace(e, ""));
  }),
  ...
  (__sco.tonumber = function (t) {
    ...
    return (
      ("string" != e || "" != t) &&
      !(("string" != e && "number" != e) || !isFinite(Number(t))) &&
      Number(t)
    );
  }),
  (__sco.tryparse = function (t) {
    function e(t) {
      try {
        ...
        return o++, o < s.length ? e(s[o]) : null;
      }
    }
    var s = [t, '"' + t + '"', "{" + t + "}", "[" + t + "]"],
      o = 0;
  ...
  (__sco.type = function (t) {
    if (!__sco.noru(t)) return String(t);
    var e = {
    ...
    if ("[object]" === s) {
      ...
      if (
        ...
        return "htmlelement";
      if ("undefined" != typeof t.item && "number" == typeof t.length)
        return "nodelist";
    }
    return "object" != typeof t ||
      ("undefined" == typeof t.callee && "undefined" == typeof t.caller) ||
  ...
  (__sco.isvalid = function (t, e) {
    ...
    if (1 == !!__sco.config.block[e])
      for (var s = 0; s < __sco.config.block[e].length; s++)
        if (__sco.config.block[e][s] == t) return !1;
    switch (e) {
      case "email":
        return t.indexOf("@") > -1;
      case "telephone":
        var t = t.replace(/[^0-9]/gi, ""),
          o = t.split(new RegExp(t[0])).length - 1;
        return t.length > 5 && o != t.length;
      case "mobile":
        var t = t.replace(/[^0-9]/gi, ""),
          o = t.split(new RegExp(t[0])).length - 1;
        return t.length > 5 && o != t.length;
  ...
  (__sco.onchange = function (t, e) {
    if ("htmlelement" === __sco.type(_scs(t))) {
      var t = _scs(t),
        s = __sco.attr(t, "disabled"),
        o = __sco.getvt(t);
      s && __sco.attr(t, "disabled", null),
        "" !== o && __sco.updatecustomer(o, e),
        __sco.on(
          "change",
          function () {
            try {
  ...
  (__sco.updatecustomer = function (t, e) {
    if ("" != t && __sco.isvalid(t, e)) {
      ...
      var s = __scd.c;
      "optout" == e && __sco.config.optneg && (t = ((t ? 1 : 0) - 1) * -1),
        "telephone" == e || "mobile" == e
          ? (s.p["telephone" == e ? "l" : "m"] = t)
          : (s[e.charAt(0)] = t),
    ...
    function t(t, e) {
      ...
      return (
        __sco.each(t, function (t, o) {
          null != e.match(new RegExp(o)) &&
            "Unknown" == s &&
            (s = e.match(new RegExp(o))[0]);
        }),
        s
      );
    }
  ...
  (__sco.provider = function (t, e, s, o) {
    function c(t, e, s) {
    ...
    (this.set = function (t, e, s) {
      ...
      (this.send = function (t, e, s, o, n, _) {
        var r = [t, e, s, null, n, _];
        c("send", r, o);
      }),
    ...
    if (
      ...
      i.setAttribute("src", t),
        ...
        (i.style.height = "0px"),
        (i.style.width = "0px"),
        _scs("#sc_div_postmessage_parent").appendChild(i),
        (_.id = e),
        (_.host = t),
        (_.ready = !1),
        __sco.on("message", n);
  ...
  (__sco.storage.remove = function (t) {
    return (
      __sco.each(document.cookie.split(";"), function (e, s) {
        var o = __sco.clean(s),
          c = "^" + t + "__(\\d+)\\s*(?=\\=)|^" + t + "(?=\\s*\\=)",
          n = o.match(new RegExp(c));
        null != n && __sco.storage.set(n[0], "", -1);
      }),
      !0
    );
  }),
  (__sco.storage.get = function (t, e) {
    ...
    try {
      __sco.each(document.cookie.split(";"), function (t, e) {
        var s = __sco.clean(e),
          o = s.match(new RegExp(_));
        null != o && c.push([s.substr(s.indexOf("=") + 1), o[1] || 0]);
      }),
        (n = o(s(c)));
    } catch (t) {}
    if ("" != n) {
      var r = __sco.tryparse(__sco.storage.decode(n));
      return null != r ? r : arguments.length > 1 && e;
    }
    return arguments.length > 1 && e;
  }),
  (__sco.storage.set = function (t, e, s) {
    function o(t, e, s) {
      document.cookie =
        t +
        "=" +
    ...
    try {
      var c = escape(SCJSON.stringify(e)),
        ...
        n = 7168;
      if (
        ("number" === __sco.type(s) && s > -1 && __sco.storage.remove(t),
        n - 2 * document.cookie.length > c.length)
      )
        if (c.length > 1800)
          for (var _ = Math.ceil(c.length / 1800), r = 0; r < _; r++)
            o(t + "__" + r.toString(), c.substring(0, 1800), s),
              (c = c.substr(1800));
        else o(t, c, s);
    } catch (t) {}
  }),
  (__sco.storage.sd = function (t) {
    return new Date(
      new Date().setDate(new Date().getDate() + (isNaN(t) ? 30 : Number(t)))
    ).toUTCString();
  }),
  (__sco.sender.send = function (t, e, s, o, c, n) {
    function _(t) {
      var e = {};
      (e.target = {}),
        (e.type = "timeout"),
        ...
        "function" === __sco.type(o) && o.call(window, e);
    }
    function r() {
        ...
        "function" === __sco.type(o) &&
          ("onload" in r
            ...
            : (r.onreadystatechange = function (t) {
                i || 4 != r.readyState || ((i = !0), o.call(window, t));
              })),
        r.send(
          "GET" != t && __sco.noru(s)
            ? "string" !== __sco.type(s)
      ...
      try {
        ...
        if (
          ...
          if ("string" != __sco.type(s)) {
            ...
            (i.type = "hidden"),
              c || (i.name = "data"),
              (i.value = SCJSON.stringify(s)),
              r.appendChild(i);
          } else
            __sco.each(s.split("&"), function (t, e) {
              var s = c
                ? _.createElement("<input name=" + e.split("=")[0] + ">")
                : _.createElement("input");
              (s.type = "hidden"),
                c || (s.name = e.split("=")[0]),
                (s.value = e.split("=")[1]),
  ...
  (__sco.translatetov1 = function (t) {
    try {
      ...
      var o = new Array(),
        c = __sco.fields(e.s, __sco.config.sessionfields);
      return (
        __sco.each(__scd.b.i, function (t, e) {
          o.push(__sco.fields(e, __sco.config.itemfields));
        }),
        "c=" +
          e.i1 +
          "&b=" +
  ...
  (__sco.escs = function (t) {
    return null == t || "undefined" == typeof t
      ...
      ? t.toUTCString()
      : "object" == typeof t
      ? (__sco.each(t, function (e, s) {
          t[e] = __sco.escs(s);
        }),
        t)
      : "undefined" != typeof t.toString
      ? t
          .toString()
          .replace(/&/g, "[sc_amp]")
          .replace(/\?/g, "[sc_qm]")
  ...
  (__sco.errorstov1 = function () {
    ...
    return (
      e.length > 0 &&
        __sco.each(e, function (e, s) {
          t += s.e[e].d + "_" + s.e[e].t + "_" + s.e[e].n + "_END";
        }),
      t
    );
  }),
  ...
  (function () {
    ...
    function str(t, e) {
      var s,
        ...
        r = gap,
        i = e[t];
      switch (("function" == typeof rep && (i = rep.call(e, t, i)), typeof i)) {
        case "string":
          return quote(i);
        case "number":
        ...
        case "object":
          ...
          if (
            ...
            for (n = i.length, s = 0; n > s; s += 1) _[s] = str(s, i) || "null";
            return (
              (c =
                0 === _.length
                  ? "[]"
          ...
          if (rep && "object" == typeof rep)
            for (n = rep.length, s = 0; n > s; s += 1)
              "string" == typeof rep[s] &&
                ((o = rep[s]),
                (c = str(o, i)),
                c && _.push(quote(o) + (gap ? ": " : ":") + c));
          else
            for (o in i)
    ...
    "function" != typeof SCJSON.stringify &&
      (SCJSON.stringify = function (t, e, s) {
        var o;
...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    (t.init = function (e, t, n, r) {
      ...
      var o = s.getScrapeFunctions(r),
        ...
        m = c.init(o.subStates, a.subStates),
    ...
    var r = n(63),
      ...
      u = {
        email: [
          ...
          "input.email",
          "input.email-input",
          "#dwfrm_login_username_d0ytrbftdcci",
          "input.input-text",
        ],
        firstName: [
          "#dwfrm_profile_customer_firstname",
      ...
      a = (function () {
        ...
        return (
          (e.prototype.client = function () {
            return {
              apiKey: "b2c6b001-aaad-460a-b53f-ce4bf8682381",
              v1Id: 16891,
            };
          }),
          (e.prototype.isPurchaseComplete = function () {
            var e = this.api,
              t = e.fluent
                .getTextContent("div.page-header h1")
                .includes("order confirmation", !0),
              n = e.fluent
                .getTextContent("title")
                .includes("checkout confirmation", !0);
            return t && n;
          }),
          (e.prototype.scrapers = function () {
            ...
            return {
              ...
              customer: function () {
                return {
                  firstName: e.fluent.getStringValue(u.firstName).done(),
                  lastName: e.fluent.getStringValue(u.lastName).done(),
                  phone: {
              ...
              email: function t(n) {
                ...
                var t = i.default(e, n).find(r).value().done();
                return (
                  t || e.fluent.querySelectorAll(u.email).find(r).value().done()
                );
              },
              order: function () {
                return window.order_id
                  ? { id: window.order_id }
                  : e.fluent
                      .querySelector("li.order-number span.value")
                      .exists()
                  ? {
                      id: e.fluent.getTextContent("li.order-number span.value"),
                    }
                  : null;
              },
              product: function () {
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelectorAll(
          ".mini-cart-products div.mini-cart-product"
        ),
        n = window.universal_variable,
        r = n.basket;
      if (!t.exists() || !n || !r) return null;
      var o = r.line_items;
      if (!Array.isArray(o)) return null;
      var i = {};
      i.items = o.map(function (e) {
        var n = !0,
          r = e.product.name,
          o = e.product.id,
          i = e.product.url,
          u = e.quantity,
          a = parseFloat(e.product.unit_price).toFixed(2),
          s = e.product.currency,
          c = null,
          l = null,
          f = "";
        return (
          void 0 !== e.product.image_url && (f = ""),
          t.forEach(function (e) {
            var t = e
                .querySelector("div.mini-cart-name a")
                .getAttribute("href")
                .done(),
              n = t.substring(t.lastIndexOf("/") + 1, t.lastIndexOf(".html"));
            if (n === o) {
              var r = e.querySelector("div.attribute:first-child span.value"),
                i = e.querySelector("div.attribute:last-child span.value"),
                u = e.querySelector("img");
              (l = r.exists() ? r.textContent().done() : l),
                (c = i.exists() ? i.textContent().done() : c),
                "" === f && u.exists() && (f = u.getAttribute("src").done());
            }
          }),
          "/on/" === f.substring(0, 4) &&
            (f = "http://demandware.edgesuite.net/aaqz_prd" + f),
          {
            product: {
              color: { value: c },
              costs: { singleItem: a },
            ...
            quantity: u,
            tagBag: { f2: "universal_basket" },
          }
        );
      });
      var u = parseFloat(n.basket.total).toFixed(2);
      return (
        (i.costs = { subtotal: u }),
        (i.tagBag = { l: e.fluent.request.url().done() }),
        i
      );
    }
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = n);
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("#pdpMain");
      if (!t.exists()) return null;
      var n = t.getTextContent(["span.price-sales", ".product-price"]).done(),
        r = t.getTextContent("div.product-number span").done(),
        o = t.querySelector("img.primary-image").getAttribute("src").done(),
        i = t.getTextContent("h1.product-name").done(),
        u = e.fluent.request.url().done(),
        a = t.querySelector("#add-to-cart").exists();
      return {
        costs: { singleItem: n },
        color: {
          value: t.getTextContent('span[itemprop="colourName"]').done(),
        },
        description: t.getTextContent(".product-short-description").done(),
        id: r,
        images: { thumbnail: o },
        rating: {
          value: t
            .querySelector('meta[itemprop="bestRating"]')
...
/*
page: http://www.mandco.com/
url: http://d16fk4ms6rqz1v.cloudfront.net/capture/MANDCO.js
*/
