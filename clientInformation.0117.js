...
function validEmailandCheckbox(e) {
  var t = !0,
    o = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/gim;
  return (
    0 == o.test(e) &&
      (__sco.on(
        "focus",
      ...
      (t = !1)),
    t && ((__scd.c.e = e), __sco.management.sendtoapi()),
    t
  );
}
...
(__sco.v1 = __sco.v1 || {}),
  ...
  (__sco.config = {
    live: !0,
    v1: !0,
    v2: "en-us" == universal_variable.user.language,
    osr: "en-us" == universal_variable.user.language,
    fallbackallowed: !0,
    translatev1: !1,
    allcurrencies: !1,
    persistcustomer: !0,
    ...
    startdate: 0,
    guid:
      "en-us" != universal_variable.user.language
        ? ""
        : "84A1905C-038A-450A-8C5A-333F55D32421",
    v1guid: "84A1905C-038A-450A-8C5A-333F55D32421",
    triggers: ["load"],
    status1: [
      function () {
    ...
    onchange: {
      email: [
        "[name=dwfrm_login_username]:first",
        ...
        "#newsletter_signup",
        ".f-field-textinput .email:first",
        ".home-signinemail:first",
        ".newsletter-input.email:first",
      ...
      telephone: ["#dwfrm_singleshipping_shippingAddress_addressFields_phone"],
      mobile: [],
      salutation: [],
      optout: [],
    },
    ...
    doc: {
      ...
      cc: !0,
      s: { i: "", m: "" },
      i: "en-us" != universal_variable.user.language ? 0 : 1807,
      i1: 17704,
      c: { f: "", l: "", e: "", o: "0", s: "", p: { m: "", l: "" } },
      b: { c: "", v: "", i: [] },
      g: [],
...
var nCurrentItem = 0;
(__sco.stagingOrDevelopment = function () {
  return !(
    !__sco.contains(__sco.loc, "//staging-") &&
    !__sco.contains(__sco.loc, "//development-")
  );
}),
  (__sco.checkStatusOne = function () {
    return (
      !(
        (!__sco.contains(__sco.loc, "cart-show") &&
          !__sco.contains(__sco.loc, "/bag")) ||
        __sco.stagingOrDevelopment()
      ) ||
      (null != _scs("#mini-cart") &&
        ("undefined" == typeof __sco.miniBasketMonitor &&
          ((__sco.miniBasketMonitor = new __sco.monitor()),
          (__sco.miniBasketMonitor.startstate = __sco.noru(_scs("#mini-cart"))
            ? _scs("#mini-cart").innerHTML
            : ""),
          (__sco.miniBasketMonitor.compare = function () {
            return __sco.noru(_scs("#mini-cart"))
              ? _scs("#mini-cart").innerHTML
              : "";
          }),
          (__sco.miniBasketMonitor.action = function () {
            __sco.management.main();
          }),
          __sco.miniBasketMonitor.start()),
        null !=
          _scs("#mini-cart div.mini-cart-products:first .mini-cart-product")))
    );
  }),
  (__sco.checkStatusThree = function () {
    return (
      "object" == typeof window.universal_variable &&
      "object" == typeof window.universal_variable.page &&
      "object" == typeof window.universal_variable.page.breadcrumb &&
      (window.universal_variable.page.breadcrumb.indexOf("Order confirmation") >
        -1 ||
        window.universal_variable.page.breadcrumb.indexOf(
          "Order Confirmation"
        ) > -1 ||
        window.universal_variable.page.breadcrumb.indexOf(
          "order confirmation"
  ...
  (__sco.checkDelivery = function () {
    return !(
      !__sco.contains(__sco.loc, "coshipping-start") ||
      !__sco.noru(
        _scs("div.accordion_head_checkout.shippingmethodhead.active:first")
      ) ||
      __sco.stagingOrDevelopment()
    );
  }),
  (__sco.formatImage = function (e) {
    return (
      (e = __sco.inbetween("dw/image", "", e, "fl")),
      (e = "https://sits-pod28.demandware.net/dw/image" + e)
    );
  }),
  (__sco.scraper.statusone = function () {
    var e = _scs("#cart-table");
    __scd.s.pg = document.referrer;
    var t = "-_-OTHER-_-";
    switch (universal_variable.user.language) {
      case "en-gb":
        t = "-_-UK-_-";
        break;
      case "en-us":
    ...
    var o = "",
      s = 0,
      n = 0;
    if (null != _scs([e, "tr.cart-row"])) {
      try {
        __sco.each(_scs([e, "tr.cart-row"], "102 get table rows"), function (
          e,
          o
        ) {
          var c = __sco
              .attr(
                _scs([o, "img.js-producttile_image:first"], "1 item image"),
                "src"
              )
              .replace("http://", ""),
            r = _scs([o, ".sku:first .value:first"], "", ["text"]);
          if (e > 0 && iscurrentitem(r))
            __scd.b.i[nCurrentItem].q = Number(__scd.b.i[nCurrentItem].q) + 1;
          else {
            var _ = "",
              i = "",
              a = "",
            ...
            if (
              ...
              (_ = universal_variable.basket.line_items[e].product.color),
                (i = universal_variable.basket.line_items[e].product.size),
                (a = universal_variable.basket.line_items[e].product.name),
                (l =
                  universal_variable.basket.line_items[e].product.description),
                (u =
                  universal_variable.basket.line_items[e].product
                    .unit_sale_price),
                (d =
                  universal_variable.basket.line_items[e].product.unit_price),
                ("en-gb" != universal_variable.user.language &&
                  "en-us" != universal_variable.user.language) ||
                  (__sco.contains(a.toLowerCase(), "romy") &&
                  __sco.contains(l.toLowerCase(), "coarse glitter degrad")
                    ? n++
                    : "miami" == a.toLowerCase() && s++);
            else {
              if (null != _scs([o, "div.color:first span.value"]))
                (_ = _scs(
                  [o, "div.color:first span.value:first"],
                  "1.1 item color",
                  ["text"]
                )),
                  (i =
                    null != _scs([o, "div.attribute:first span.value:first"])
                      ? _scs(
                          [o, ".attribute:first span.value:first"],
                          "1.2 item size",
                          ["text"]
                        )
                      : "");
              else if (
                null != _scs([o, "div.attribute"]) &&
                2 == _scs([o, "div.attribute"]).length
              )
                for (var p = 0; p < _scs([o, "div.attribute"]).length; p++)
                  __sco.contains(
                    __sco.text(_scs([o, "div.attribute"])[p]).toLowerCase(),
                    "colour"
                  )
                    ? (_ = _scs(
                        [
                          o,
                          "div.attribute:nth-child(" + p + ") span.value:first",
                        ],
                        "2.1 item colour",
                        ["text"]
                      ))
              ...
              (u = _scs([o, ".price-sales:last"], "item price", [
                "text",
                "pricecurr",
              ])),
                (d = __sco.pricecurr(
                  __sco.text(_scs([o, ".price-standard:last"]))
                ));
            }
            __scd.b.i.push({
              u: __sco.inbetween("", "?", c, "ff"),
              n: _scs([o, ".name:first"], "", ["text"]),
              f1: __sco
                .attr(_scs([o, ".js-producttile_link:first"]), "href")
                .replace("http://", ""),
              i: r,
              co: _,
              si: i,
      ...
      try {
        var c =
            (_scs(".order-totals-table:first"),
            _scs(".order-subtotal td:last", "", ["text", "pricecurr"])),
          r =
            null == _scs(".order-shipping:first") ||
            null ==
              _scs(".order-shipping:first", "", ["text"]).match(
                /(\d+[.,\w]\d+)/
              )
              ? 0
              : parseFloat(
        ...
        _scs(".order-sales-tax:first")
          ? parseFloat(
              _scs(".order-sales-tax:first td:last", "", ["text", "pricecurr"])
            )
          : 0,
          _scs(".order-total:last td:last", "", ["text", "pricecurr"]);
        (__scd.b.c = __sco.cursym),
          (__scd.b.v = c),
          (__scd.s.bt = __scd.b.i.length),
          (__scd.s.yc = r),
          __sco.each(_scs(".slides:first li"), function (e, t) {
            e < 4 &&
              _scs([t, ".name"]) &&
              ((__scd.s["rec_" + e + "_n"] = _scs(
                [t, ".name:first a:first"],
                "",
                ["text"]
              )),
              (__scd.s["rec_" + e + "_u"] = __sco.attr(
                _scs([t, "img:first"]),
                "src"
              )),
              (__scd.s["rec_" + e + "_v"] = _scs([t, ".salesprice:first"], "", [
                "text",
              ])),
              (__scd.s["rec_" + e + "_l"] = __sco.attr(
                _scs([t, "a:first"]),
                "href"
              )));
          });
        var _ = window.location.href.match(/jimmychoo\.com\/([^\/]+)\//);
        if (
          __sco.noru(universal_variable) &&
          __sco.noru(universal_variable.user) &&
          __sco.noru(universal_variable.user.language)
        ) {
          var i = universal_variable.user.language;
          __sco.contains(i, "-") &&
            ((i = i.split("-")),
            i.length > 1 && (i = i[0] + "_" + i[1].toUpperCase())),
            (__scd.s.locale = i);
        } else
          null != _
            ? "on" != _[1] && (__scd.s.locale = _[1])
            : (__scd.s.locale = "en");
      } catch (e) {
        (e.description = "201 " + (e.description || "")), __sco.error(e);
      }
    } else if (
      null != _scs("#mini-cart div.mini-cart-products:first .mini-cart-product")
    ) {
      try {
        __sco.each(
          _scs(
            "#mini-cart div.mini-cart-products:first .mini-cart-product",
            "s100 product rows"
          ),
          function (e, o) {
            var c = __sco
              .attr(
                _scs([o, ".js-producttile_image:first"], "s101 item image"),
                "src"
              )
              .replace("http://", "");
            c = __sco.inbetween("", ".jpg?", c, "ff") + ".jpg";
            var r = __sco
              .attr(
                _scs([o, ".js-producttile_link:first"], "s102 item id"),
                "data-productid"
              )
              .toUpperCase();
            if (e > 0 && iscurrentitem(r))
              ...
              "object" == typeof universal_variable &&
                "object" == typeof universal_variable.basket.line_items &&
                universal_variable.basket.line_items.length > 0 &&
                __sco.each(universal_variable.basket.line_items, function (
                  e,
                  t
                ) {
                  (_ = t.product.name),
                    (i = t.product.description),
                    (itemSKU = t.product.sku.toUpperCase()),
                    ((r == itemSKU &&
                      "en-gb" == universal_variable.user.language) ||
                      "en-us" == universal_variable.user.language) &&
                      (__sco.contains(_.toLowerCase(), "romy") &&
                      __sco.contains(i.toLowerCase(), "coarse glitter degrad")
                        ? n++
                        : "miami" == _.toLowerCase() && s++);
                });
              var a =
                  null != _scs([o, ".color .value:first"])
                    ? _scs([o, ".color .value:first"], "s103 item colour", [
                        "text",
                      ])
                    : "",
                l =
                  "undefined" != typeof _scs([o, ".size:first"]) &&
                  null != _scs([o, ".size:first"])
                    ? __sco.inbetween(
                        ": ",
                        "",
                        _scs([o, ".size:first"], "minicart size", ["text"]),
                        "fl"
                      )
                    : "",
                u = __sco.formatImage(
                  __sco.contains(c, "?") ? __sco.inbetween("", "?", c, "ff") : c
                ),
                d = _scs([o, ".mini-cart-name:first"], "s104 item name", [
                  "text",
                ]),
                p = __sco
                  .attr(_scs([o, ".js-producttile_link:first"]), "href")
                  .replace("http://", ""),
                g = _scs(
                  [o, ".mini-cart-pricing .mini-cart-price:first"],
                  "s105 item price",
                  ["text", "pricecurr"]
                ),
                f = __sco.pricecurr(
                  __sco.text(
                    _scs([
                      o,
                      ".mini-cart-pricing .product-standard-price:first",
                    ])
                  )
                );
              __scd.b.i.push({
      ...
      try {
        var r,
          c = _scs(".mini-cart-subtotals .value:first", "s200 subtotal", [
            "text",
            "pricecurr",
          ]);
        (__scd.b.c = __sco.cursym),
    ...
    if (__scd.b.i.length > 0) {
      ("-_-UK-_-" != t && "-_-US-_-" != t) ||
        (s > 0 && (o += "-_MIAMI_-"),
        n == __scd.b.i.length && (o += "-_ROMY_CGD_-"));
      var a = 0;
      switch (
        (__sco.each(__scd.b.i, function (e, t) {
          t.wv > t.v && a++;
        }),
        universal_variable.user.language)
      ) {
        case "en-gb":
          a > 0 && (o += "-_SALE_-");
          break;
        case "en-us":
          a === __scd.b.i.length && (o += "-_SALE_-");
      }
      "" != o &&
        __sco.each(__scd.b.i, function (e, t) {
          t.f2 += o;
  ...
  (__sco.scraper.statustwo = function () {
    try {
      __sco.each(
        _scs(
          "#shippingmethodform div.shippingmethods:first div.shippingmethod"
        ),
        function (e, t) {
          "checked" == __sco.attr(_scs([t, "input:first"]), "checked") &&
            ((__scd.s.ym = __sco.inbetween(
              "",
              "<span",
              _scs([t, "label:first"]).innerHTML,
              "ff"
            )),
            (__scd.s.yc = _scs(
              [t, "label:first span:first"],
              "201 delivery cost",
              ["text", "pricecurr"]
            )));
        }
  ...
  (__sco.scraper.statusthree = function () {
    try {
      "object" == typeof window.universal_variable &&
        "object" == typeof window.universal_variable.transaction &&
        "string" == typeof window.universal_variable.transaction.order_id &&
        window.universal_variable.transaction.order_id.length > 0 &&
        (__scd.s.ordernumber = universal_variable.transaction.order_id),
        null != _scs("div.order-number:first span.value:last")
          ? (__scd.s.ordernumber = __sco.text(
              _scs("div.order-number:first span.value:last")
            ))
          : null !=
              _scs(
                "div.orderconfirmationdetails:first div.ordernumber:first span.value:first"
              ) &&
            (__scd.s.ordernumber = __sco.text(
              _scs(
                "div.orderconfirmationdetails:first div.ordernumber:first span.value:first"
    ...
    try {
      if (
        ...
        if (
          ...
          "undefined" != __sco.type(__sco.miniBasketMonitor) &&
            (__sco.miniBasketMonitor.stop(),
            (__sco.miniBasketMonitor.action = function () {
              return __sco.management.prerun();
            }),
            (__sco.management.setsession = (function () {
              var e = __sco.management.setsession;
              return function () {
                e.apply(this, arguments), __sco.miniBasketMonitor.start();
              };
            })())),
          ...
          if (
                ...
                "undefined" != __sco.type(g[2])
                  ? "htmlelement" != __sco.type(t) && 0 < t.length
                    ? __sco.each(t, function (e, t) {
                        p = p.concat(__sco.toarray(n(t.childNodes, g[2])));
                      })
                    : (p =
                        "htmlelement" != __sco.type(t) && 0 == t.length
                          ? []
                          : p.concat(__sco.toarray(n(t.childNodes, g[2]))))
                  : "htmlelement" != __sco.type(t) && 0 < t.length
                  ? __sco.each(t, function (e, t) {
            ...
            if ("elemp" == g[1])
              return (
                "htmlelement" != __sco.type(t) && 0 < t.length
                  ? __sco.each(t, function (e, t) {
                      p = p.concat(__sco.toarray(_(s(g[2]), t)));
                    })
                  : (p =
                      "htmlelement" != __sco.type(t) && 0 == t.length
                        ? []
                        : p.concat(__sco.toarray(_(s(g[2]), t)))),
                "" === f[o]
                  ? 0 === p.length
                    ? null
                    : p
...
try {
  !(function () {
        ...
        (n = this.advised = function () {
          ...
          try {
            ...
            try {
              ...
              (r.result = r.exception = e), (f = "afterThrowing");
            }
            if (
              ((l = [r.result]),
    ...
    (__sco.osr.clientConfigModule = function () {
      meld.around(__sco.osr, "getTemplateKeyword", function (e) {
        ...
        meld.around(__sco.osr, "preShowChecks", function (e) {
          return (
            null != document.location.href.indexOf("/Cart-Show") &&
            null == _scs(".cart-empty")
          );
        }),
        meld.around(__sco.osr, "emailBasketClick", function (e) {
          var t = e.args[0];
          if (validEmailandCheckbox(__sco.getvt(_scs(".emb-sc:first")))) {
            var o;
            if (0 == (o = __sco.osr.scrapeEmailAddress())) return;
            (__scd.s.osrEmail = o),
              __sco.management.sendtoapi(),
              __sco.osr.unblockUI();
            var s = __sco.osr.getLinkId(t.target),
              n = __sco.extend(
                {
                  emailAddress: o,
            ...
            if (
              (__sco.isArray(c) ? __sco.iterateExecute(c, opIn) : c && opIn(c),
    ...
    (__sco.osr.addEvents = function (e) {
      ...
      function s(e) {
        return "mousewheel" == e.type ||
          "DOMMouseScroll" == e.type ||
          "onmousewheel" == e.type
          ? void (__sco.osr.lastMove.timestamp = new Date().getTime())
          : ((e.clientX =
              e.clientX ||
              (__sco.noru(e.changedTouches) && e.changedTouches.length > 0
            ...
            void (__sco.osr.lastMove.y = e.clientY));
      }
      function n(e, t, o, s) {
        var n = [
            "TopLeft",
...
!(function (e) {
  ...
  function (e, t) {
    "use strict";
    function n() {
      switch (window.universal_variable.user.language) {
        case "en-gb":
          return "-_-UK-_-";
        case "en-us":
          return "-_-US-_-";
      ...
      a = (function () {
        ...
        return (
          (e.prototype.client = function () {
            return {
              apiKey: "84a1905c-038a-450a-8c5a-333f55d32421",
              v1Id: 17704,
            };
          }),
          ...
          (e.prototype.scrapers = function () {
            ...
            return {
              ...
              customer: function () {
                return {
                  firstName: e.fluent
                    .getStringValue("#dwfrm_profile_customer_firstname")
                    .done(),
                  lastName: e.fluent
                    .getStringValue("#dwfrm_profile_customer_lastname")
                    .done(),
                  phone: {
                    landline: e.fluent
                      .getStringValue("#dwfrm_profile_customer_phone")
                      .done(),
                    mobile: e.fluent
                      .getStringValue("#dwfrm_profile_customer_mobilephone")
                      .done(),
                  },
                  salutation: e.fluent
                    .getStringValue("#dwfrm_profile_customer_title")
                    .done(),
                };
              },
              email: function () {
  ...
  function (e, t, n) {
    ...
    function r(e) {
      var t = e.fluent.querySelector("#cart-table"),
        n = e.fluent.querySelector("table.order-totals-table");
      if (!t.exists()) return null;
      var r = {
        costs: { subtotal: n.getStringValue("tr.order-total td").done() },
        items: [],
        keywords: [],
      };
      return (
        (r.items = t
          ...
          .map(function (e) {
            var t = e.getStringValue("div.name a").done(),
              n = e.querySelector("img").getAttribute("src").done(),
              i = e.querySelector("a").getAttribute("href").done(),
              a = e.getStringValue("span.price-sales").done(),
              u = e.getStringValue("td.item-quantity input").toInt().done(),
              s = e.getStringValue("div.sku span.value").done();
            r.keywords.push(o.default());
            var c = "0.00";
            e.querySelector(".price-standard").exists() &&
              (c = e.getStringValue(".price-standard").done());
            var l = a < c ? "" : "!--";
            return {
              product: {
                costs: { previous: c, singleItem: a },
                id: s,
                images: { thumbnail: n },
                inStock: !0,
                name: t,
  ...
  function (e, t, n) {
    "use strict";
    function r(e) {
      var t = e.fluent.querySelector("div.mini-cart-content-inside"),
        n = e.fluent.querySelector("div.mini-cart-totals");
      if (!t.exists()) return null;
      var r = {
        costs: { subtotal: n.getStringValue("span.value").done() },
        items: [],
        keywords: [],
      };
      return (
        (r.items = t
          ...
          .map(function (t) {
            var n = t
                ...
                .done(),
              i = t.querySelector("img").getAttribute("src"),
              a = t.querySelector("a").getAttribute("href").done(),
              u = "",
              s = t.querySelector("a").getAttribute("data-productid").done();
            window.universal_variable &&
              window.universal_variable.basket &&
              Array.isArray(window.universal_variable.basket.line_items) &&
              window.universal_variable.basket.line_items.forEach(function (e) {
                u = e.quantity;
              }),
              r.keywords.push(o.default());
            var c = "0.00",
              l = "";
            t
              .querySelector(".mini-cart-pricing .product-standard-price")
              .exists()
              ? ((c = t
                  .getStringValue(".mini-cart-pricing .product-standard-price")
                  .done()),
                (l = t
                  .getStringValue(
                    ".mini-cart-pricing .mini-cart-price.price-adjusted"
                  )
                  .done()))
              : (l = t
                  .getStringValue("div.mini-cart-pricing span:last-child")
                  .done());
            var f = "!--";
            if (c) {
              var d = e.fluent
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("h1.product-name").value().done();
      if (!t) return null;
      var n = e.fluent.getStringValue("div.product-number span").done(),
        r = e.fluent.getStringValue("div.product-price span").done(),
        o = e.fluent.getStringValue("h1.product-name span").done(),
        i = e.fluent
          .querySelector("div.slick-track div.thumb img")
          .getAttribute("src")
          .done(),
        a = e.fluent
          .querySelectorAll("div.site-wrapper ol li")
          .getAt(1)
          .getStringValue("span")
          .done();
      return {
...
/*
page: http://www.jimmychoo.jp/
url: http://d16fk4ms6rqz1v.cloudfront.net/capture/jimmychoo.js
*/
