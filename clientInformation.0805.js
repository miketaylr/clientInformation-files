      ...
      var r = "_DATALAYER_",
        ...
        l = function (e, t) {
          var n = "!--",
            ...
            u = "!--",
            c = "",
            l = o.formatNumber(e.costs.singleItem),
            f = o.formatNumber(e.costs.previous);
          return (
            e.costs.previous > e.costs.singleItem &&
              ((n = ""),
              (i = ""),
              (a = "762322"),
              (c = parseFloat(e.costs.previous).toFixed(2))),
            t.product.stock && t.product.stock <= 2 && (u = ""),
            {
              align: "left",
              align2: "float:left",
              basketType: r,
        ...
        d = i.default.getScBasket(l, f);
      return d
        ? ((d.tagBag = {
            basket: u,
            cur: s,
            domain: a,
            totalvaluejp: o.formatNumber(d.costs.subtotal),
            phone: c,
            guestPage: n.fluent.request.url().done(),
          }),
          d)
        : null;
    }
...
/*
page: http://www.ballyofswitzerland.com/
