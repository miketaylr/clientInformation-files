...
(__sco.v1 = __sco.v1 || {}),
  ...
  (__sco.config = {
    ...
    startdate: 0,
    guid: "",
    v1guid: "01F1396E-DC6C-4649-9782-80CC2F12DEEA",
  ...
  (__sco.checkStatusOne = function () {
    if (document.location.href.indexOf("Basket.aspx") > -1) return !0;
  }),
  (__sco.scraper.statusone = function () {
    if (null != _scs(".table.basket-table:first")) {
        ...
        try {
          ...
          if (
            (__sco.each(_scs(".basket-table:first div.tr", "1 rows"), function (
              ...
              __sco.contains(r, "/www.prodirectrugby") &&
                (r =
                  "/productimages" +
  ...
  function (e, t, n) {
    ...
    var r = n(62),
      ...
      i = {
        ...
        firstName: ["#UserFirstName", "#cd_FIRSTNAME"],
        lastName: ["#UserLastName", "#cd_LASTNAME"],
      ...
      a = (function () {
        ...
        return (
          (e.prototype.client = function () {
            return {
              apiKey: "01F1396E-DC6C-4649-9782-80CC2F12DEEA",
              v1Id: 19125,
            };
          }),
...
/*
page: http://www.prodirectrugby.com/
url: http://d16fk4ms6rqz1v.cloudfront.net/capture/prodirectrugby.js
*/
