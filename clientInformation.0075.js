...
function GoSearch(
  ...
  if (k == "" || ui == "0") {
    alert("Geben Sie mindestens einen Suchbegriff ein.");
    if (null != event) {
...
function SetCrawlLogFilters(
  ...
  if (sch == Url) {
    alert("WÃ¤hlen Sie einen Filter aus.");
    if (null != event) {
      event.returnValue = false;
      return false;
    } else return;
...
/*
page: http://www.asvz.ch/
url: http://portal.asvz.ethz.ch/_layouts/1031/search.js?rev=hv8Jc8zmDPrdd%2B%2B%2BxpIv6w%3D%3D
*/
