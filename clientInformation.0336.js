(function () {
  ...
  var positions = {};
  try {
    positions["1559425312"] = [
      " #stap-3 .panel.panel-primary .panel-body.l-padding-top-lg .form-horizontal .well",
      "#cookiebar",
      "#l-header",
      "#livechat",
      "#stap-3 .col-sm-7.cta",
      "#stap-3 .col-sm-7.cta .btn.btn-primary.btn-block",
      "#stap-3 .col-sm-7.cta .pull-right.l-margin-top-md.l-no-margin-bottom.visible-lg",
      '#stap-3 .module-actief div[ng-if="$ctrl.module.meest_gekozen"]',
      "#stap-3 > div.panel > div.panel-body",
      "#sticky",
      ".balloon-cta-danny",
      ".col-xs-12.col-sm-12.col-md-7",
      ".col-xs-12.col-sm-8.col-md-5 p",
      ".etfaq",
      ".jumbotron .container-fluid .row",
      ".logo-default",
      ".salesfunnel-sidebar",
      ".salesfunnel-sidebar #moneyview",
      ".salesfunnel-sidebar .sidebar-widget.paragraph-dark.hidden-xs",
      "article.clearfix",
      "div#stap-3 > div.panel-primary > div.panel-body > form > fieldset:nth-of-type(1) > div > div:nth-of-type(5)",
      "div.col-md-8 > h1",
      "div.sticky-navbar > hr.line",
      "div[ng-class=\"validatie.getClasses('ingangsdatum')\"]",
      "fieldset:nth-of-type(2) > div:nth-of-type(1)",
      "fieldset:nth-of-type(2) > div:nth-of-type(2)",
      "footer#l-footer",
      'funnel-stap[titel="Dekking & Premie"] h2.pull-left',
      "h1.smaller",
      "p.pull-right.l-margin-top-md.l-no-margin-bottom.visible-lg",
      "section .jumbotron",
    ];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://inshared.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.inshared.nl/
url: https://inshared.blueconic.net/frontend/static/javascript/blueconic/blueconic.min.js
*/
