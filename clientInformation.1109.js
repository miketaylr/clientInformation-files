(function () {
  ...
  try {
    positions["-221869344"] = [
      "#calculation-result .col-xs-12.col-sm-8 .panel.no-border .panel-body.no-inset-left.no-inset-right",
      "#carousel-item-1:not(.clone)",
      "#carousel-item-2:not(.clone)",
      "#carousel-item-3:not(.clone)",
      "#vivatest .constrain.shrink.inset.pattern-hypo",
      ".hidden-xs .featured-buttons.offset-top-xsmall.offset-bottom",
      ".visible-xs .featured-buttons.offset-top-xsmall.offset-bottom",
      "a.thumb.bordered.de-decorate.text-base.third.phone-full:eq(0)",
      "a.thumb.bordered.de-decorate.text-base.third.phone-full:eq(1)",
      "a.thumb.bordered.de-decorate.text-base.third.phone-full:eq(2)",
      "a:nth-of-type(1) > div.inner",
      "a:nth-of-type(2) > div.inner",
      "a:nth-of-type(3) > div.inner",
      "body",
      "div#calculation-result > div.col-sm-4",
      "div#conversion",
      "div#makeAppointment > div:nth-of-type(2) > div:nth-of-type(1)",
      "div.calculators-result-panel-footer > div:nth-of-type(1)",
      "div.carousel",
      "div.col-12 col-md-8.margin-bottom--md",
      "div.col-xs-12 > a.btn",
      "div.constrain > p:nth-of-type(3)",
      "div.hidden-xs > div.pagemarker",
      "div.main",
      "div.main > div > div:nth-of-type(5) > h2",
      "div.neg-offset-left-small",
      "div.pagemarker.pagemarker-feedback.pagemarker-vertical.ng-scope",
      "div.shadow",
      "div:nth-of-type(2) > div.grid-container > div.grid-12 > div.col-md-8",
      "div:nth-of-type(2) > div.grid-container > div.grid-12 > div.col-md-8 > div.calculators-result-panel",
      "div:nth-of-type(5) > div.grid-container > div.grid-12 > div.col-12 > div.grid-12",
      "div:nth-of-type(5) > div.grid-line",
      "div:nth-of-type(5) > div.grid-line > a:nth-of-type(1)",
      "div:nth-of-type(5) > div.grid-line > a:nth-of-type(2)",
      "div:nth-of-type(5) > div.grid-line > a:nth-of-type(3)",
      "div:nth-of-type(6) > div.grid-line",
      'div[role="main"] h1',
      'div[ui-view="view__content--partner"]',
      'div[ui-view="view__content--verplichtingen"]',
      'div[ui-view="view__share"]',
      "footer.new-release",
      'form[name="caniBuyThisHouse"]',
      'form[name="caniBuyThisHouse"] div[ng-show="showDetails"] div.form-group.inset-left.inset-right',
      'form[name="maxHypForm"] .label.no-offset-bottom',
      'form[name="maxHypForm"] div[ng-show="showDetails"] div.inset-left.inset-right',
      "html",
      'input[name="officeSearch"]',
    ];
    positions["-1104474944"] = positions["-221869344"];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://hypotheker.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.hypotheker.nl/
url: https://hypotheker.blueconic.net/frontend/static/javascript/blueconic/blueconic.min.js
*/
