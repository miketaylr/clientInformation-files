(function () {
  var domainGroups = {};
  try {
    domainGroups["350c2cd7-60ef-46b0-a2f2-4d5090ce4faf"] = [
      "-1528329792",
      "-1597815168",
      "-1692725568",
      "-1809527776",
  ...
  try {
    positions["2020696736"] = [
      ...
      ".barContent",
      ".c-premium__content",
      ".premiumArticleHolder",
      ".reactionSection > .textPointer",
      ".socialBlock",
      "body.home div.mainContentWrapper ul#newsCollection_3166683 > li:nth-of-type(3) h4, div.mobileMainContent ul#newsCollection_3166683 > li:nth-of-type(4) h4, body.tabletHomePage ul#newsCollection_3166683 > li:nth-of-type(3) h2, article.newsArticleContent h1",
    ];
    positions["-289407840"] = positions["2020696736"];
    positions["869119328"] = positions["2020696736"];
    positions["-1692725568"] = positions["2020696736"];
    positions["1754462560"] = positions["2020696736"];
    positions["815218496"] = positions["2020696736"];
    positions["990143808"] = positions["2020696736"];
    positions["-24060480"] = positions["2020696736"];
    positions["787723744"] = positions["2020696736"];
    positions["2047650016"] = [
      "#aside_bc_button",
      "#aside_bc_button2",
      "#div-gpt-ad-001",
      "#premiumPromoRight",
      ...
      "#wmfragment_6",
      "#wmfragment_7",
      ".article-wrapper #div-gpt-ad-004",
      ".articleHeader",
      ".articlePromoBlockContent",
      ".barContent",
      ".c-premium-category__wrapper",
      ".c-premium__content",
      ".conversionPageContentHolder",
      ".conversionPageContentHolder2Cols .stepsBar",
      ".magazinePromoBlock",
      ".mainContentHolder > .mainContentWrapper > .mainContent > .standardPageContent",
      ".navigation > #item4",
      ".navigation > #item7",
      ".premiumArticleContent > .VIEditableContent",
      ".premiumPromoLarge",
      ".reactionSection > .textPointer",
      ".subscriptionModelTop",
      ".subscriptionPresentBlock",
      "aside > .asideBlock:first + .asideBlock",
      "h1.title",
      "ul.media-items",
    ];
    positions["-954672736"] = positions["2047650016"];
    positions["1544615136"] = positions["2047650016"];
    positions["-1692725568"] = positions["2047650016"];
    positions["-1916847648"] = positions["2047650016"];
    positions["1754462560"] = positions["2047650016"];
    positions["373437088"] = positions["2047650016"];
    positions["-401765984"] = positions["2047650016"];
    positions["-454360032"] = positions["2047650016"];
    positions["807913280"] = positions["2047650016"];
    positions["2070186592"] = positions["2047650016"];
    positions["-962507392"] = positions["2047650016"];
    positions["299765920"] = positions["2047650016"];
    positions["-1528329792"] = positions["2047650016"];
    positions["-1597815168"] = positions["2047650016"];
    positions["-783652896"] = positions["2047650016"];
    positions["238013024"] = positions["2047650016"];
    positions["-1809527776"] = positions["2047650016"];
    positions["1461669120"] = positions["2047650016"];
    positions["437898720"] = positions["2047650016"];
    positions["308186240"] = ["#floorad"];
    positions["-375498848"] = positions["308186240"];
    positions["392735904"] = positions["308186240"];
    positions["-2083976768"] = positions["308186240"];
    positions["698894720"] = positions["308186240"];
    positions["-94894304"] = positions["308186240"];
    positions["1015306784"] = positions["308186240"];
    positions["2125816064"] = positions["308186240"];
    positions["-1751497408"] = positions["308186240"];
    positions["1160314624"] = [
      "#google_ads_div_VrijNederland_336x280_Boven_ad_wrapper",
      "#overlay-new-site",
      ".article-break-newsletter .article-break__cta",
      ".article-break-subscription",
      ".article__content__footer .middle-align-children.margin-top-sm-half.margin-bottom-sm-half .text-label.margin-right-xs",
      ".bc.secondcolumn",
      ".card-extra--newsletter .article-break__cta",
      ".grid-wrapper",
      ".meta",
      ".meta .link",
      ".metafooter",
      ".notification",
      ".progress-bar",
      ".proposition.proposition--large",
      ".proposition__link a",
      ".vn-article.active .content__footer .vn-social-buttons__list",
      "BC",
      "BC2",
      "div.brand-logo",
      "div.deck > div:nth-of-type(1) > a.caption > img",
      "div.deck > div:nth-of-type(2) > a.caption > img",
      "div.navigation__body",
      "div.navigation__header__right",
      "h1.page__title",
    ];
    positions["1930782080"] = positions["1160314624"];
    positions["-678530304"] = positions["1160314624"];
    positions["2000271680"] = positions["1160314624"];
    positions["-918774560"] = positions["1160314624"];
    positions["-1238388480"] = positions["1160314624"];
    positions["-1558002400"] = positions["1160314624"];
    positions["1442768224"] = positions["1160314624"];
    positions["1113492544"] = positions["1160314624"];
    positions["-1832931296"] = positions["1160314624"];
    positions["-763712608"] = positions["1160314624"];
    positions["1187511168"] = positions["1160314624"];
    positions["-1156232352"] = positions["1160314624"];
    positions["961868064"] = [
      "#header-background .blockContent",
      "#header-logo",
      "#lead-image",
      ".aanbod-show",
      ".box.boxbutton",
      ".box.boxbutton.boxzwijsen",
      ".box.boxzwijsen.boxzwijsenclear",
      ".kijkverderelement",
      ".uspelement",
    ];
    positions["-835278752"] = positions["961868064"];
    positions["-1128747136"] = [
      "#header-right",
      "#order_book",
      "#searchBoxForm_div",
      "#social1",
    ...
    positions["2103630464"] = positions["-1128747136"];
    positions["912073856"] = positions["-1128747136"];
    positions["359423104"] = positions["-1128747136"];
    positions["-1296382720"] = positions["-1128747136"];
    positions["-219797472"] = positions["-1128747136"];
    positions["-398396960"] = [
      "#jq_facetsearch_results",
      ".article .content.nest",
      ".customer-info",
      ".footer",
      ".footer__top",
      ".header",
      ...
      ".webshop__categories",
      "article.grid-10",
      "div#advertorial_widget-4",
      "div#rw_article_achtergrond",
      "div.block:eq(0)",
      "div.block:eq(1)",
      "div.block:eq(2)",
      "div.block:eq(3)",
      "div.block:eq(4)",
      "div.block:eq(5)",
      "div.grid-12 > article > p:nth-of-type(2)",
      "div.woocommerce-info--ws",
      "div.wpg-element.dezemaandinhetblad",
      "div:nth-of-type(6)",
      "h1.title",
    ];
    positions["940678304"] = positions["-398396960"];
    positions["1839072832"] = positions["-398396960"];
    positions["-1637029248"] = positions["-398396960"];
    positions["639850976"] = positions["-398396960"];
    positions["-241658304"] = positions["-398396960"];
    positions["171536608"] = positions["-398396960"];
    positions["-1652589536"] = positions["-398396960"];
    positions["-882496000"] = positions["-398396960"];
    positions["-1485684864"] = [
      "#main-content",
      ".aanbod-show",
      ".checkout",
      ".wpg-element.abos-iform",
      ".wpg-element.webshop",
      "body",
      "div.content-wrapper.home_largeimage",
      "div.wpg-element.abo",
      "right .csc-textpic.csc-textpic-center dt",
    ];
    positions["1104381152"] = positions["-1485684864"];
    positions["-1227453984"] = positions["-1485684864"];
    positions["350702144"] = positions["-1485684864"];
    positions["-457893472"] = positions["-1485684864"];
    positions["-1258832064"] = positions["-1485684864"];
    positions["-476836512"] = positions["-1485684864"];
    positions["1402220096"] = positions["-1485684864"];
    positions["-645016832"] = ["#popupenquete"];
    positions["1780534688"] = [
      "#related-content .image.clear",
      ".media-overview li",
      "logo",
      "main-content",
      "search-form-small",
    ...
    positions["-853217440"] = positions["1780534688"];
    positions["129375232"] = positions["1780534688"];
    positions["549815584"] = positions["1780534688"];
    positions["970255936"] = positions["1780534688"];
    positions["1994989632"] = [
      "#related-content",
      "#three-column-layout .column-three",
      ".leaderbord",
      "wbds_plnt120x600_2",
    ];
    positions["-1433447072"] = positions["1994989632"];
    positions["932220672"] = positions["1994989632"];
    positions["1341653280"] = positions["1994989632"];
    positions["1751085888"] = positions["1994989632"];
    positions["568893536"] = positions["1994989632"];
    positions["809760256"] = positions["1994989632"];
    positions["1097207840"] = positions["1994989632"];
    positions["-1910859392"] = positions["1994989632"];
    positions["-1140765856"] = positions["1994989632"];
    positions["-370672320"] = positions["1994989632"];
    positions["-1195126976"] = [
      "#solhomeposition",
      "#solsidebarposition",
      "main-content",
    ];
    positions["1994989632"] = ["#videoisfree"];
    positions["-1916002368"] = ["#webView"];
    positions["120176416"] = [".aside .holder", ".info-box"];
    positions["1803692416"] = [".customer-info-short", "main-content"];
    positions["-810032128"] = [".navigation-grid__item.first-item"];
    positions["692367584"] = positions["-810032128"];
    positions["-1958261344"] = ["a.slick-current > div.book-cover"];
    positions["-1268089408"] = positions["-1958261344"];
    positions["-1685175168"] = ["body"];
    positions["-2081974368"] = positions["-1685175168"];
    positions["692367584"] = positions["-1685175168"];
    positions["398784"] = positions["-1685175168"];
    positions["411777184"] = positions["-1685175168"];
    positions["993986688"] = positions["-1685175168"];
    positions["804336288"] = positions["-1685175168"];
    positions["-1666943264"] = positions["-1685175168"];
    positions["-1522037024"] = [
      "div.pagina > span > table:nth-of-type(3) > tbody > tr:nth-of-type(2) > td",
    ];
    positions["1860902272"] = positions["-1522037024"];
    positions["363520576"] = positions["-1522037024"];
    positions["-1114742784"] = ["main-content"];
    positions["-1375994688"] = positions["-1114742784"];
    positions["-1038665344"] = positions["-1114742784"];
    positions["-1973114528"] = positions["-1114742784"];
    positions["-796773632"] = positions["-1114742784"];
    positions["-2137041344"] = positions["-1114742784"];
    positions["-1933315520"] = positions["-1114742784"];
  } catch (err) {}
  (function (a) {
    ...
    (function () {
      var InteractionTypeImpl = InteractionType.extend({
        ...
        onPrepare: function () {
          var a = this._getParameterByName("keyword");
          a && this.profile.setValue("current_site_search", a);
        },
      ...
      // Register listener 'keywordparameterlistener':
      window.blueConicPreListeners.push({
        id: "keywordparameterlistener",
    ...
    (function () {
      var InteractionTypeImpl = InteractionType.extend({
        SEASON_LEAGUE_PROFILE_PROPERTY: "vi_content_competitie",
        SEASON_LEAGUE_META_TAG: "related_seasonleague",
        init: function (a, b) {
          this.blueConicClient = a;
          this.context = b ? b : null;
          this.profile = a.profile.getProfile();
        ...
        onPrepare: function () {
          var a =
            this._getMetaContentByName(this.SEASON_LEAGUE_META_TAG) || "geen";
          this.profile.setValue(this.SEASON_LEAGUE_PROFILE_PROPERTY, a);
          var a = this._getParameterByName("utm_campaign"),
            b = this._getParameterByName("utm_source"),
            c = this._getParameterByName("utm_medium");
          a && b && this.profile.addValue("vi_utm_campaignsource", a + "_" + b);
          a && c && this.profile.addValue("vi_utm_campaignmedium", a + "_" + c);
        },
        _getMetaContentByName: function (a) {
          return (a = document.querySelector("meta[name='" + a + "']"))
      ...
      // Register listener 'wpg_prelistener':
      window.blueConicPreListeners.push({
        id: "wpg_prelistener",
        interactionType: InteractionTypeImpl,
      });
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://wpg.blueconic.com";
    var PROTOCOL =
...
/*
page: http://www.veiliglerenlezen.nl/
url: http://wpg.blueconic.com/frontend/static/javascript/blueconic/blueconic.min.js
*/
