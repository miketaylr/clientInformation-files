...
!(function (e) {
  ...
  function (e, t) {
    ...
    function n() {
      ...
      switch (e) {
        case "www.raja.fr":
          (r = "171b7507-bd0e-4c86-8fd1-bdfdf543dd05"),
            (t = 18514),
            (n = 1497),
            (o = "EUR"),
            (i = "FR");
          break;
        case "www.rajapack.co.uk":
          (r = "c313d771-9975-4c38-aac3-a4536bee6922"),
            (t = 18669),
            (o = "GBP"),
            (i = "UK");
          break;
        case "www.rajapack.es":
          (r = "367f4083-97f2-4a5d-85f8-9259e55195af"),
            (t = 18673),
            (o = "EUR"),
            (i = "ES");
          break;
        case "www.rajapack.ch":
          (r = "3d139f97-fc79-4bfb-a330-54860c8ad06b"),
            (t = 18674),
            (o = "CHF"),
            (i = "CH");
          break;
        case "www.rajapack.it":
          (r = "5c8bc010-45d7-463d-b825-136bef142159"),
            (t = 18672),
            (o = "EUR"),
            (i = "IT");
          break;
        case "www.rajapack.nl":
          (r = "5c93938b-a8ec-4b98-8d49-034acab7d351"),
            (t = 18653),
            (o = "EUR"),
            (i = "NL");
          break;
        case "www.rajapack.be":
          (r = "8610d377-638d-47ea-afa4-cab2d4e361f8"),
            (t = 18671),
            (o = "EUR"),
            (i = "BE");
          break;
        case "www.rajapack.pl":
          (r = "e6a4bf35-0553-4282-8184-caac71895be6"),
            (t = 18675),
            (o = "PLN"),
            (i = "PL");
          break;
        case "www.rajapack.dk":
          (r = "cce0e9eb-25bd-4939-8ff8-a52eca920f3a"),
            (t = 18670),
            (o = "DKK"),
            (i = "DK");
          break;
        case "www.rajapack.de":
          (r = "7E6D78F0-BED7-47BE-8D87-92A82AD6B94F"),
            (t = 18764),
            (o = "EUR"),
            (i = "DE");
          break;
        case "www.rajapack.at":
          (r = "616E8360-8510-4A44-BBAB-9183194EA609"),
            (t = 18763),
            (o = "EUR"),
            (i = "AT");
          break;
        case "www.rajapack.cz":
          (r = "6769D700-889A-421C-AD5D-E6F53DE69F88"),
            (t = 18765),
            (o = "CZK"),
            (i = "CZ");
          break;
      ...
      return { v1Id: t, v2Id: n, apiKey: r, currency: o, region: i };
    }
    function r(e) {
      var t = "[[_",
        r = e,
      ...
      if (
        ...
        var i = new Date().getHours(),
          a = 1,
          u = 16;
        t += a + i >= u ? "[[_AFTER4PM_]]" : "[[_BEFORE4PM_]]";
      }
      if ("IT" === o) {
        var s = window.tc_vars;
        if (s && s.order_newcustomer) {
          var c = s.order_newcustomer;
          t = t + "[[_" + c + "_]]";
        }
      }
      return t;
    }
    (t.clientData = n), (t.getFilter = r);
  },
  function (e, t) {
    "use strict";
  ...
  function (e, t, n) {
    ...
    function r(e) {
      ...
      return (
        ...
        (n.tagBag = { oa: i }),
        (n.keywords = [o.getFilter(e.fluent.request.url().done())]),
        (n.currency = o.clientData().currency),
        n
      );
    }
    var o = n(6);
  ...
  function (e, t, n) {
    ...
    function r(e) {
      ...
      return (
        ...
        (i.tagBag = { oa: a }),
        (i.keywords = [o.getFilter(e.fluent.request.url().done())]),
        (i.currency = o.clientData().currency),
        i
      );
    }
    var o = n(6);
  ...
  function (e, t, n) {
    ...
    function r(e) {
      ...
      return (
        ...
        (r.tagBag = { oa: a }),
        (r.keywords = [o.getFilter(e.fluent.request.url().done())]),
        (r.currency = o.clientData().currency),
        r
      );
    }
    var o = n(6);
  ...
  function (e, t, n) {
    ...
    function r(e) {
      ...
      if (!t.exists()) return null;
      var n,
        r = o.clientData().currency,
        i = e.fluent.querySelector(".btn-cart.fright").exists(),
        a = e.fluent
          .querySelector("meta[itemprop=sku]")
          .getAttribute("content")
          .done(),
        u = t.querySelector("div.layoutBox2 h1").textContent().done(),
        s = t
        ...
        l = c.done(),
        f = t.querySelector("div.product_media-img img");
      f.exists() && (n = f.getAttribute("src").done());
      var d = t.querySelector(".media-base-product img");
      return (
        d.exists() && (n = d.getAttribute("src").done()),
        {
          costs: { singleItem: s },
          id: a,
          images: { thumbnail: n },
