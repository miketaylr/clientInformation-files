(function () {
  ...
  var positions = {};
  try {
    positions["-2110787360"] = [
      ".page-aanvullende-informatie div.klantenvertellen",
      ".page-node-540  div.field-item > div:nth-of-type(1) > div:nth-of-type(1)",
      ".page-node-540 div.field-item > div:nth-of-type(1) > div:nth-of-type(2)",
      ".page-node-540 div.field-item > p:nth-of-type(2)",
      ".page-node-540 div.field-item > p:nth-of-type(3)",
      ".page-node-540 div.page-hero > h1",
      ".page-node-540 img.img-responsive",
      ".page-node-60318 div#block-views-7771e1bb4b935cc9528d87b313c63f74 > div.block-wrapper > div.view > div.view-content > div.row > ul.list-view > li:nth-of-type(1)",
      ".page-node-60318 li:nth-of-type(1) > article.view-wrapper > div.img > a > img.img-responsive",
      ".page-node-60318 li:nth-of-type(1) > article.view-wrapper > div.view-summary",
      ".page-node-60318 li:nth-of-type(1) > article.view-wrapper > footer",
      ".page-node-60318 li:nth-of-type(1) > article.view-wrapper > header > h2 > a",
      ".page-node-60318 li:nth-of-type(2) > article.view-wrapper > div.img > a > img.img-responsive",
      ".page-node-60318 li:nth-of-type(2) > article.view-wrapper > div.view-summary",
      ".page-node-60318 li:nth-of-type(2) > article.view-wrapper > footer",
      ".page-node-60318 li:nth-of-type(2) > article.view-wrapper > footer > a.btn",
      ".page-node-60318 li:nth-of-type(2) > article.view-wrapper > header > h2 > a",
      ".page-node-60318 li:nth-of-type(3) > article.view-wrapper > div.img > a > img.img-responsive",
      ".page-node-60318 li:nth-of-type(3) > article.view-wrapper > div.view-summary",
      ".page-node-60318 li:nth-of-type(3) > article.view-wrapper > footer",
      ".page-node-60318 li:nth-of-type(3) > article.view-wrapper > header > h2 > a",
      ".page-node-60318 li:nth-of-type(6)",
      ".page-node-60318 ul.list-view > li:nth-of-type(4)",
      ".page-node-60318 ul.list-view > li:nth-of-type(5)",
      ".page-node-60395 div.field-item > div.row > div:nth-of-type(1) > p:nth-of-type(1)",
      ".page-node-60395 div.image > h2",
      ".page-node-60395 div.image > img.img-responsive",
      ".page-node-60395 section.block_verzekering > article > h2",
      ".page-node-60395 section.verzekeringen_voorwaarden",
      ".page-node-60457 a.btn",
      ".page-node-60457 div.section--two-parted--right",
      ".page-node-98 div.block-green > div.view-wrapper > div.content",
      ".page-node-98 div.contact-options > h3:nth-of-type(2) > a",
      ".page-node-98 div.hero-content",
      ".page-node-98 div.hero-image",
      ".page-node-98 div.hero-widgets > div.row > div:nth-of-type(1)",
      ".page-node-98 div.view-content > div:nth-of-type(1) > div.col-sm-6 > a.home-category-button > img.img-responsive",
      ".page-node-98 div.view-content > div:nth-of-type(1) > div.col-xs-12",
      ".page-node-98 div.view-content > div:nth-of-type(2) > div.col-xs-12",
      ".page-node-98 div.view-wrapper > a.btn",
      ".page-node-98 div.view-wrapper > a:nth-of-type(1) > img.img-responsive",
      ".page-node-98 div:nth-of-type(1) > aside.hero-widget",
      ".page-node-98 div:nth-of-type(2) > div.contact-options > h3:nth-of-type(1)",
      ".page-node-98 h2.hero-title",
      ".page-node-98 h2.title-home",
      ".page-node-99 div.contact-options > h3:nth-of-type(2) > a",
      ".page-node-99 div.field-item",
      ".page-node-99 div:nth-of-type(2) > div.contact-options > h3:nth-of-type(1)",
      ".page-persoonsgegevens button.btn.btn-orange.btn-inverted.btn-orange-style.next-step",
      ".page-persoonsgegevens div.polisaanvraag > div.row > div:nth-of-type(3)",
      ".page-persoonsgegevens div:nth-of-type(3) > div.panel > div.panel-body > ul.fa-ul",
      ".page-search div#block-system-main > div.block-wrapper",
      ".page-start div.col-md-8",
      ".page-start div.usps.row",
      "a.belmeterug.pushcall-btn",
      "div#premiewidget > div.col-xs-12 > h2",
      "div.actionpage-hero",
      "div.add > ul.links > li:nth-of-type(2) > a.ng-binding",
      "div.col-xs-12 > div.add > ul.links > li:nth-of-type(2) > a.ng-binding",
      "div.col-xs-12 > div.content",
      "div.contact-options > div:nth-of-type(3) > a.link",
      "div.field-item > h3:nth-of-type(1)",
      "div.section--green",
      "div.section--situations",
    ];
    positions["1736770400"] = [
      ...
      "div.container > h1 > a",
      "div.contentLeftText > #introText > p",
      "div.contentLeftText > h2",
      "div.push",
    ];
    positions["408233408"] = [
      "article.node > header > h2",
      "div.navbar-header > a.btn",
      "div:nth-of-type(1) > article.node > header > h2",
    ];
    positions["731900064"] = ["div#homepage-hero > section"];
    positions["759631840"] = [
      "div.actionpage-hero--overlay",
      "div.col-xs-12 > h1",
      "div.section--situations",
      "div.usps > div.col-xs-12 > ul.row > li:nth-of-type(1) > h3.checklistitem",
    ];
  } catch (err) {}
  (function (a) {
    ...
    (function () {
      var InteractionTypeImpl = InteractionType.extend({
        ...
        onPrepare: function () {
          this.profile.setValue("in_iframe", this._inIframe());
        },
        _inIframe: function () {
          try {
      ...
      // Register listener 'iframeprelistener':
      window.blueConicPreListeners.push({
        id: "iframeprelistener",
    ...
    (function () {
      var InteractionTypeImpl = InteractionType.extend({
        TEST_GROUP_PROFILE_PROPERTY: "testgroup",
        TEST_GROUP_COOKIE_NAME: "bc_tstgrp",
        init: function (a, c) {
          this.blueConicClient = a;
        ...
        onPrepare: function () {
          if (document.querySelectorAll) {
            var a = document.querySelectorAll(
              "span.verzekeringskeuze.ng-binding"
            );
            0 < a.length &&
              (a = a[0].innerHTML) &&
              this.profile.setValue("lastchosenproduct", a);
          }
          a = this.blueConicClient.util.cookie.getCookie(
            this.TEST_GROUP_COOKIE_NAME
          );
          a ||
            ((a = Math.floor(10 * Math.random()) + 1),
            this._createCookie(this.TEST_GROUP_COOKIE_NAME, a));
          this.profile.setValue(this.TEST_GROUP_PROFILE_PROPERTY, a);
        },
        _createCookie: function (a, c, d) {
          var b = "";
          d &&
            ((b = new Date()),
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://monuta.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.monuta.nl/
url: https://cdn.blueconic.net/monuta.js
*/
