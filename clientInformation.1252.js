!(function (e) {
      ...
      u = (function () {
        ...
        return (
          (e.prototype.client = function () {
            return {
              apiKey: "b3b2142d-b5bb-4a13-9bf9-98025d37e44b",
              v1Id: 19333,
              v2Id: 1849,
            };
          }),
          (e.prototype.isPurchaseComplete = function () {
            ...
            if (
              (window &&
                window.dataLayer &&
                window.dataLayer.forEach(function (t) {
                  t.ecomm_pagetype && (e = t.ecomm_pagetype);
                }),
              "purchase" === e)
            )
              return !0;
            var t = this.api.fluent.request.url().includes("/order?", !0),
              n = this.api.fluent
                .getTextContent(".form_header")
          ...
          (e.prototype.scrapers = function () {
            ...
            return {
              ...
              order: function () {
                return {
                  id:
                    e.request.getQueryStringParameter("id") ||
                    e.request.getQueryStringParameter("finish"),
                };
              },
              product: function () {
                return o.default(e);
          ...
          (e.prototype.triggers = function () {
            ...
            return (
              ...
              {
                events: { change: e },
                watch: [{ selector: "#add_newaccount_email" }],
  ...
  function (e, t) {
    ...
    var n = (function () {
      function e(e, t) {
        (this.api = e), (this.contentDiv = t), (this.templateId = 4332);
      }
      return (
        (e.prototype.scrapers = function () {
          return {};
        ...
        (e.prototype.postScrapers = function () {
          var e = this.api;
          return {
            onContinue: function (t, n, r) {
              window.setTimeout(function () {
                window.location.replace(
                  "http://www.anrdoezrs.net/click-7573864-12534396-1461253991000?url=" +
                    window.encodeURIComponent(e.page.location().href)
                );
              }, 500);
            },
          };
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("form[name=cart]");
      if (!t.exists()) return null;
      var n = {};
      return (
        (n.items = t
          .querySelectorAll(".cart-contents > tbody > tr")
          .map(function (e) {
            var t = e.querySelector(".item a"),
              n = e
              ...
              o = t.getAttribute("href").done(),
              i = e.getTextContent(".format").done();
            if (o) {
              var a = o.match(/\/([a-z0-9]+)\?id/i);
              a && a.length > 0 && (i = a[1]);
            } else {
              if (!(i && i.indexOf(": ") > -1))
                throw new Error("Item ID does not exist");
              i = i.substring(i.indexOf(": ") + 2, i.length);
            }
            var u = e.getTextContent(".ebook-price").done();
            if (!(u && u.indexOf(": ") > -1))
              throw new Error("Item Price does not exist");
            u = u.substring(u.indexOf(": ") + 2, u.length);
            var s = e
                .getTextContent(".availability")
                .toLowerCase()
                .includes("in stock"),
              c = e.getStringValue(".quantity input").toInt().done();
            return {
              product: {
                costs: { singleItem: u },
                currency: "USD",
          ...
          .done()),
        (n.currency = "USD"),
        (n.costs = { subtotal: t.getTextContent("h3 strong").done() }),
        (n.tagBag = { basketLink: e.fluent.request.url().done() }),
        n
      );
    }
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = n);
  ...
  function (e, t) {
    ...
    function n(e) {
      var t = e.fluent.querySelector(
        ".product-detail .inner-content-container"
      );
      if (!t.exists()) return null;
      var n = t
          .getTextContent([
            ".price-block-binding .details-title-text",
            ".price-block-binding span strong",
          ])
          .done(),
        r = t
          .querySelector("#details-image-container img")
          .getAttribute("src")
          .done(),
        o = t
          .getTextContent("#details-description-container .details-title-text")
          .done(),
        i = "";
      if (
        (window &&
          ...
          window.dataLayer.forEach(function (e) {
            e.ecomm_prodid && (i = e.ecomm_prodid);
          }),
        "" === i)
      ) {
        var a = e.fluent.request
          .url()
          .done()
          .match(/\/([a-z0-9]+)\?id/i);
        a && a.length > 0 && (i = a[1]);
      ...
      return {
        ...
        inStock: t.querySelector("#addtocartlink").exists(),
      };
    }
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = n);
  },
  function (module, exports) {
    ...
    var _typeof =
      ...
      escFunc = function (e) {
        return (
          escMap[e] || "\\u" + (e.charCodeAt(0) + 65536).toString(16).substr(1)
        );
      },
      escRE = /[\\"\u0000-\u001F\u2028\u2029]/g;
        ...
        stringify: (function () {
          return function e(t) {
            ...
            if (
              ...
              if ("function" == typeof t.toJSON && !Array.isArray(t))
                return e(t.toJSON());
              if (isArray(t)) {
              ...
              if ("[object Object]" === toString.call(t)) {
                var o = [];
                for (var i in t)
                  t.hasOwnProperty(i) && o.push(e(i) + ": " + e(t[i]));
                return "{" + o.join(", ") + "}";
              }
            }
            return '"' + t.toString().replace(escRE, escFunc) + '"';
          };
        })(),
      });
  },
...
/*
page: http://www.booksamillion.com/
url: https://s.salecycle.com/booksamillion/bundle.js
*/
