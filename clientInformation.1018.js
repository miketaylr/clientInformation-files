(function () {
  var domainGroups = {};
  try {
    domainGroups["ca04632d-5c49-484d-ae4a-c9f1d7e4805e"] = ["-278937120"];
    domainGroups["fb6c5e40-b2d1-48ee-aff7-60b5f5d8437d"] = [
      "-1379468704",
      "-1980113184",
      "-439981888",
      "-668844544",
  ...
  var positions = {};
  try {
    positions["949582080"] = [".block-default.share"];
    positions["1184881760"] = [
      ".contact",
      ".masthead--big",
      "div#bc-empty1980455",
      "div#bc-empty1993199",
      "div#bc-empty_1710033_",
      "div#verhuisgegevens_input_2",
      "div.block > div:nth-of-type(2) > div.grid-unit",
      "div.block.block--ultra-light-gray",
      "div.grid--beta > div:nth-of-type(2) > div:nth-of-type(3)",
      "div.grid--beta:nth-child(2) div[id^=Linker-kolom] div[id^=content-kolom]",
      "div.grid--beta:nth-child(2) div[id^=Middelste-kolom] div[id^=content-kolom]",
      "div.grid--beta:nth-child(2) div[id^=Rechter-kolom] div[id^=content-kolom]",
      "div.grid-unit > div > h1 > span.light",
      "div.grid-unit > h1",
      'div.grid-wrapper--0:has(p.h2.margin-bottom-0.color--extra-dark-grey:contains("Premie Autoverzekering per maand"))',
      "div.hidden-mobile > div.breadcrumb > ul.breadcrumb-list",
      "div.xc-mediaitem-wrapper > h1.colored",
      "div.xc-page-wrapper > div.item",
      'div:nth-of-type(1) > div[id^="Linker-kolom"]',
      'div:nth-of-type(1) > div[id^="Rechter-kolom"]',
      "div:nth-of-type(1) > ul.link-list > li:nth-of-type(6)",
      'div[data-blueriq-component-id="P577-C2-C0"]',
      'div[data-module="notificationCenter.List"]:has(h3:contains("Heeft u al aangegeven of u belastingplichtig bent in het buitenland?"))',
      "form.form.pageform p:eq(1)",
      'form:has(li.current:contains("2")) h1',
      "form[name='pageform'] > div.buttons",
      "form[name='pageform'] > p:nth-of-type(1)",
      "label > a",
      'li[data-collapser-id="Verzekering-Variant_1-row-1"]:has(label:contains("WA")) span:eq(0)',
      'li[data-collapser-id="Verzekering-Variant_1-row-2"]:has(label:contains("WA Extra")) span:eq(0)',
      'li[data-collapser-id="Verzekering-Variant_1-row-3"]:has(div.radiobutton--custom.checked)',
      'li[data-collapser-id="Verzekering-Variant_1-row-3"]:has(label:contains("WA Casco")) span:eq(0)',
    ];
    positions["2096622944"] = positions["1184881760"];
    positions["131952032"] = positions["1184881760"];
    positions["-1462558016"] = positions["1184881760"];
    positions["1872873408"] = positions["1184881760"];
    positions["-1424021888"] = positions["1184881760"];
    positions["2042293472"] = positions["1184881760"];
    positions["188037376"] = positions["1184881760"];
    positions["-434202208"] = positions["1184881760"];
    positions["1751242208"] = positions["1184881760"];
    positions["520221536"] = positions["1184881760"];
    positions["816681440"] = [
      ".masthead--big",
      "div#3-6-_1404847_",
      "div#Rechter-kolom_1397243_ > h2.colored",
      "div#bc-empty_1650287_",
      "div#bc-empty_1661350_",
      "div#bc-empty_1710033_",
      "div#content__1342791_",
      'div.col-one-whole.col-t-one-half.col-t-borderleft.gridpart:has(span:contains("helpen?"))',
      "div.grid--beta > div:nth-of-type(1) > div:nth-of-type(3)",
      "div.grid--beta > div:nth-of-type(2) > div.block",
      "div.grid--block-nu > div.grid-unit > div.block",
      "div.grid-unit > h1",
      "div.menu-service",
      "div.xc-mediaitem-wrapper > p",
      'div:nth-of-type(1) > div[id^="Linker-kolom"]',
      "div:nth-of-type(1) > label.grid-unit",
      "div:nth-of-type(2) > div:nth-of-type(1) > div.item",
      'div[data-module="notificationCenter.List"]:has(h3:contains("Wilt u aangeven of u belastingplichtig bent in het buitenland?"))',
      "form.form.pageform",
      "form.form.pageform p:eq(1)",
      "form[name='pageform'] > div:nth-of-type(2) > h2",
      "h2",
      "input#Stap2Next-_1",
    ];
    positions["-797369920"] = [
      ".masthead--big",
      "div#Linker-kolom_1352159_",
      "div#bc-empty1802073",
      "div#bc-empty1802087",
      "div#bc-empty1802110",
      "div#bc-empty1802111",
      ...
      "div#bc-empty1802115",
      "div.grid--beta:nth-child(2) div[id^=Linker-kolom] div[id^=content-kolom]",
      "html > body > div#page > div.section > div.grid--beta > div:nth-of-type(1) > div.xc-page-wrapper > div",
    ];
    positions["386418976"] = [".masthead--big", "div#bc-empty_1616514_"];
    positions["2133110368"] = [
      "div#content__353458_",
      "div#sidebar_save_calculation",
      "div.grid-unit > div.item",
      "div.masthead-content",
      "div:nth-of-type(2) > div:nth-of-type(2) > div.block",
      "div:nth-of-type(2) > p",
    ];
    positions["-278937120"] = [
      "div#content__360136_",
      "div#part1",
      "div#part2",
      "div:nth-of-type(2) > div:nth-of-type(2) > div.block",
    ];
    positions["-1379468704"] = [
      "div#section sect-mydata",
      "div:nth-of-type(1) > div.item-body",
    ];
  } catch (err) {}
  (function (a) {
    ...
    (function () {
      var InteractionTypeImpl = InteractionType.extend({
        ...
        onPrepare: function () {
          var a = this._getParameterByName("ns_campaign");
          a &&
            (this.profile.setValue("current_ns_campaign", a),
            this.profile.addValue("ns_campaign", a));
          if ((a = this._getParameterByName("ns_mchannel")))
            this.profile.setValue("current_ns_mchannel", a),
              this.profile.addValue("ns_mchannel", a);
          if ((a = this._getParameterByName("ns_source")))
            this.profile.setValue("current_ns_source", a),
              this.profile.addValue("ns_source", a);
          if ((a = this._getParameterByName("ns_linkname")))
            this.profile.setValue("current_ns_linkname", a),
              this.profile.addValue("ns_linkname", a);
          window._bcUserLoggedIn
            ? this.profile.setValue("login_state", "yes")
            : this.profile.setValue("login_state", "no");
        },
        _getParameterByName: function (a) {
          a = a.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
          a = RegExp("[\\?&]" + a + "=([^&#]*)", "i").exec(window.location);
          return null == a ? "" : decodeURIComponent(a[1].replace(/\+/g, " "));
        },
      });
      // end of interaction type

      // Register listener 'nn_prelistener':
      window.blueConicPreListeners.push({
        id: "nn_prelistener",
        interactionType: InteractionTypeImpl,
      });
...
/*
page: http://www.nn.nl/
url: https://cdn.blueconic.net/nn.js
*/
