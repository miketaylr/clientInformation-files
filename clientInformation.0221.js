(function () {
  ...
  var positions = {};
  try {
    positions["1034765280"] = [
      ".sellect-product-grid",
      "a:nth-of-type(1) > figure > img.main-img",
      "body > section > div.sellect-product-recommendation > div.carousel.slides-8.slick-initialized.slick-slider",
      "clippath#cut-off-bottom > polygon:nth-of-type(1)",
      'div > section[data-fade-order="0"]',
      'div > section[data-fade-order="1"]',
      'div > section[data-fade-order="2"]',
      'div > section[data-fade-order="3"]',
      'div > section[data-fade-order="4"]',
      "div.careers_page",
      "div.checkout > div.line-items > div > div.product-info > div.price",
      "div.checkout-wrapper",
      "div.content-wrap",
      "div.filter > label.title",
      "div.footer-bar",
      "div.no-tablet",
      "div.no-tablet > p:nth-of-type(1)",
      "div.no-tablet > p:nth-of-type(2)",
      "div.promotion > span",
      "div.sort > label.title",
      "div:nth-of-type(3) > p",
      "figure.video-cta > img.main-img",
      "html > body",
      "nav.primary-nav > ul > li:nth-child(4)",
      "p.offer",
      "section.cservice > div.inner",
      "section.plp-sidebar",
      "section.window > footer",
      "section.window > main > nav.breadcrumbs",
      "section:nth-of-type(1) > div.column-wrapper > section.column > a > div.image-wrapper > img",
      "section:nth-of-type(2) > a > div.image-wrapper > img",
      "section:nth-of-type(2) > div.column-wrapper > section:nth-of-type(1) > a > div.image-wrapper > img",
      "section:nth-of-type(3) > a > div.image-wrapper > img",
      "span.bg > img",
      "ul.category-ul",
    ];
    positions["-121605152"] = positions["1034765280"];
    positions["-664370176"] = positions["1034765280"];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://elietahari.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.elietahari.com/
url: https://cdn.blueconic.net/elietahari.js
*/
