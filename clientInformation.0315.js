...
(__sco.v1 = __sco.v1 || {}),
  ...
  (__sco.copy = {
    "28 day ultimate teatox":
      "Start your SkinnyMint journey today and get the body you want in 28 days. ",
    "besties value teatox (2x28day)":
      "Start your SkinnyMint journey today and get the body you want in 28 days. ",
    "morning boost":
      "Start your SkinnyMint journey today and get the body you want in 28 days. ",
    "14 day starter teatox":
      "Start your SkinnyMint journey today and get working on the body you want in just 14 days",
    "night cleanse":
      "Start your SkinnyMint journey today and get working on the body you want in just 14 days",
  }),
  (__sco.config = {
    ...
    startdate: 0,
    guid: "",
    v1guid: "c204ced3-9b50-4cf1-bc07-20ab87f6d6d3",
    triggers: ["exit", "timeout"],
    status1: ["cart"],
    status2: ["STATUSTWO"],
    status3: ["orders/thank_you"],
    status4: ["STATUSFOUR"],
    exclude: ["RUN ON EVERYTHING"],
    onchange: {
      email: ["#spree_user_email", "#mce-email", "#order_email"],
      first: ["#order_bill_address_attributes_firstname"],
      last: ["#order_bill_address_attributes_lastname"],
      telephone: [],
      mobile: [],
      salutation: [],
      optout: [],
    },
    block: { email: ["gorgeous@you.com", "We wont spam you :)"] },
    optneg: !1,
    external: {
  ...
  (__sco.funnyMoney = function (e) {
    return (e = __sco.contains(e, "Ø¥")
      ? __sco.inbetween("Ø¥", "", e, "fl")
      : __sco.contains(e, "Ù")
      ? __sco.inbetween("Ù", "", e, "fl")
      : __sco.contains(e, "Ø¯")
      ? __sco.inbetween("Ø¯", "", e, "fl")
      : __sco.pricecurr(e));
  }),
  (__sco.scraper.statusone = function () {
    if (_scs("#cart-detail #line_items")) {
      try {
        var e = _scs(
          "#order-total .total:first .total-amount:first",
          "0 totalprice",
          ["text"]
        );
        (__scd.b.v = __sco.funnyMoney(e)),
          (__scd.b.c = __sco.inbetween(
            "(",
            ")",
            _scs(
              "#s2id_currency span.select2-chosen:first span:first",
              "1 currency select",
              ["text"]
            ),
            "lf"
          ...
          (__scd.s.abt = _scs(
            "#order-total .total:first .total-amount:first",
            "2 totalprice formated with curr",
            ["text"]
          ));
      } catch (e) {
      ...
      try {
        if (
          (__sco.each(_scs("#line_items .line-item", "1 rows"), function (
            e,
            t
          ) {
            var o = "(http://|https://)",
              s = "(http://|https://)",
              c = _scs(
                [t, ".cart-item-image:first img:first"],
                "1.1 item image"
              ),
              n = _scs(
                [t, ".cart-item-info:first .cart-item-image:first a:first"],
                "1.2 item link"
              ),
              _ = _scs(
                [t, ".cart-item-info:first .cart-item-description:first h4"],
                "1.3 item name",
                ["text"]
              ),
              r = _scs(
                [t, ".cart-item-info:first .cart-item-price:first h4:first"],
                "1.4 item value",
                ["text"]
              ),
              i = __sco.funnyMoney(r),
              a = _scs(
                [
                  t,
                  ".cart-item-cost:first .cart-item-quantity:first .line_item_quantity:first",
                ],
                "1.5 item quan",
                ["getvt"]
              ),
              u = _scs(
                [t, ".cart-item-cost:first .cart-item-total:first"],
                "1.6 item subtotal with currency",
                ["text"]
              ),
              l =
                null != _scs("#country")
                  ? _scs("#country", "1.7 get current country", ["getvt"])
                  : "",
              m =
                null != _scs("#currency")
                  ? _scs("#currency", "1.8 get website country", ["getvt"])
                  : "",
              p =
                __sco.contains(l.toLowerCase(), "united kingdom") ||
                __sco.contains(m.toLowerCase(), "uk")
                  ? "[[NOSEND]]"
                  : "";
            __scd.b.i.push({
              n: _,
              ...
              v: i,
              tf: u,
              f1: __sco.clear(__sco.attr(n, "href"), s, "g"),
              f2: p,
              u: __sco
                .clear(__sco.attr(c, "src"), o, "g")
          ...
          for (var t = 0, o = 0; o < __scd.b.i.length; o++)
            t += Number(__scd.b.i[o].q);
          __scd.s.totals = t;
        }
        if (__scd.b.i)
          if (__scd.b.i.length > 1)
            __scd.s.copy =
              "Start your SkinnyMint journey today and join hundreds of thousands of customers who have kickstarted a healthy lifestyle with us.";
          else
            switch (!0) {
              case __sco.contains(__scd.b.i[0].n, "14"):
                __scd.s.copy =
                  "Start your SkinnyMint journey today and get working on the body you want in just 14 days.";
                break;
              case __sco.contains(__scd.b.i[0].n, "Night"):
                __scd.s.copy =
                  "Start your SkinnyMint journey today and get working on the body you want in just 14 days.";
                break;
              case __sco.contains(__scd.b.i[0].n, "28"):
                __scd.s.copy =
                  "Start your SkinnyMint journey today and get the body you want in 28 days.";
                break;
              case __sco.contains(__scd.b.i[0].n, "Morning"):
                __scd.s.copy =
                  "Start your SkinnyMint journey today and get the body you want in 28 days.";
            }
      } catch (e) {
  ...
  (__sco.scraper.statusthree = function () {
    try {
      __scd.s.ordernumber = __sco.text(_scs(".order-number:first"));
    } catch (e) {
          ...
          return (
            ...
            "htmlelement" != __sco.type(t) && 0 < t.length
              ...
              : (p =
                  "htmlelement" != __sco.type(t) && 0 == t.length
                    ? p.concat(
                        __sco.toarray(
                          (l ? t : document).getElementsByTagName(
                            s(e.match(m.TAG)[0])
                          )
                        )
                      )
            ...
            "" === d[o]
              ? 0 === p.length
                ? null
                : p
              : u(d[o], null == p || 0 == p.length ? null : p, o, 1)
          );
  ...
  (__sco.pricecurr = function (e, t) {
    ...
    if (
      ...
      var i = e.replace(/[^\d\,\.]/g, "").match(/[\d]+/g),
        ...
        u = e.match(new RegExp("(" + _.replace(/\$/g, "\\$") + ")"), "i");
      return (
        null != a
          ? (__sco.cursym = a[0])
...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    var r = n(62),
      ...
      i = {
        ...
        firstName: ["#order_bill_address_attributes_firstname"],
        lastName: ["#order_bill_address_attributes_lastname"],
      },
      u = (function () {
        function e(e) {
          this.api = e;
        ...
        return (
          (e.prototype.client = function () {
            return {
              apiKey: "c204ced3-9b50-4cf1-bc07-20ab87f6d6d3",
              v1Id: 18781,
            };
          }),
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("#cart-detail #line_items");
      ...
      n.items = t
        ...
        .map(function (e) {
          var t = e
              .querySelector(".cart-item-image a img")
              .getAttribute("src")
              .done(),
            n = e
              .querySelector(".cart-item-image a")
              .getAttribute("href")
              .done(),
            r = e
              .querySelector(".cart-item-description h4")
              .textContent()
              .done(),
            o = e.querySelector(".cart-item-price h4").textContent().done(),
            i = e
              .querySelector(".cart-item-quantity input")
              .value()
              .toInt()
              .done(),
            u = e.querySelector(".cart-item-total").textContent().done();
          return {
            product: {
              name: r,
              url: n,
        ...
        .done();
      var r = e.fluent.querySelector(".total-amount").textContent().done();
      if (
        ((n.costs = { subtotal: r, total: r }),
        (n.currency = "USD"),
        (n.tagBag = {
          copy:
            "Start your SkinnyMint journey today and join hundreds of thousands of customers who have kickstarted a healthy lifestyle with us.",
        ...
        var o = e.fluent.fromValue(n.items[0].product.name);
        (o.includes("14") || o.includes("Night", !0)) &&
          (n.tagBag.copy =
            "Start your SkinnyMint journey today and get working on the body you want in just 14 days."),
          (o.includes("28") || o.includes("Morning", !0)) &&
            (n.tagBag.copy =
              "Start your SkinnyMint journey today and get the body you want in 28 days.");
      }
      return n;
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("#wrapper .product");
      if (!t.exists()) return null;
      var n = "",
        r = "",
        o = t.querySelector("#product-price"),
        i = o.querySelector(".old-price");
      return (
        i.exists() && (n = i.textContent().done()),
        (r = o.querySelector(".price").textContent().done()),
        {
          name: t.querySelector(".product-heading h1").textContent().done(),
          costs: { singleItem: r, previous: n },
          inStock: !0,
          url: e.fluent.request.url().done(),
          images: {
            thumbnail: t.querySelector("img").getAttribute("src").done(),
          },
        }
      );
    }
...
/*
page: http://www.skinnymint.com/
url: https://d16fk4ms6rqz1v.cloudfront.net/capture/SKINNYMINTAPJ.js
*/
