function isStatusOne() {
  return !!(
    __sco.contains(__sco.loc.toLowerCase(), "/index.cfm") &&
    __sco.contains(__sco.loc.toLowerCase(), "page=cart:cart") &&
    __sco.contains(
      __sco.text(_scs("#cartheading")).toLowerCase(),
      "shopping cart"
    )
  );
}
function isStatusThree() {
  return !(
    !__sco.contains(__sco.loc.toLowerCase(), "page=checkout:ordercomplete") ||
    !__sco.contains(
      _scs("h1#complete", "", ["text"]).toLowerCase(),
...
(__sco.v1 = __sco.v1 || {}),
  ...
  (__sco.config = {
    ...
    startdate: 0,
    guid: "",
    v1guid: "ca57cda4-ef4f-4e82-aa4e-fccde5e1de51",
  ...
  (__sco.scraper.statusone = function () {
    "undefined" == __sco.type(__sco.divmonitor) &&
      ((__sco.divmonitor = new __sco.monitor()),
      (__sco.divmonitor.compare = function () {
        return null != _scs("td#totalamount")
          ? _scs("td#totalamount").innerHTML
          : "";
      }),
      (__sco.divmonitor.action = function () {
        __sco.management.prerun();
      }),
      (__sco.divmonitor.startstate =
        null != _scs("td#totalamount") ? _scs("td#totalamount").innerHTML : ""),
      __sco.divmonitor.start());
    var t = 1,
      e = "",
      o = 0;
    if (null != _scs("#cart .lineItem")) {
      try {
        __sco.each(_scs("#cart .lineItem", "100 product rows"), function (
          s,
          c
        ) {
          var n = "(http://|https://)",
            _ = __sco.inbetween(
              ...
              "w_60,h_60/",
              __sco.attr(
                _scs([c, "img.productimage:first"], "101 first image"),
                "src"
              ),
              "fl"
            ),
            r = __sco.inbetween(
              ...
              "",
              __sco.attr(
                _scs([c, "img.productimage:first"], "102 last image"),
                "src"
              ),
              "fl"
            ),
            i = _ + "w_100,h_100/" + r,
            a = _scs(
              [c, "div.productinfo:first strong:first"],
              "103 item name",
              ["text"]
            ),
            u = _scs([c, "td.quantity input:first"], "104 item quantity", [
              "getvt",
            ]),
            l =
              null != _scs([c, ".product-finish:first span:nth-child(1)"])
                ? __sco.inbetween(
                    "Finish/Color -",
                    "",
                    _scs(
                      [c, ".product-finish:first span:nth-child(1)"],
                      "105 item stock",
                      ["text"]
                    ),
                    "fl"
                ...
                : "",
            p =
              null != __sco.text(_scs([c, "span.instock:first"]))
                ? _scs(
                    [c, ".product-finish:first .instock:first"],
                    "106 item stock",
                    ["text"]
                  )
                : "",
            m = a + l + t;
          if (null != _scs([c, "span.newPrice:first"]))
            var g =
                (_scs([c, "span.originalPrice:first"], "108 original price", [
                  "text",
                  "pricecurr",
                ]),
                _scs([c, "span.newPrice:first"], "109 new price", [
                  "text",
                  "pricecurr",
                ])),
              d = g;
          else
            var d = _scs([c, "td.unitprice:first"], "110 item price", [
              "text",
              "pricecurr",
            ]);
          var f = "";
          null != _scs([c, "div.productinfo:first a:first"]) &&
            null !=
              __sco.attr(
                _scs([c, "div.productinfo:first a:first", "111 item link"]),
                "href"
              ) &&
            (f = __sco.clear(
              __sco.attr(
            ...
            o < 10
              ? __scd.b.i.push({
                  ...
                  ed1: e,
                  ed2: l,
                  f2: __sco.support.mobile ? "[[MOBILE]]" : "[[DESKTOP]]",
                })
      ...
      try {
        (__scd.b.c = "USD"),
          (e = _scs("span#cartQuantity", "112 cart contents", ["text"])),
          e > 9 && (e = ""),
          null != _scs(".free-shipping:first")
            ? (__scd.s.shippingAmt = "0.00")
            : null != _scs(".faux-shipping-savings:first")
            ? (__scd.s.shippingAmt = "0.00")
            : null != _scs("#shippingamount") &&
              (__scd.s.shippingAmt =
                0 == __sco.pricecurr(__sco.text(_scs("#shippingamount")))
                  ? "0.00"
                  : _scs("#shippingamount", "113 shipping amount", [
                      "text",
                      "pricecurr",
                    ])),
          (__scd.s.subtotalAmt =
            null != _scs("#subtotalamount")
              ? _scs("#subtotalamount", "114 subtotal amount", [
                  "text",
                  "pricecurr",
                ])
              : "0.00"),
          null != _scs("#taxAmount")
            ? (__scd.s.taxAmt =
                0 == __sco.pricecurr(__sco.text(_scs("#taxAmount")))
                  ? "0.00"
                  : _scs("#taxAmount", "115 tax amount", ["text", "pricecurr"]))
            : (__scd.s.taxAmt = "0.00"),
          (__scd.s.cartItems = e),
          (__scd.s.coupon = _scs("div#discountamount")
            ? _scs("div#discountamount", "116 coupons!", ["text", "pricecurr"])
            : ""),
          null != _scs("#totalamount .newPrice:first")
            ? (__scd.b.v = _scs(
                "#totalamount .newPrice:first",
                "200 subtotal",
                ["text", "pricecurr"]
              ))
            : null != _scs("#subtotalamount") &&
              (__scd.b.v = _scs("#subtotalamount", "201 subtotal", [
                "text",
                "pricecurr",
              ])),
          (__scd.s.at = parseFloat(
            Number(__scd.s.subtotalAmt) + Number(__scd.s.shippingAmt)
          ).toFixed(2));
      } catch (t) {
  ...
  (__sco.scraper.statusthree = function () {
    try {
      __scd.s.ordernumber = __sco.inbetween(
        "is:",
        "",
        _scs("div.featured h3", "ordernumber", ["text"]),
        "fl"
      );
    } catch (t) {
    ...
    try {
      ...
      if (
        ...
        (e = !0),
          ...
          (t = __sco.tonumber(t)) && 300 <= t && 400 > t
        ...
        (e = !0),
          ...
          (t = __sco.tonumber(t)) && 400 <= t && 500 > t
            ? __sco.management.setstatus(t, __sco.management.run)
        ...
        o
          ...
          : (t = __sco.tonumber(t)) && 100 <= t && 200 > t
          ? __sco.management.setstatus(t, __sco.management.run)
        ...
        (0 < (t = __sco.management.isstatus(__sco.config.status2)) ||
          ...
          (t = __sco.tonumber(t)) && 200 <= t && 300 > t
            ? __sco.management.setstatus(t, __sco.management.run)
  ...
  (_scs = function (t, e, o) {
    ...
    function i(t, e, o) {
      ...
      return (
        (1 !== t.nodeType && 9 !== t.nodeType) ||
          (e
            ? ((e = __sco.attr(t, o.match(p.ATTR)[1])),
              null != e &&
                null != e.match(new RegExp("^" + o.match(p.ATTR)[5] + "$")) &&
                (s = s.concat(__sco.toarray(t))))
            : ((t = t.getElementsByTagName("*")),
              __sco.each(t, function (t, e) {
                var c = __sco.attr(e, o.match(p.ATTR)[1]);
                null != c &&
    ...
    function a(t, e, o) {
      ...
      return (
        (1 !== t.nodeType && 9 !== t.nodeType) ||
          (e
            ? null != __sco.attr(t, s(o.match(p.ATTR)[1])) &&
              (c = c.concat(__sco.toarray(t)))
            : ((t = t.getElementsByTagName("*")),
              __sco.each(t, function (t, e) {
                __sco.attr(e, s(o.match(p.ATTR)[1])) &&
    ...
    function u(t, e, o, l) {
      if (null != e) {
        if (null != t.match(p.ID)) {
          d[o] = __sco.ltrim(d[o].replace(t.match(p.ID)[0], ""));
          var m = document.getElementById(s(t.match(p.ID)[1])),
            m = null == m ? null : m.id != s(t.match(p.ID)[1]) ? null : m;
          return "" === d[o] ? m : u(d[o], m, o, 1);
        }
        if (null != t.match(p.TAG))
          return (
            (d[o] = __sco.ltrim(d[o].replace(t.match(p.TAG)[0], ""))),
            (m = []),
            "htmlelement" != __sco.type(e) && 0 < e.length
              ? __sco.each(e, function (e, o) {
                  1 === o.nodeType &&
                    (m = m.concat(
                      __sco.toarray(
                        o.getElementsByTagName(s(t.match(p.TAG)[0]))
                      )
                    ));
                })
              : (m =
                  "htmlelement" != __sco.type(e) && 0 == e.length
                    ? m.concat(
                        __sco.toarray(
                          (l ? e : document).getElementsByTagName(
                            s(t.match(p.TAG)[0])
                          )
                        )
                      )
                    : m.concat(
                        __sco.toarray(
                          e.getElementsByTagName(s(t.match(p.TAG)[0]))
                        )
                      )),
            "" === d[o]
              ? 0 === m.length
                ? null
                : m
              : u(d[o], null == m || 0 == m.length ? null : m, o, 1)
          );
        if (null != t.match(p.CLASS))
          return (
            (d[o] = __sco.ltrim(d[o].replace(t.match(p.CLASS)[0], ""))),
            (m = []),
            ...
            -1 <
                ...
                ? __sco.each(e, function (e, o) {
                    1 === o.nodeType &&
                      (m = l
                        ...
                        : m.concat(
                            __sco.toarray(
                              o.getElementsByClassName(s(t.match(p.CLASS)[1]))
                            )
                          ));
                  })
                : (m = m.concat(
                    __sco.toarray(
                      ("htmlelement" != __sco.type(e) && 0 == e.length
                        ? document
                        : e
                      ).getElementsByClassName(s(t.match(p.CLASS)[1]))
                    )
                  ))
              : "htmlelement" != __sco.type(e) && 0 < e.length
              ? __sco.each(e, function (e, o) {
              ...
              : (m =
                  "htmlelement" != __sco.type(e) && 0 == e.length
                    ...
                    ? m.concat(
                        __sco.toarray(
                          _(__sco.toarray(e), s(t.match(p.CLASS)[1]))
                        )
                      )
                    : m.concat(
                        __sco.toarray(
                          _(e.getElementsByTagName("*"), s(t.match(p.CLASS)[1]))
                        )
                      )),
            "" === d[o]
              ? 0 === m.length
        ...
        if (null != t.match(p.ATTR))
          return (
            (d[o] = __sco.ltrim(d[o].replace(t.match(p.ATTR)[0], ""))),
            (m = []),
            "undefined" != typeof t.match(p.ATTR)[5]
              ? "htmlelement" != __sco.type(e) && 0 < e.length
                ? __sco.each(e, function (e, o) {
                    m = m.concat(i(o, l, t));
                  })
        ...
        if (null != t.match(p.CHILD)) {
          var g = t.match(p.CHILD),
            m = [];
          if (
            ((d[o] = __sco.ltrim(d[o].replace(t.match(p.CHILD)[0], ""))),
                ...
                "undefined" != __sco.type(g[2])
                  ? "htmlelement" != __sco.type(e) && 0 < e.length
                    ? __sco.each(e, function (t, e) {
                        m = m.concat(__sco.toarray(c(e.childNodes, g[2])));
                      })
                    : (m =
                        "htmlelement" != __sco.type(e) && 0 == e.length
                          ? []
                          : m.concat(__sco.toarray(c(e.childNodes, g[2]))))
                  : "htmlelement" != __sco.type(e) && 0 < e.length
                  ? __sco.each(e, function (t, e) {
            ...
            if ("elemp" == g[1])
              return (
                "htmlelement" != __sco.type(e) && 0 < e.length
                  ? __sco.each(e, function (t, e) {
                      m = m.concat(__sco.toarray(r(s(g[2]), e)));
                    })
                  : (m =
                      "htmlelement" != __sco.type(e) && 0 == e.length
                        ? []
                        : m.concat(__sco.toarray(r(s(g[2]), e)))),
                "" === d[o]
                  ? 0 === m.length
                    ? null
                    : m
  ...
  (__sco.clear = function (t, e, o, s) {
    ...
    return "string" != c || ("string" != c && ("string" != n || "regexp" != n))
      ? null
      : t.replace(
          "regexp" == n ? e : "string" == _ ? new RegExp(e, o) : new RegExp(e),
  ...
  (__sco.pricecurr = function (t, e) {
    ...
    if (
      ...
      var i = t.replace(/[^\d\,\.]/g, "").match(/[\d]+/g),
        a = t.match(new RegExp("(" + r + ")"), "i"),
        u = t.match(new RegExp("(" + _.replace(/\$/g, "\\$") + ")"), "i");
      return (
        null != a
          ? (__sco.cursym = a[0])
          : null != u && (__sco.cursym = s[u[0]] || ""),
  ...
  (__sco.iterateExecute = function (t, e, o) {
    if (("undefined" == typeof o && (o = []), __sco.isArray(t))) {
    ...
    function t(t, e) {
      ...
      return (
        __sco.each(t, function (t, s) {
          null != e.match(new RegExp(s)) &&
            "Unknown" == o &&
            (o = e.match(new RegExp(s))[0]);
        }),
        o
      );
    }
  ...
  (__sco.storage.set = function (t, e, o) {
    ...
    try {
      ...
      if (
        ...
        "number" === __sco.type(o) && -1 < o && __sco.storage.remove(t),
        7168 - 2 * document.cookie.length > c.length)
      )
        if (1800 < c.length)
          for (var n = Math.ceil(c.length / 1800), _ = 0; _ < n; _++)
            s(t + "__" + _.toString(), c.substring(0, 1800), o),
              (c = c.substr(1800));
        else s(t, c, o);
    } catch (t) {}
  }),
  ...
  (__sco.format = function (t, e) {
    ...
    return (
      __sco.each(t, function (t, s) {
        o = "undefined" != typeof s[e] ? o + (s[e] + "|") : o + "|";
      }),
      o
    );
  }),
  (__sco.translatetov1 = function (t) {
    try {
      ...
      return (
        __sco.each(__scd.b.i, function (t, e) {
          s.push(__sco.fields(e, __sco.config.itemfields));
        }),
        "c=" +
          e.i1 +
          "&b=" +
...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    var r = n(62),
      ...
      a = {
        ...
        phone: { mobile: ["#shippingphonenumber"] },
      },
      s = (function () {
        function e(e) {
          this.api = e;
        ...
        return (
          (e.prototype.client = function () {
            return {
              apiKey: "ca57cda4-ef4f-4e82-aa4e-fccde5e1de51",
              v1Id: 18538,
            };
          }),
          (e.prototype.isPurchaseComplete = function () {
            var e = this.api,
              t = e.fluent.request
                .url()
                .includes("page=checkout:ordercomplete", !0),
              n = e.fluent
                .querySelector("#complete")
                .textContent()
                .includes("thank you, your order is complete!", !0);
            return t && n;
          }),
          (e.prototype.scrapers = function () {
            ...
            return {
              basket: function () {
                return r.default(e) || i.default(e);
              },
              customer: function () {
                return {
              ...
              order: function () {
                var t = e.fluent.querySelector("div.featured h3");
                return t.exists()
                  ? { id: t.textContent().between("is:", "").done() }
                  : null;
              },
              product: function () {
                return o.default(e) || u.default(e);
              },
            };
          }),
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelectorAll("#cart tbody .lineItem");
      if (!t.exists()) return null;
      var n = {};
      n.items = t
        .map(function (e) {
          var t = e.querySelector("td.quantity input").value().toInt().done(),
            n = e.getTextContent("div.productinfo strong").done(),
            r = "",
            o = e.querySelector(".product-finish span:nth-child(2)");
          o.exists() && (r = o.textContent().done());
          var i = n + " " + r,
            u = e.querySelector("img.productimage").getAttribute("src").done();
          u && (u = u.replace("w_60,h_60/", "w_100,h_100/"));
          var a = e.querySelector("span.originalPrice"),
            s = e.querySelector("span.newPrice"),
            c = e.querySelector("td.unitprice span"),
            l = "",
            f = "";
          a.exists() && s.exists()
            ? ((l = s.textContent().done()), (f = a.textContent().done()))
            : c.exists() && (l = c.textContent().done());
          var d = "",
            p = e.querySelector("div.productinfo a").getAttribute("href");
          return (
            p.exists() && (d = p.done()),
            {
              product: {
                costs: { singleItem: l, previous: f },
                id: i,
                images: { thumbnail: u },
                inStock: !0,
                name: n,
        ...
        .done();
      var r = "",
        o = e.fluent.querySelector("#shippingamount");
      e.fluent.querySelector(".free-shipping").exists() ||
      e.fluent.querySelector(".faux-shipping-savings").exists() ||
      "--" === o.textContent().done()
        ? (r = "0.00")
        : o.exists() && (r = o.textContent().done());
      var i = e.fluent.querySelector("#subtotalamount"),
        u = i.exists() ? i.textContent().done() : "0.00",
        a = e.fluent.querySelector("#totalamount .newPrice"),
        s = a.exists() ? a.textContent().done() : u,
        c = e.fluent.querySelector("#taxAmount"),
        l = "";
      l =
        c.exists() && "--" !== c.textContent().done()
          ? c.textContent().done()
          : "0.00";
      var f = e.fluent.querySelector("#discountamount"),
        d = f.exists() ? f.textContent().done() : "",
        p =
          Number(u.replace("$", "").replace(",", "")) +
          Number(r.replace("$", ""));
      return (
        (n.costs = { subtotal: u, total: s }),
        (n.tagBag = {
          shippingAmt: r,
          subtotalAmt: u,
          taxAmt: l,
          coupon: d,
          at: parseFloat(p.toString()).toFixed(2),
        }),
        (n.keywords = ["[[DESKTOP]]"]),
        n
      );
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("div.cart-items div.cart-item"),
        n = e.fluent.querySelector("div.cart-items");
      if (!t.exists()) return null;
      var r = {};
      r.items = n
        .querySelectorAll("div.cart-item")
        .map(function (e) {
          var t = e.querySelector(".js-qty-input").value().toInt().done(),
            n = e.getTextContent("a.item-title").done(),
            r = e.getTextContent("li.text-grey-medium").done(),
            o = n + r,
            i = e.querySelector("img").getAttribute("src").done(),
            u = e.getTextContent(".text-green.actual-price").done(),
            a = "",
            s = e.querySelector("div.productinfo a").getAttribute("href");
          s.exists() && (a = s.done());
          var c = !!e.getTextContent("ul.unstyled").includes("in-stock", !0);
          return {
            product: {
              costs: { singleItem: u },
              id: o,
        ...
        .done();
      var o = e.fluent.querySelector("#overview-totals"),
        i = "",
        u = o.querySelector("#cart-shipping-total");
      u.exists() && "--" !== u.textContent().done()
        ? u.exists() && (i = u.textContent().done())
        : (i = "0.00");
      var a = e.fluent.querySelector("#cart-sub-total"),
        s = a.exists() ? a.textContent().done() : "0.00",
        c = e.fluent.querySelector("#cart-grand-total"),
        l = c.exists() ? c.textContent().done() : s,
        f = e.fluent.querySelector("#cart-tax-total"),
        d = "";
      d =
        f.exists() && "--" !== f.textContent().done()
          ? f.textContent().done()
          : "0.00";
      var p = e.fluent.querySelector("#discountamount"),
        h = p.exists() ? p.textContent().done() : "",
        v =
          Number(s.replace("$", "").replace(",", "")) +
          Number(i.replace("$", ""));
      return (
        (r.costs = { subtotal: s, total: l }),
        (r.tagBag = {
          shippingAmt: i,
          subtotalAmt: s,
          taxAmt: d,
          coupon: h,
          at: parseFloat(v.toString()).toFixed(2),
        }),
        (r.keywords = ["[[MOBILE]]"]),
        r
      );
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("#productTitle"),
        n = e.fluent.querySelector("#productImageContainer");
      if (!t.exists() && !n.exists()) return null;
      var r,
        o,
        i = e.fluent.getTextContent("#titleName").done(),
        u = e.fluent.querySelector("input#thisfinish"),
        a = e.fluent.querySelector("select#thisfinish");
      if (
        (u.exists()
          ? ((r = u), (o = r.getAttribute("price").done()))
          : a.exists() &&
            a
              .querySelectorAll("option")
              .map(function (e) {
                e.getAttribute("selected").exists() &&
                  ((r = e), (o = r.getAttribute("data-price").done()));
              })
              .done(),
        !r)
      )
        return null;
      var s = r.getAttribute("data-stock").toInt().done() > 0,
        c = r.getAttribute("data-finishtitle").exists()
          ? r.getAttribute("data-finishtitle").done()
          : "",
        l = e.fluent.request.url().done(),
        f = i + c,
        d = e.fluent.querySelector("#productImage").getAttribute("src").done();
      return {
        costs: { singleItem: o },
        id: f,
        images: { thumbnail: d },
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("#product"),
        n = e.fluent.querySelector("#product-media");
      if (!t.exists() && !n.exists()) return null;
      var r = e.fluent.getTextContent("#heading").done(),
        o = e.fluent.querySelector("#purchase-box"),
        i = o.getTextContent("strong.js-price").done(),
        u = !!o.getTextContent(".stock-message").includes("in stock", !0),
        a = o.getTextContent(".js-finish-name").done(),
        s = e.fluent.request.url().done(),
        c = r + a,
        l = e.fluent
...
/*
page: http://www.faucetdirect.com/
url: https://d16fk4ms6rqz1v.cloudfront.net/capture/faucetdirect.js
*/
