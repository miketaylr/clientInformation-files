function getSalutation() {
  var e = _scs(
    "div.del-detail:first ul li:nth-child(1) p:first span.ui-selectmenu-button a:first span.ui-selectmenu-text:first",
    "1 salutation",
    ["text"]
  );
  return e;
...
(__sco.v1 = __sco.v1 || {}),
  ...
  (__sco.config = {
    ...
    daystorun: 20,
    startdate: 0,
    guid: "df1e9d82-5a37-4e24-a663-393ef15758b4",
    v1guid: "df1e9d82-5a37-4e24-a663-393ef15758b4",
    ...
    status3: ["orderconfirmation", "placeorder", "order-confirmation"],
    status4: ["STATUSFOUR"],
    ...
    onchange: {
      ...
      mobile: ["#register-phone", "#address\\.phone"],
      salutation: [],
      optout: [],
    },
    block: {},
  ...
  (__sco.checkStatusTwo = function () {
    return null != _scs("#addToCartButton");
  }),
  (__sco.scraper.statusone = function () {
    var e = "(http://|s.squixa.net/|635313068454500000/|.pagespeed.*|https://)";
    if (_scs("#cartItems")) {
      try {
        (__scd.b.v = _scs(
          "#orderTotals tbody:first tr:first td:last",
          "2 cart total check",
          ["text", "pricecurr"]
        )),
          (__scd.s.yc = _scs(
            "#orderTotals tbody:first tr:nth-child(1) td:last",
            "8 delivery price check",
            ["text"]
          )),
          (__scd.s.abt = _scs(
            "#orderTotals tfoot:first tr:first td:last",
            "fullprice check",
            ["text"]
          ));
      } catch (e) {
      ...
      try {
        __sco.each(_scs(".cart:first .cartItem", "1 cart error"), function (
          t,
          o
        ) {
          var s = _scs([o, ".itemName:first"], "4 item name", ["text"]),
            c = __sco.clear(
              __sco.attr(_scs([o, "a:first img:first"]), "src"),
              e,
              "g"
            );
          (c =
            __sco.contains(c, "context=") && !__sco.contains(c, "base64")
              ? "www.pillowtalk.com.au/medias/?context=" +
                __sco.inbetween("context=", "", c, "fl")
              : c),
            (c = __sco.contains(c, "base64")
              ? "undefined" != typeof __scd.s.imageArray &&
                "undefined" != typeof __scd.s.imageArray[s] &&
                null != __scd.s.imageArray[s]
                ? "www.pillowtalk.com.au" + __scd.s.imageArray[s]
                : "images.salecycle.com/18030/4629/default-02.jpg"
              : c);
          var n = _scs([o, "a:first"]),
            _ = _scs([o, ".brandName:first"], "3 item brand", ["text"]),
            r = _scs([o, ".itemColor:first"])
              ? _scs([o, ".itemColor:first"], "5 item color", ["text"])
              : "-",
            i = _scs([o, ".itemSize:first"])
              ? _scs([o, ".itemSize:first"], "6 item size", ["text"])
              : "-",
            a = _scs([o, ".itemCategory:first"])
              ? _scs([o, ".itemCategory:first"], "7 item category", ["text"])
              : "-",
            l = _scs(
              [o, ".quantity:first input._qty:first"],
              "8 item quantity",
              ["getvt"]
            ),
            u = _scs([o, ".itemPrice:first"], "9 item price", [
              "text",
              "pricecurr",
            ]);
          __scd.b.i.push({
            n: s,
            i: s + u + l + r + i + a + _ + __sco.guid(),
            q: Number(l),
            v: (1 * u).toFixed(2),
            f1: encodeURIComponent(n.getAttribute("href")),
            u: c,
            ed1: r,
            ed2: i,
            ed3: a,
      ...
      try {
        "undefined" == __sco.type(__sco.basketmonitor) &&
          ...
          (__sco.basketmonitor.compare = function () {
            return _scs("#cartItems").innerHTML;
          }),
          (__sco.basketmonitor.action = function () {
            __sco.management.prerun();
          }),
          (__sco.basketmonitor.startstate = _scs("#cartItems").innerHTML),
          __sco.basketmonitor.start());
      } catch (e) {
        (e.description = "2000 " + (e.description || "")), __sco.error(e);
      }
    }
    if (_scs("#cartItemsComponent")) {
      try {
        (__scd.b.v = _scs(
          "#cartTotalsComponent div.innerTotals:first ul:first li:first em:first",
          "2 cart total check",
          ["text", "pricecurr"]
        )),
          (__scd.s.yc = _scs(
            "#cartTotalsComponent div.innerTotals:first ul:first li:nth-child(1) em:first",
            "8 delivery price check",
            ["text"]
          )),
          (__scd.s.abt = _scs(
            "#cartTotalsComponent div.innerTotals:first ul:first li.totalLine:first em:first b:first",
            "fullprice check",
            ["text"]
          ));
      } catch (e) {
      ...
      try {
        __sco.each(
          _scs("#cartItemsComponent div.CartEntryTile", "1 cart error"),
          function (t, o) {
            var s = "",
              c = "",
              n = "",
              s = _scs(
                [
                  o,
                  "div.shp_bag_right:first div.shp_bag_top:first #shp_bag_right_id p:first ",
                ],
                "3 product name check",
                ["text"]
              ),
              n = _scs(
                [o, "div.shp_bag_right:first strong:first"],
                "4 product price",
                ["text", "pricecurr"]
              ),
              _ = __sco.clear(
                __sco.attr(
                  _scs(
                    [o, "div.shp_bag_left:first a:first img:first"],
                    "7 product image check"
                  ),
                  "src"
                ),
                e,
            ...
            (_ =
              __sco.contains(_, "context=") && !__sco.contains(_, "base64")
                ? "www.pillowtalk.com.au/medias/?context=" +
                  __sco.inbetween("context=", "", _, "fl")
                : _),
              (_ = __sco.contains(_, "base64")
                ? "undefined" != typeof __scd.s.imageArray &&
                  "undefined" != typeof __scd.s.imageArray[s] &&
                  null != __scd.s.imageArray[s]
                  ? "www.pillowtalk.com.au" + __scd.s.imageArray[s]
            ...
            var r =
                ...
                _scs(
                  [
                    o,
                    "div.shp_bag_right:first div.shp_bag_top:first #shp_bag_right_id em:first span:first",
                  ],
                  "style specific error 1",
                  ["text"]
                )
                  ? _scs(
                      [
              ...
              i =
                ...
                _scs(
                  [
                    o,
                    "div.shp_bag_right:first div.shp_bag_top:first #shp_bag_right_id em:first span:nth-child(1)",
                  ],
                  "style specific error 2",
                  ["text"]
                )
                  ? _scs(
                      [
              ...
              a =
                ...
                _scs(
                  [
                    o,
                    "div.shp_bag_right:first div.shp_bag_top:first #shp_bag_right_id em:first span:last",
                  ],
                  "style specific error 3",
                  ["text"]
                )
                  ? _scs(
                      [
              ...
              l =
                ...
                _scs(
                  [
                    o,
                    "div.shp_bag_right:first div.shp_bag_top:first label:first",
                  ],
                  "style specific error 3",
                  ["text"]
                )
            ...
            __scd.b.i.push({
              ...
              q: _scs(
                [
                  o,
                  "div.shp_bag_right:first div.ui-select:first div span.ui-btn-inner:first span.ui-btn-text:first",
                ],
                "4 quantity check",
                ["text"]
              ),
              v: n,
              f1: _scs(
                [o, "div.shp_bag_left:first a:first"],
                "6 product link check"
              ).getAttribute("href"),
              osr_f1: decodeURIComponent(
                _scs(
                  [o, "div.shp_bag_left:first a:first"],
                  "6 product link check"
                ).getAttribute("href")
      ...
      try {
        "undefined" == __sco.type(__sco.basketmonitor) &&
          ((__sco.basketmonitor = new __sco.monitor()),
          (__sco.basketmonitor.compare = function () {
            return _scs("#cartTotalsComponent").innerHTML;
          }),
          (__sco.basketmonitor.action = function () {
            __sco.management.prerun();
          }),
          (__sco.basketmonitor.startstate = _scs(
            "#cartTotalsComponent"
          ).innerHTML),
          __sco.basketmonitor.start());
      } catch (e) {
  ...
  (__sco.scraper.statustwo = function () {
    try {
      (__scd.s.imageArray =
        null != __scd.s.imageArray ? __scd.s.imageArray : {}),
        "undefined" == typeof __sco.addToCartMonitor &&
          ((__sco.addToCartMonitor = new __sco.monitor()),
          (__sco.addToCartMonitor.startstate =
            "undefined" != typeof _scs("#addToCartLayer") &&
            null != _scs("#addToCartLayer")
              ? _scs("#addToCartLayer").innerHTML
              : ""),
          (__sco.addToCartMonitor.compare = function () {
            return "undefined" != typeof _scs("#addToCartLayer") &&
              null != _scs("#addToCartLayer")
              ? _scs("#addToCartLayer").innerHTML
              : "";
          }),
          (__sco.addToCartMonitor.action = function () {
            "undefined" != typeof _scs("#addToCartLayer") &&
              null != _scs("#addToCartLayer") &&
              null ==
                __scd.s.imageArray[
                  __sco.attr(_scs("#addToCartLayer img:first"), "title")
                ] &&
              (__scd.s.imageArray[
                __sco.attr(_scs("#addToCartLayer img:first"), "title")
              ] = __sco.attr(_scs("#addToCartLayer img:first"), "src"));
          }),
          (__sco.addToCartMonitor.interval = 500),
          __sco.addToCartMonitor.start());
    } catch (e) {
      (e.description = "2000 " + (e.description || "")), __sco.error(e);
    }
  }),
  (__sco.scraper.statusthree = function () {
    try {
      __scd.s.ordernumber = __sco.text(_scs("#orderId"));
    } catch (e) {
        ...
        (1 !== e.nodeType && 9 !== e.nodeType) ||
          (t
            ...
            : ((e = e.getElementsByTagName("*")),
              __sco.each(e, function (e, t) {
                var c = __sco.attr(t, o.match(d.ATTR)[1]);
                null != c &&
                  null != c.match(new RegExp("^" + o.match(d.ATTR)[5] + "$")) &&
    ...
    function l(e, t, o, u) {
      if (null != t) {
        if (null != e.match(d.ID)) {
          f[o] = __sco.ltrim(f[o].replace(e.match(d.ID)[0], ""));
          var p = document.getElementById(s(e.match(d.ID)[1])),
            p = null == p ? null : p.id != s(e.match(d.ID)[1]) ? null : p;
          return "" === f[o] ? p : l(f[o], p, o, 1);
        }
        if (null != e.match(d.TAG))
          return (
            (f[o] = __sco.ltrim(f[o].replace(e.match(d.TAG)[0], ""))),
            (p = []),
            ...
            "" === f[o]
              ? 0 === p.length
                ? null
                : p
              : l(f[o], null == p || 0 == p.length ? null : p, o, 1)
          );
        if (null != e.match(d.CLASS))
          return (
            (f[o] = __sco.ltrim(f[o].replace(e.match(d.CLASS)[0], ""))),
            (p = []),
        ...
        if (null != e.match(d.ATTR))
          return (
            (f[o] = __sco.ltrim(f[o].replace(e.match(d.ATTR)[0], ""))),
            (p = []),
        ...
        if (null != e.match(d.CHILD)) {
          var m = e.match(d.CHILD),
            p = [];
          if (
            ((f[o] = __sco.ltrim(f[o].replace(e.match(d.CHILD)[0], ""))),
                ...
                "undefined" != __sco.type(m[2])
                  ? "htmlelement" != __sco.type(t) && 0 < t.length
                    ? __sco.each(t, function (e, t) {
                        p = p.concat(__sco.toarray(c(t.childNodes, m[2])));
                      })
                    : (p =
                        "htmlelement" != __sco.type(t) && 0 == t.length
                          ? []
                          : p.concat(__sco.toarray(c(t.childNodes, m[2]))))
                  : "htmlelement" != __sco.type(t) && 0 < t.length
                  ? __sco.each(t, function (e, t) {
            ...
            if ("elemp" == m[1])
              return (
                "htmlelement" != __sco.type(t) && 0 < t.length
                  ? __sco.each(t, function (e, t) {
                      p = p.concat(__sco.toarray(r(s(m[2]), t)));
                    })
                  : (p =
                      "htmlelement" != __sco.type(t) && 0 == t.length
                        ? []
                        : p.concat(__sco.toarray(r(s(m[2]), t)))),
                "" === f[o]
                  ? 0 === p.length
                    ? null
                    : p
  ...
  if (
    ((function () {
      function e(e, t, n) {
        ...
        if (d(t)) r = s(e, t, n);
          ...
          "function" == typeof e[t] && (r = o(e, t, n));
        else if ("function" === _) r = s(e, t(e), n);
        else {
          _ = [];
          for (i in e)
            "function" == typeof e[i] && t.test(i) && _.push(o(e, i, n));
          r = c(_);
        }
        return r;
      }
      function t(e, t) {
        ...
        (this.target = e),
          ...
          (o = this.orig = e[t]),
          (s = this),
          (c = this.advised = function () {
            function e(e) {
              var t = d(e);
              return s._callSimpleAdvice("on", n, e), t;
            }
            var n, _, l, d, f;
            this instanceof c
              ? ((n = m(o.prototype)),
              ...
              (l = u.call(arguments)),
              (f = "afterReturning"),
              (_ = r({ target: n, method: t, args: l }));
            try {
              s._callSimpleAdvice("before", n, l);
              try {
                _.result = s._callAroundAdvice(n, t, l, e);
              } catch (e) {
                (_.result = _.exception = e), (f = "afterThrowing");
              }
              if (
                ((l = [_.result]),
                s._callSimpleAdvice(f, n, l),
                s._callSimpleAdvice("after", n, l),
                _.exception)
              )
                throw _.exception;
              return _.result;
          ...
          p(c, "_advisor", { value: s, configurable: !0 });
      }
      function o(e, o, s) {
      ...
      function s(e, t, s) {
        var n, _, r;
        for (n = [], r = 0; (_ = t[r++]); ) (_ = o(e, _, s)) && n.push(_);
        return c(n);
      }
      function c(e) {
        return {
      ...
      function _(e, t) {
        ...
        for (o in l)
          (s = t[o]) &&
            ((c = e[o]) || (e[o] = c = []), c.push({ aspect: t, advice: s }));
      }
      function r(e) {
        return a.push(i), (i = e);
      }
      (e.before = n("before")),
        (e.around = n("around")),
        (e.on = n("on")),
        (e.afterReturning = n("afterReturning")),
        (e.afterThrowing = n("afterThrowing")),
        (e.after = n("after")),
        ...
        (t.prototype = {
          ...
          _callAroundAdvice: function (e, t, o, s) {
            function c(e, t) {
              return 0 > e ? s(t) : n(_[e].advice, e, t);
            }
            function n(o, s, n) {
              function _(e) {
                return l++, c(s - 1, e);
              ...
              (l = 0),
                (d = r({
                  ...
                  args: n,
                  proceed: function () {
                    return _(0 < arguments.length ? u.call(arguments) : n);
                  },
            ...
            var _;
            return (_ = this.aspects.around), c((_ ? _.length : 0) - 1, o);
          },
          add: function (e) {
            var t, o;
            return (
    ...
    (__sco.osr.config = {
      ...
      selectors: {
        ...
        emailContainer: "#emailboxelement-sc",
        emailCaptureField: "input.email-sc:first",
        ...
        continueButton: ".conshop-sc",
        saveButton: "a.send-sc",
        message: null,
        osrOverlay: "div.osr-content:first",
      },
      style: { width: "498px" },
    }),
    ...
    (__sco.osr.preShowChecks = function () {
      return null !== _scs("#cartItemsSlot") && 0 == !__scd.b.i.length;
    }),
    (__sco.osr.validPage = function () {
      if (0 == __sco.osr.config.validPages.length) return !1;
      var e = !1;
    ...
    (__sco.osr.scrapeEmailAddress = function () {
      var e = _scs(__sco.osr.config.selectors.emailCaptureField).value.trim();
      return 0 == e.length
        ...
        __sco.on(
          ...
          function (e) {
            if (
              ...
              if ((e.x || e.clientX) >= t.width && (e.y || e.clientY) >= 0)
                return !1;
    ...
    (__sco.osr.show = function (e) {
      if (
        ...
        var t =
            ...
            __scd.s.i,
          o = __sco.extend(
            { basketContents: __scd.b.i, triggerType: __sco.osr.triggerType },
            __sco.osr.configRequest
          );
    ...
    (__sco.osr._tmpl = function (e, t) {
      ...
      return (
        __sco.each(t, function (t, _) {
          for (s = e.cloneNode(!0).innerHTML; (o = c.exec(e.innerHTML)); )
    ...
    (__sco.osr.sendPing = function () {
      var e =
        __sco.osr.config.apiHost + "/litebox/ping/" + __scd.i + "/" + __scd.s.i;
      __sco.management.intersend(
        "POST",
        e,
        SCJSON.stringify(__sco.osr.configRequest),
        function (e) {},
        __sco.osr.config.requestHeaders
      );
    }),
...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    var I = function (e, t) {
      var n = y(e, t);
      (h[e] = n.frameGuid),
        document.body ? S(n) : (l.push(n), m || ((m = !0), u.on("load", b)));
    };
    ...
    u.on("message", function (e) {
      if (window !== e.source) {
        ...
        if (n || t === C(a.default.remoteStateStoreUrl)) {
          var i;
          try {
  ...
  function (e, t, n) {
    ...
    !(function (n, u) {
      ...
      function u(e) {
        return localStorage.getItem(m + S + e);
      }
      function a(e, t) {
        localStorage.removeItem(m + S + e), localStorage.setItem(m + S + e, t);
      }
      function s(e) {
        localStorage.removeItem(m + S + e);
      }
      function c(e) {
        for (
          var t = new RegExp("^" + m + r(S) + "(.*)"),
  ...
  function (e, t, n) {
    ...
    var r = n(62),
      ...
      s = {
        ...
        phone: {
          landline: ["#address-phone", "#address\\.phone"],
          mobile: ["#register-phone", "#address\\.phone"],
        },
      },
      c = (function () {
        ...
        return (
          (e.prototype.client = function () {
            return {
              apiKey: "df1e9d82-5a37-4e24-a663-393ef15758b4",
              v1Id: 18030,
            };
          }),
          (e.prototype.isPurchaseComplete = function () {
            var e = this.api.fluent.request.url();
            return (
              e.includes("orderconfirmation", !0) ||
              e.includes("placeorder") ||
              e.includes("order-confirmation")
            );
          }),
          (e.prototype.scrapers = function () {
            ...
            return {
              ...
              customer: function () {
                return {
                  firstName: e.fluent.getStringValue(s.firstName).done(),
                  lastName: e.fluent.getStringValue(s.lastName).done(),
                  phone: {
                    landline: e.fluent.getStringValue(s.phone.landline).done(),
                    mobile: e.fluent.getStringValue(s.phone.mobile).done(),
                  },
                };
              },
              email: function () {
              ...
              order: function () {
                return { id: e.fluent.getTextContent("#orderId").done() };
              },
              product: function () {
                var t = e.fluent
                  .querySelector("body")
                  .getAttribute("class")
                  .includes("mobile", !0);
                return t ? u.default(e) : i.default(e);
              },
            };
          }),
          (e.prototype.triggers = function () {
            ...
            return (
              ...
              e.push.apply(e, s.phone.landline),
              e.push.apply(e, s.phone.mobile),
              {
                events: { change: e },
                watch: [
                  { selector: "#productDetails" },
                  { selector: "#miniCartLayer" },
                ],
              }
            );
          }),
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("#cartItems .cart");
      if (!t.exists()) return null;
      var n = {};
      n.items = t
        .querySelectorAll("tbody tr.cartItem")
        .map(function (e) {
          var t = e.querySelector(".details"),
            n = e.querySelector(".variantDefs"),
            r = t.getTextContent(".brandName").done(),
            o = "",
            i = "",
            u = "";
          return (
            n.exists() &&
              ((o = n.getTextContent(".itemColor").done()),
              (i = n.getTextContent(".itemSize").done()),
              (u = n.getTextContent(".itemCategory").done())),
            {
              product: {
                images: {
                  thumbnail: e
                ...
                url: e.querySelector(".thumb a").getAttribute("href").done(),
                costs: { singleItem: e.getTextContent(".itemPrice").done() },
                inStock: !0,
                name: t.getTextContent(".itemName").done(),
                brand: r,
                color: { value: o },
                size: { value: i },
                category: { value: u },
              },
              costs: { subtotal: e.getTextContent(".total").done() },
              quantity: e
                .getTextContent(".quantity a.active._qty")
                .toInt()
                .done(),
              tagBag: { ed1: o, ed2: i, ed3: u, ed4: r },
            }
          );
        })
        .done();
      var r = e.fluent.querySelector("#orderTotals");
      return (
        (n.costs = {
          total: r.getTextContent("#totalPriceID").done(),
          subtotal: r.getTextContent("tbody > tr > td:last-child").done(),
        }),
        (n.shipping = {
          value: r
            .getTextContent("tbody > tr:last-child > td:last-child")
            .done(),
        }),
        (n.currency = "AUD"),
        n
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector(".yCmsContentSlot");
      if (!t.querySelector(".cartListItem").exists()) return null;
      var n = {};
      n.items = t
        .querySelectorAll(".cartListItem")
        .map(function (e) {
          var t = e.querySelector(".variantDefs"),
            n = e.getTextContent("div.brandName").done(),
            r = "",
            o = "",
            i = "";
          return (
            t.exists() &&
              ((r = t.getTextContent(".itemColor").done()),
              (o = t.getTextContent(".itemSize").done()),
              (i = t.getTextContent(".itemCategory").done())),
            {
              product: {
                images: {
                  thumbnail: e
                    .querySelector(".cartItemproductImage a img")
                    .getAttribute("src")
                    .done(),
                },
                url: e
                  .querySelector(".cartItemproductImage a")
                  .getAttribute("href")
                  .done(),
                costs: {
                  singleItem: e
                    .getTextContent(".basket-page-item-prices .itemPrice span")
                    .done(),
                },
                inStock: !0,
                name: e.getTextContent(".itemName").done(),
                brand: n,
                color: { value: r },
                size: { value: o },
                category: { value: i },
              ...
              costs: {
                subtotal: e
                  .getTextContent(
                    ".basket-page-item-prices .itemTotalPrice span"
                  )
                  .done(),
              },
              quantity: e
                .getStringValue(".qtyForm select[name=quantity]")
                .toInt()
                .done(),
              tagBag: { ed1: r, ed2: o, ed3: i, ed4: n },
            }
          );
        })
        .done();
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("#miniCartLayer");
      if (!t.querySelector(".itemList").exists()) return null;
      var n = {};
      n.items = t
        .querySelectorAll(".itemList .popupCartItem")
        .map(function (e) {
          var t = e.querySelector(".itemDesc"),
            n = t.getTextContent(".brandName").done(),
            r = "",
            o = "",
            i = "",
            u = t.querySelector(".variantDefs");
          return (
            u.exists() &&
              ((r = t.getTextContent(".itemColor").done()),
              (o = t.getTextContent(".itemSize").done()),
              (i = t.getTextContent(".itemCategory").done())),
            {
              product: {
                images: {
                  thumbnail: e
                    .querySelector(".itemThumb img")
                    .getAttribute("src")
                    .done(),
                },
                url: e
                  .querySelector(".itemThumb a")
                  .getAttribute("href")
                  .done(),
                inStock: !0,
                brand: n,
                name: t.getTextContent(".itemName").done(),
                costs: { singleItem: t.getTextContent(".itemPrice").done() },
                color: { value: r },
                size: { value: o },
                category: { value: i },
              },
              quantity: t.getTextContent(".itemQuantity").toInt().done(),
              tagBag: { ed1: r, ed2: o, ed3: i, ed4: n },
            }
          );
        })
        .done();
      var r = t.querySelector(".total"),
        o = r.getTextContent(".price").done();
      return (n.costs = { subtotal: o, total: o }), (n.currency = "AUD"), n;
    }
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = n);
  },
  function (e, t) {
    ...
    function n(e) {
      ...
      if (!t.exists()) return null;
      var n = t.querySelector("#productDetailsJspComponent"),
        r = n.getTextContent("#actual_price").done(),
        o = t.querySelector("#productChooserJspComponent");
      return {
        name: n.getTextContent("h1").clean().done(),
        brand: n.getTextContent("h2").done(),
        costs: {
          singleItem: r
            ? r
            : n
                .getTextContent("#updated_price")
                .replace(/[a-zA-Z]/g, "")
                .clean()
                .split("-")
                .getAt(0)
        ...
        inStock: !o.querySelector(".prodStock .outstk").exists(),
        url: e.fluent.request.url().done(),
        images: {
          thumbnail: t.querySelector("#pImage img").getAttribute("src").done(),
        },
        currency: "AUD",
      };
    }
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector(".page-mobile-productDetails");
      if (!t.exists()) return null;
      var n = t.querySelector("#productTitleJspComponent"),
        r = t.querySelector("#productChooserJspComponent"),
        o = r.getTextContent("#actual_price").done();
      return {
        name: n.getTextContent("h1").clean().done(),
        brand: n.getTextContent("p").done(),
        costs: {
          singleItem: o
            ? o
            : r
        ...
        inStock: !r.querySelector(".prodStock .outstk").exists(),
        url: e.fluent.request.url().done(),
        images: {
          thumbnail: t
            .querySelector(".productCarouselImage .item img")
            .getAttribute("src")
            .done(),
        },
        currency: "AUD",
...
/*
page: http://www.pillowtalk.com.au/
url: http://d16fk4ms6rqz1v.cloudfront.net/capture/PILLOWTALK.js
*/
