...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    var r = n(66),
      ...
      a = {
        ...
        mobile: [
          "#dwfrm_profile_customer_mobilephone",
          "#dwfrm_singleshipping_shippingAddress_addressFields_phone",
        ],
      ...
      u = (function () {
        ...
        return (
          ...
          (e.prototype.isPurchaseComplete = function () {
            var e = this.api;
            return (
              e.fluent.querySelector(".order-number .value").exists() &&
              e.fluent.querySelector(".order-status").exists()
            );
          }),
            ...
            return {
              ...
              customer: function () {
                ...
                return {
                  ...
                  phone: {
                    landline: e.fluent.getStringValue(a.landline).done(),
                    mobile: e.fluent.getStringValue(a.mobile).done(),
                  },
  ...
  function (e, t) {
    ...
    function r(e) {
      var t = "mixed",
        n = "http://images.salecycle.com/18023/11843/headerBGMixed.jpg";
      if (
        window.universal_variable &&
        window.universal_variable.basket &&
        window.universal_variable.basket.line_items
      ) {
        var r = window.universal_variable.basket.line_items;
        Array.isArray(r) &&
          r.forEach(function (e) {
            if (e.product && e.product.category)
      ...
      return (
        "women" === t &&
          (n = "http://images.salecycle.com/18023/11843/headerBGWomens.jpg"),
        "men" === t &&
          (n = "http://images.salecycle.com/18023/11843/headerBG.jpg"),
        (t = "[[__" + t.toUpperCase() + "__]]"),
        { filter: t, header: n }
      );
    }
  ...
  function (e, t, n) {
    ...
    function r(e) {
      ...
      var t = "_DATALAYER_",
        n = o.getFilter(),
        r = o.getBasketFilter(e).filter,
        a = o.getBasketFilter(e).header,
        u = "" + n + r,
        s = "Site/default/Cart-Repop?itemids=",
        c = [],
        l = [],
        f = function (e, n) {
          var r = "",
          ...
          n.product.image_urls.length >= 4 &&
            ((r = n.product.image_urls[1]),
            (o = n.product.image_urls[2]),
            (i = n.product.image_urls[3]),
            (a = "")),
            c.push(n.product.sku_code),
            l.push(n.quantity);
          var s = "left";
          return (
            1 === window.universal_variable.basket.line_items.length &&
              (s = "center"),
            {
              align: s,
              basketType: t,
        ...
        d = i.default.getScBasket(f);
      return d
        ? ((s = "" + s + c.join("_") + "&itemqty=" + l.join("_")),
          (d.tagBag = { headerimg: a, repop: s }),
          d)
        : null;
    }
    var o = n(65),
