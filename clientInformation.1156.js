...
function GoSearch(
  ...
  if (k == "" || ui == "0") {
    alert("WprowadÅº jeden lub wiÄcej wyrazÃ³w do wyszukania.");
    if (null != event) {
...
function SetCrawlLogFilters(
  ...
  if (sch == Url) {
    alert("Wybierz jeden z filtrÃ³w.");
    if (null != event) {
      event.returnValue = false;
      return false;
    } else return;
...
/*
page: http://www.wsiz.rzeszow.pl/
url: https://www.wsiz.rzeszow.pl/_layouts/1045/search.js?rev=D1F4WSO0DLBtAv5oLYcfrQ%3D%3D
*/
