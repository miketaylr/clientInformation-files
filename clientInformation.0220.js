(function () {
  ...
  try {
    positions["1951880384"] = [
      ".recirculation-content.grid-content",
      "h2.widget-title",
    ];
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://statnews-rc.blueconic.net";
    var PROTOCOL =
    ...
    BlueConic.prototype.getRestEndpoint = function (interactionTypeId) {
      return (
        ...
        "//" +
        this.getHostname() +
        "/rest/custom/frontend/" +
        interactionTypeId
      );
    };
    BlueConic.prototype.isInSimulatorMode = function () {
      return window.name && window.name === "bc_simulator";
    };
    ...
    var INTERNAL = {
      ...
      handleDOMMutation: function (handleInteractionsFn) {
        ...
        blueConicAPI._handleMutationTO = setTimeout(function () {
          ...
          var selectors = POSITION.getSelectors();
    ...
    var RPC = {
      ...
      JSONP: (function () {
        ...
        function getRPCParameters(url) {
          ...
          if (window.name && window.name.indexOf("bc_") === 0) {
            var mode = window.name;
            if (mode) {
              mode = mode === "bc_simulator_popout" ? "bc_simulator" : mode;
              mode =
                mode.substring(0, "bc_dialogues".length) === "bc_dialogues"
                  ? "bc_dialogues"
                  : mode;
              qsParams += "mode=" + mode + "&";
            }
      ...
      submitBatch: function () {
        ...
        var doCorsRequest =
          IS_CORS_SUPPORTED &&
          INTERNAL.isNative(XMLHttpRequest, "XMLHttpRequest");
        ...
        var submitTasks = function (tasks, fnOnReady) {
          ...
          var jsonpGet = function () {
            ...
            RPC.JSONP.get(RPC.resourceURL_GET, methodCalls, function (
              responseData
            ) {
    ...
    (function () {
      ...
      if (BC_MGT) {
        ...
        RPC.JSONP.get(url, null, function (responseData) {
          ...
          if (BC_MGT && window.name && window.name === "bc_simulator") {
...
/*
page: http://www.statnews.com/
url: https://cdn.blueconic.net/statnews-rc.js?ver=23903I547
*/
