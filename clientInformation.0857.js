!(function (e) {
  ...
  function (e, t, n) {
    ...
    var I = function (e, t) {
      var n = y(e, t);
      (h[e] = n.frameGuid),
        document.body ? b(n) : (l.push(n), m || ((m = !0), a.on("load", w)));
    };
  ...
  function (e, t, n) {
    ...
    var r = n(62),
      o = (function () {
        function e(e, t) {
          (this.api = e), (this.contentDiv = t), (this.templateId = 4379);
        }
        return (
          (e.prototype.scrapers = function () {
            ...
            return {
              email: function () {
                var n = t.querySelector("input.emb-sc"),
                  o = n.value().done();
                if (!e.strings.regexList.EMAIL.test(o))
                  throw new r.default(
          ...
          (e.prototype.preScrapers = function () {
            var e = this.api;
            return {
              preShow: function (t, n, r) {
                return (
                  e.fluent.request.queryStringParameter("tour_id").exists() &&
                  !!r
                );
              },
            };
  ...
  function (e, t, n) {
    ...
    var r = n(73),
      ...
      a = {
        ...
        lastName: ["#last_name"],
        phone: { landline: ["#phone"], mobile: ["#mobile"] },
        salutation: ["#title"],
        optIn: "#optIn",
      },
      u = (function () {
        ...
        return (
          (e.prototype.client = function () {
            return {
              apiKey: "31f1eae7-c5e3-4910-ae34-d6395a4beac9",
              v1Id: 19334,
              v2Id: 1850,
            };
          }),
          (e.prototype.isPurchaseComplete = function () {
            return (
              this.api.fluent.request.url().includes("/booking/confirm/") &&
          ...
          (e.prototype.scrapers = function () {
            ...
            return {
              ...
              customer: function () {
                var t = e.fluent.querySelector(a.optIn);
                return {
              ...
              order: function () {
                ...
                return (
                  e.fluent
                    .querySelector(".booking-summary tr:nth-child(2) strong")
                    .exists() &&
                    void 0 !==
                      e.fluent
                        .querySelector(
                          ".booking-summary tr:nth-child(2) strong"
                        )
                        .textContent()
                        .done() &&
                    (t = e.fluent
            ...
            return (
              ...
              e.push(a.optIn),
              {
                ...
                watch: [
                  ...
                  {
                    selector:
                      ".container-fluid.booking-menu-bottom.booking-menu-bottom-tour",
                  },
                ],
                idleTracking: { enabled: !0 },
                mouseOut: { enabled: !0 },
                pageVisibility: { enabled: !0 },
              }
            );
          }),
  ...
  function (e, t) {
    ...
    function n(e) {
      var t = {},
        n = e.fluent.querySelector("#booking-flibber"),
        r = e.fluent.querySelector("#accommodations div.card-img").exists(),
        o = n.querySelector('[data-source="accommodation"]'),
        i = n.querySelector("div.price span").value().toFloat().done();
      if (
        !(
          r &&
          n.exists() &&
        ...
        return null;
      var a = e.page.location().hostname.split(".")[0],
        u = n.getTextContent(".currency-link.static").done(),
        s = n.getTextContent("div.price"),
        c = s,
        l =
          n.querySelector(".booking-form-discount span").exists() &&
          void 0 !== n.getTextContent(".booking-form-discount span").done()
            ? n.getTextContent(".booking-form-discount span").done() +
              " " +
              n.getTextContent(".booking-form-discount").done()
            : "";
      if ("" !== l) {
        c = n.getTextContent(".booking-form-subtotal");
        var f = s
            .replace(/[^0-9,.]/g, "")
            .toFloat()
            .done(),
          d = c
            ...
            .toFloat()
            .done();
        t.discount = { cost: (d - f).toFixed(2) + " " + u, label: l };
      }
      (t.currency = u),
        (t.costs = { claim: s.done(), total: s.done(), subtotal: c.done() });
      var p = e.fluent.getTextContent(".page-header").done(),
        h = e.fluent.getTextContent(".lead").done(),
        m = e.fluent.querySelector("#content a").getAttribute("href").done();
      m = m.split("/")[m.split("/").length - 1];
      var v = n.querySelector("table tbody"),
        g = v.getTextContent("tr td:nth-child(2)").done(),
        y = v.getTextContent("tr:nth-child(2) td:nth-child(2)"),
        S = y.split(" ").getAt(0).toInt().done();
      if (null === S || void 0 === S) return null;
      var b = y.done(),
        w = new Date(new Date(g).getTime() + 24 * S * 60 * 60 * 1e3),
        I = [
          "Jan",
          "Feb",
          "Mar",
        ...
        C = v.getTextContent("tr:nth-child(3) td:nth-child(2)").done(),
        T = v.querySelector("tr:nth-child(4) td:nth-child(2)"),
        _ = T.exists() ? T.textContent().done() : "",
        O = "" === _ ? "!--" : "",
        A = e.fluent.querySelector("#adults-selector"),
        k = A.getTextContent(".dropdown-form-value").toInt().done() || 0,
        M = A.getTextContent(".dropdown-form-label").done() || "",
        x = e.fluent.querySelector("#children-selector"),
        j = x.getTextContent(".dropdown-form-value").toInt().done() || 0,
        P = e.fluent.getTextContent(".dropdown-form-label").done() || "",
        R = e.fluent.querySelector("#infants-selector"),
        L = R.getTextContent(".dropdown-form-value").toInt().done() || 0,
        N = R.getTextContent(".dropdown-form-label").done() || "",
        U = k + " " + M;
      j > 0 && (U = U + ", " + j + " " + P),
        L > 0 && (U = U + ", " + L + " " + N);
      var V = e.fluent.querySelector(
        "#accommodations div.card.card-small.card-large-back.selected div.card-img"
      );
      V.exists() ||
        (V = e.fluent
          .querySelectorAll("#accommodations .card-front")
          .find(function (e) {
            return e.getTextContent("h1").includes(C);
          })
          .querySelector(".card-img"));
      var q = V.getAttribute("style"),
        G = q.between("(", ")").replace(/\'/g, ""),
        F = G.exists()
          ? G.includes("?")
            ? G.split("?").getAt(0).done()
            : G.done()
          : "";
      return "" === F
        ? null
        : ((t.items = [
            {
              product: {
                accommodation: {
                  ...
                  name: C,
                  occupants: { adults: k, children: j, infants: L },
                  roomType: C,
                  start: { date: g },
                },
                costs: { singleItem: c.done() },
                id: m,
                images: { thumbnail: F },
                inStock: !0,
                name: p,
          ...
          (t.tagBag = { country: a, repop: e.fluent.request.url().done() }),
          t);
    }
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = n);
  },
  function (e, t) {
    ...
    function n(e) {
      var t =
          e.fluent.querySelector(".hero-bg-item.r-bg.no-blur").exists() &&
          void 0 !==
            e.fluent
              .querySelector(".hero-bg-item.r-bg.no-blur")
              .getAttribute("data-m")
              .done(),
        n = e.fluent.querySelector("#booking_accommodation option"),
        r = e.fluent.querySelector("#per-person-price"),
        o = e.fluent.request.url().includes("/booking?");
      if (o || !t || !n.exists() || !r.exists()) return null;
      var i = e.fluent.getTextContent("h1").done(),
        a = e.fluent.getTextContent(".mw-currency").done(),
        u = e.fluent
          .getTextContent(".sec-color-white.section-package-info h1")
          .done(),
        s = e.fluent.getTextContent(".package-info-icon h1").done(),
        c = e.fluent.getTextContent(".package-info-icon:nth-child(3) h1");
      if (!c.exists()) return null;
      var l = c.split(" - "),
        f = l.getAt(0).done(),
        d = l.getAt(1).done(),
        p = e.fluent
          .querySelector("#booking-side-form")
          .getAttribute("action")
          .split("=")
          .getAt(1)
          .done(),
        h = e.fluent
          .querySelector(".hero-bg .hero-bg-item.r-bg.no-blur")
          .getAttribute("data-m")
          .done();
      return {
        accommodation: {
          boardType: n.textContent().done(),
          end: { date: d },
          name: n.textContent().done(),
          roomType: n.textContent().done(),
          start: { date: f },
        },
        category: { value: s },
        clientProductId: p,
        costs: { singleItem: r.textContent().done() },
        inStock: !0,
        currency: a,
        description: u,
        id: p,
        images: { thumbnail: h },
        singleItemPrice: r.textContent().done(),
...
/*
page: http://www.nordicvisitor.com/
url: https://d16fk4ms6rqz1v.cloudfront.net/capture/nordicvisitor.js
*/
