...
(__sco.v1 = __sco.v1 || {}),
  ...
  (__sco.config = {
    ...
    startdate: 0,
    guid: "",
    v1guid: "C063103A-4F1D-42A3-AC8F-F539F8A25070",
    triggers: ["exit", "timeout"],
    status1: ["/cart"],
    status2: ["STATUSTWO"],
    status3: ["onepage/success"],
    status4: ["STATUSFOUR"],
    ...
    onchange: {
      email: [
        ...
        "input[name=login\\[username\\]]:first",
        "#email_address",
      ],
      first: ["#opc-billing-firstname", "#firstname"],
      last: ["#opc-billing-lastname", "#lastname"],
      telephone: ["input[name=telephone]:first", "input[name=telephone]:last"],
      mobile: [],
      salutation: [],
      optout: [],
    },
    ...
    if (
      ("undefined" == __sco.type(__sco.basketMonitor) &&
        ...
        (__sco.basketMonitor.compare = function () {
          return null == _scs("div.js-full:first")
            ? null
            : _scs("div.js-full:first").innerHTML;
        }),
        (__sco.basketMonitor.action = function () {
          return __sco.management.prerun();
        }),
        (__sco.basketMonitor.startstate = _scs("div.js-full:first").innerHTML),
        (__sco.basketMonitor.interval = 2500),
        (__sco.basketMonitor.max = 600),
        __sco.basketMonitor.start()),
      (__sco.basketType = "DESKTOP"),
      _scs("div.m-page-wrapper") && (__sco.basketType = "MOBILE"),
      _scs("div.basket-empty") &&
        0 ==
          __sco.contains(
            __sco.attr(_scs("div.basket-empty"), "style"),
            "none"
          ) &&
        _scs("tbody.js-product-list") &&
        _scs("tbody.js-product-list:first tr.basket-item"))
    ) {
      try {
        var e = "",
          t = "!--";
        if ("MOBILE" == __sco.basketType)
          for (
            var o = _scs(
                ".totals-wrap:first .basket-order__title",
                "001.1 mobile price rows"
              ),
              s = 0;
            s < o.length;
            s++
            ...
            var c = o[s];
            __sco.contains(__sco.text(c).toLowerCase(), "subtotal")
              ? (__scd.b.v = _scs(
                  [c, ".basket-order__value:first"],
                  "002.1 mobile subtotal price",
                  ["text", "pricecurr"]
                ))
              : __sco.contains(__sco.text(c).toLowerCase(), "discount") &&
                ((e = _scs(
                  [c, ".basket-order__value:first"],
                  "002.1 mobile subtotal price",
                  ["text", "pricecurr"]
          ...
          for (
            var o = _scs("div.js-totals:first p", "001 price rows"), s = 0;
            s < o.length;
            s++
          ) {
            var c = o[s];
            __sco.contains(__sco.text(c).toLowerCase(), "subtotal")
              ? (__scd.b.v = _scs(
                  [c, "span.value:first"],
                  "002.1 subtotal price",
                  ["text", "pricecurr"]
                ))
              : __sco.contains(__sco.text(c).toLowerCase(), "discount") &&
                ((e = _scs([c, "span.value:first"], "002.2 discount price", [
                  "text",
                  "pricecurr",
                ])),
                (t = ""));
          }
        (__scd.s.com = t), (__scd.s.yc = e);
      } catch (e) {
        (e.description = "201 " + (e.description || "")), __sco.error(e);
      }
      try {
        __sco.each(
          _scs("tbody.js-product-list:first tr.basket-item", "1 rows"),
          function (e, t) {
            var o,
              s = "(http://|https://|www.web-blinds.com)",
              c = "(http://|https://)",
              n =
                _scs(".js-product-list:first p.delivery-info") &&
                _scs(
                  ".js-product-list:first p.delivery-info:nth-child(" + e + ")"
                )
                  ? _scs(
                      ".js-product-list:first p.delivery-info:nth-child(" +
                        e +
                        ")",
                      " 7 delivery info",
                      ["text"]
              ...
              _ = "",
              r = 0;
            "MOBILE" == __sco.basketType
              ? ((_ = _scs([t, "div.total:first"], " 1.2 price", [
                  "text",
                  "pricecurr",
                ])),
                (r =
                  1 *
                  _scs(
                    [t, "div.qty:first span.qty-value:first"],
                    " 1.3 qty mobile",
                    ["text"]
                  )))
              : ((_ = (
                  1 *
                  _scs([t, "td.total:first"], " 4 item price", [
                    "text",
                    "pricecurr",
                  ])
                ).toFixed(2)),
                (r =
                  1 *
                  _scs([t, "td.qty:first span.qty-value:first"], " 3 qty", [
                    "text",
                  ]))),
              (o =
                _scs([t, "td.image:first img:first"]) ||
                _scs([t, "td.info:first img:first"], " 8 image")),
              __scd.b.i.push({
                n: _scs([t, "td.info:first a:first"], " 1 name", ["text"]),
                i: _scs([t, "td.info:first a:first"], " 1 name", [
                  "text",
                ]).replace(/ /g, ""),
                q: r,
                v: parseFloat(_ / r).toFixed(2),
                f1: __sco.clear(
                  __sco.attr(
                    _scs([t, "td.info:first a:first"], "6 link"),
                    "href"
                  ),
                  c,
                  "g"
                ...
                d: n,
                u: __sco.clear(__sco.attr(o, "src"), s, "g"),
              });
            for (var i = 0; i < 20; i++)
              (__scd.b.i[e]["ed" + i] = ""),
                (__scd.b.i[e]["edcom" + i] = "!--"),
                _scs([t, "ul.configurations:first li"]) &&
                  _scs([
                    t,
                    "ul.configurations:first li:nth-child(" + i + ")",
                  ]) &&
                  ((__scd.b.i[e]["ed" + i] = _scs(
                    [t, "ul.configurations:first li:nth-child(" + i + ")"],
                    " 2.0 extras loop",
                    ["text"]
                  )),
                  (__scd.b.i[e]["edcom" + i] = ""));
  ...
  (__sco.scraper.statusthree = function () {
    try {
      var e = "";
      _scs("div.order__number") &&
        __sco.text(_scs("div.order__number:first")).length > 0 &&
        (e = __sco.inbetween(
          " ",
          "",
          __sco.text(_scs("div.order__number:first")),
          "ll"
        )),
        "" == e &&
          "array" == __sco.type(dataLayer) &&
          "object" == __sco.type(dataLayer[0]) &&
          "string" == __sco.type(dataLayer[0].transactionId) &&
          (e = __scd.s.ordernumber = dataLayer[0].transactionId),
        "" != e && (__scd.s.ordernumber = e);
    } catch (e) {
  ...
  (_scs = function (e, t, o) {
    ...
    function l(e, t, o, u) {
      if (null != t) {
        if (null != e.match(p.ID)) {
          d[o] = __sco.ltrim(d[o].replace(e.match(p.ID)[0], ""));
          var m = document.getElementById(s(e.match(p.ID)[1])),
            m = null == m ? null : m.id != s(e.match(p.ID)[1]) ? null : m;
          return "" === d[o] ? m : l(d[o], m, o, 1);
        }
        if (null != e.match(p.TAG))
          return (
            (d[o] = __sco.ltrim(d[o].replace(e.match(p.TAG)[0], ""))),
            (m = []),
            ...
            "" === d[o]
              ? 0 === m.length
                ? null
                : m
              : l(d[o], null == m || 0 == m.length ? null : m, o, 1)
          );
        if (null != e.match(p.CLASS))
          return (
            (d[o] = __sco.ltrim(d[o].replace(e.match(p.CLASS)[0], ""))),
            (m = []),
        ...
        if (null != e.match(p.ATTR))
          return (
            (d[o] = __sco.ltrim(d[o].replace(e.match(p.ATTR)[0], ""))),
            (m = []),
        ...
        if (null != e.match(p.CHILD)) {
          var g = e.match(p.CHILD),
            m = [];
          if (
            ((d[o] = __sco.ltrim(d[o].replace(e.match(p.CHILD)[0], ""))),
    ...
    if (
      ...
      return (
        "array" === __sco.type(e)
          ? ((d = __sco.clean(e[1]).split(/\s+(?![^\[]*\])/g)), (h = e[0]))
          : (d = __sco.clean(e).split(/\s+(?![^\[]*\])/g)),
        (y = __sco.clone(d)),
        __sco.each(d, function (e, o) {
          if (null != f) {
            var s = l(o, h, e);
...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    var r = n(62),
      ...
      a = {
        ...
        firstName: ["#firstname", "#opc-billing-firstname"],
        lastName: ["#lastname", "#opc-billing-lastname"],
        phone: { mobile: ["input[name=telephone]"] },
      },
      s = (function () {
        function e(e) {
          this.api = e;
        ...
        return (
          (e.prototype.client = function () {
            return {
              apiKey: "C063103A-4F1D-42A3-AC8F-F539F8A25070",
              v1Id: 16800,
            };
          }),
          (e.prototype.isPurchaseComplete = function () {
            var e = this.api;
            return e.fluent.request.url().includes("onepage/success", !0);
          }),
            ...
            return {
              ...
              order: function () {
                ...
                if (
                  t &&
                  "undefined" !=
                    typeof t[u.correctIndex(t, "transactionId", "f")] &&
                  "string" ==
                    typeof t[u.correctIndex(t, "transactionId", "f")]
                      .transactionId
                )
                  return {
                    id:
                      t[u.correctIndex(t, "transactionId", "f")].transactionId,
                  };
                var n = e.fluent.querySelector("div.order__number");
                return n.exists() ? { id: n.textContent().done() } : null;
              },
              product: function () {
                return i.default(e);
              },
          ...
          (e.prototype.triggers = function () {
            ...
            return (
              ...
              e.push.apply(e, a.phone.mobile),
              {
                events: { change: e },
                watch: [
                  { selector: "table.basket-table" },
                  { selector: "table.mobile-basket-table" },
                ],
              }
            );
          }),
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("tbody.js-product-list"),
        n = t.querySelectorAll("tr.basket-item"),
        r = e.fluent.querySelector("div.m-page-wrapper").exists();
      if (r || !n) return null;
      var o = {};
      o.items = n
        .map(function (t, n) {
          var r = e.fluent.querySelector(".js-product-list"),
            o = r.querySelectorAll("p.delivery-info"),
            i = "";
          o.exists() && (i = r.getStringValue("p.delivery-info").done());
          var u = t.getTextContent(".price:last-child").done(),
            a = null,
            s = e.fluent.querySelector(".is-discounted");
          s.exists() && (a = s.textContent().done());
          var c = t.querySelector(".qty-value").value().toInt().done(),
            l = t.querySelector("img").getAttribute("src").done(),
            f = t.getTextContent("a.name").done(),
            d = t.querySelector("a.name").getAttribute("href").done(),
            p = f;
          return {
            product: {
              costs: { previous: a, singleItem: u },
              id: p,
              images: { thumbnail: l },
              inStock: !0,
              name: f,
            ...
            quantity: c,
            tagBag: { basket: "DESKTOP", d: i },
          };
        })
        .done();
      var i = e.fluent.querySelector("div.totals-wrap div.basket-totals"),
      ...
      return (
        u.forEach(function (e) {
          e.value().includes("subtotal", !0) &&
            (a = e.querySelector("span").textContent().done()),
            e.value().includes("discount", !0) &&
              (s = e.querySelector("span").textContent().done()),
            e.value().includes("delivery", !0) &&
              (c = e.querySelector("span").textContent().done());
        }),
        (o.costs = { subtotal: a }),
        (o.discount = { cost: s }),
        (o.shipping = { cost: c }),
    ...
    function n(e) {
      ...
      o.items = n
        .map(function (t, n) {
          ...
          o.exists() && (i = r.getStringValue("p.delivery-info").done());
          var u = null,
            a = t.querySelector("td.remove div.total"),
            s = a.exists() ? a.textContent().replace("Â£", "").done() : "0.00",
            c = t.querySelector(".qty-value").value().toInt().done(),
            l = "Â£" + (Number(s) / c).toString(),
            f = t.querySelector("img").getAttribute("src").done(),
            d = t.querySelector("td.info a"),
            p = d.getAttribute("href").done(),
            h = d.textContent().done(),
            v = h;
          return {
            product: {
              costs: { previous: u, singleItem: l },
              currency: "GBP",
              id: v,
              images: { thumbnail: f },
              inStock: !0,
            ...
            quantity: c,
            tagBag: { basket: "MOBILE", d: i },
          };
        })
        .done();
      var i = e.fluent.querySelectorAll("div.js-totals:last-child").getAt(0),
        u = i.querySelectorAll("p"),
        a = "0",
        s = "0",
        c = "0";
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("div.justify"),
        n = t.querySelector(".product-title");
      if (!t.exists() || !n.exists()) return null;
      var r = n.textContent().done(),
        o = e.fluent.request.url().done(),
        i = t.getTextContent("p.price-from strong").done(),
        u = t.querySelector("img").getAttribute("src").done(),
        a = t.querySelector("button.btn-primary").exists();
      return {
        costs: { singleItem: i },
        currency: "GBP",
        id: r,
...
/*
page: http://www.web-blinds.com/
url: https://d16fk4ms6rqz1v.cloudfront.net/capture/web-blinds.js
*/
