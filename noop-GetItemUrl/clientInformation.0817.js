...
function GoSearch(
  ...
  if (k == "" || ui == "0") {
    alert("Entrez un ou plusieurs mots Ã  rechercher.");
    if (null != event) {
...
function SetCrawlLogFilters(
  ...
  if (sch == Url) {
    alert("Choisissez un des filtres.");
    if (null != event) {
      event.returnValue = false;
      return false;
    } else return;
...
/*
page: http://www.cafepedagogique.net/
url: http://www.cafepedagogique.net/_layouts/1036/search.js?rev=LkcliuXuBtpyM1BbXQm3gw%3D%3D
*/
