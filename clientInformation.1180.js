(function () {
  ...
  var positions = {};
  try {
    positions["1673193024"] = [
      "#button-humburger-menu.button-menu",
      "#choose-your-supplementary-coverages h2",
      "#claimsFreeYearsCombo .form-col-2",
      "#guar_8",
      "#header #topnav .nav",
      "#hoofddekkingen",
      "#insurancetypes",
      "#main-wrapper .bc-list",
      "#price .pad.alert-info .span6.checkoffs.lineHeight24px",
      "#price .sprite",
      "#processForm",
      "#questionCFY .form-col-2",
      "#sidebar",
      "#summaryContainer",
      "#testataPagina",
      "#thanks",
      "#visual",
      "#visual1",
      ".accordion > ul > li:nth-of-type(2) > .image-left",
      ".bc-container table td.campagne-1",
      ".bc-container table td.campagne-2",
      ".bc-container table td.campagne-3",
      ".bc-container table td.campagne-4",
      ".bc-container table td.campagne-5",
      ".bcSlideOutContent .product.coverage",
      ".bcSlideOutContent .product.giveaway",
      ".btn-default.btn-call",
      ".callcenter_header",
      ".col-md-4.hf-col",
      ".container",
      ".container .row.content",
      ".content",
      ".content .hint.hint-dark",
      ".divLimitationClass.limitationCode_12",
      ".form-container",
      ".hp-banner",
      ".image-bottom:last-child",
      ".info.checkoffs",
      ".jumbotron .btn-blueconic-container",
      ".jumbotron__right-content div:nth-of-type(1)",
      ".myjini",
      ".onlymedia:nth-child(2) .cnt div.image-left",
      ".package-0001 .info.checkoffs",
      ".package-0002 .info.checkoffs",
      ".package-0003 .info.checkoffs",
      ".package.checked .content",
      ".policies_comparison tbody ",
      ".premium-table",
      ".roadside.boxed .segmented-controls.clearfix",
      ".row",
      ".row.content",
      ".span6.content ",
      ".span8.quotation",
      ".text-block .btn-blueconic-container",
      ".tm-home .advantages.blue-box ",
      ".tm-home .hero",
      ".tm-quotation .content footer",
      ".wrapper",
      "a#saveQQButton",
      "a.desktop-site-link",
      "body #wrapper",
      "body.smartphone-prepareCar011 .content form#processForm",
      "div#footer",
      "div#guar_8 > label.checkbox-box > span.frame > span.prices",
      "div#misted",
      "div#paymentDataGroup > fieldset:nth-of-type(2) > div:nth-of-type(1)",
      "div#price",
      "div#sitemap",
      "div#topnav-overlayarea",
      "div.appversion",
      "div.bc-agent",
      "div.bc-value",
      "div.bc-vergelijk",
      "div.boxed:nth-of-type(2)",
      "div.clearfix a.button.orange.full",
      "div.container > nav > ul.nav > li:nth-of-type(2) ul",
      "div.content > a:nth-of-type(2)",
      "div.content > div:nth-of-type(2)",
      "div.content > fieldset > div:nth-of-type(2)",
      "div.content > form > fieldset > div:nth-of-type(2)",
      "div.content > form > fieldset:nth-of-type(2)",
      "div.content > h2",
      "div.hint-dark",
      "div.image-left > img",
      "div.inner > div:nth-of-type(3)",
      "div.layer-98-copy > div:nth-of-type(1)",
      "div.layer-98-copy > div:nth-of-type(2)",
      "div.layer-98-copy-1",
      "div.layer-98-copy-1 > div > h2",
      "div.section-buttons",
      "div.section-legend",
      "div.section-richtext",
      "div.span6",
      "div.span8 > div.boxed",
      "div.span9 > table > thead",
      "div.wrapper > section > div.container > div:nth-of-type(1) > div.span12",
      "div:nth-of-type(16)",
      "div:nth-of-type(5) > div.span7",
      "div:nth-of-type(7) > p",
      "dl:nth-of-type(1) > dt:nth-of-type(1)",
      "fieldset h2:first-of-type",
      "form h2:nth-of-type(1)",
      "form#processForm",
      "h1",
      "h4.title",
      "header#topbar > div.container > div.row > div:nth-of-type(1)",
      "header.main",
      "html > body",
      "section#main-wrapper .quotation-progress",
      ...
      "section.tabs .tab-pane .col-md-4",
      'span[class="step-blueconic-container"]',
      "table.parcel > tbody > tr:nth-of-type(1) > td:nth-of-type(1)",
      "table.unsized > tbody > tr:nth-of-type(1) > td:nth-of-type(1)",
    ];
    positions["2060346304"] = [
      ".bc-container table td.campagne-1",
      ".bc-container table td.campagne-2",
      ".bc-container table td.campagne-3",
      ".bc-container table td.campagne-4",
      ...
      "div.bc-value",
      "div.bc-vergelijk",
      "table.offers tr td.white",
      "table.offers tr td.white.borderGray",
    ];
    positions["-100518656"] = [
      ".content",
      ".main div.container div.row.content .span8.quotation",
      ".phone",
      ".tm-quotation .content footer",
      "div#guar_8 > label.checkbox-box > span.frame > span.prices",
      "div.wrapper > section > div.container",
      "fieldset h2:first-of-type",
    ];
  } catch (err) {}
  (function (a) {
    ...
    (function () {
      var InteractionTypeImpl = InteractionType.extend({
        ...
        onPrepare: function () {
          var a = this._getParameterByName("utm_allsecur_medium");
          a && this.profile.setValue("utm_custom", a);
        },
    ...
    /* Next pre listener */
    //
    // testgroup_prelistener
    //
    (function () {
      var InteractionTypeImpl = InteractionType.extend({
        TEST_GROUP_PROFILE_PROPERTY: "eenoftwee",
        TEST_GROUP_COOKIE_NAME: "bc_eenoftwee",
        init: function (a, c) {
          this.blueConicClient = a;
        ...
        onPrepare: function () {
          var a = this.blueConicClient.util.cookie.getCookie(
            this.TEST_GROUP_COOKIE_NAME
          );
          a ||
            ((a = Math.floor(2 * Math.random()) + 1),
      ...
      // Register listener 'testgroup_prelistener':
      window.blueConicPreListeners.push({
        id: "testgroup_prelistener",
        interactionType: InteractionTypeImpl,
      });
    })(); // end of interaction type + register interaction type
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://allsecur.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.allsecur.nl/
url: https://allsecur.blueconic.net/frontend/static/javascript/blueconic/blueconic.min.js
*/
