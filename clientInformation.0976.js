...
function Contentsview(e) {
  (this.psase_int = [
    "down_count",
    "display_user_id",
    "display_user_adult_flag",
    "adult_preview_type",
    "flagbbs_file_size",
    "file_list_count",
  ]),
    ...
    (this.view_broadcast = null),
    (this.view_bbs_purchase_stat = null),
    (this.broadcast_chapter = e.broadcast_chapter),
    (this.chapter_idx = e.chapter_idx),
    (this.bro_keywd = e.bro_keywd),
    (this.bbs_files = e.bbs_files),
    (this.fc_event = null),
    (this.is_redown = e.is_redown),
    (this.PAID_CONTENTS = e.PAID_CONTENTS),
    (this.down_count = e.down_count),
    (this.bbs_new_time = Math.round(new Date().getTime() / 1e3) - 259200),
    this.setViewData(e.view_data),
    this.setOtherData(e);
}
...
(FC_CATEGORY.prototype.setData = function () {
  ...
  (FC_APP_FN.openContentsView = function (e, t, a) {
    ...
    if ((console.debug(d), 1 == APP.new_contents_view))
      return WEB_CONTENTS_VIEW_FUN.openContentsView(d), void 0;
    utility.loading.show();
    var u = function () {
    ...
    if (
      (1 == IsBrowserIE_FC()
        ? setTimeout(u, 15e3)
        : setTimeout(u, APP.DEFINE.AJAX_TIMEOUT - 2e3),
      2 == a)
    )
      var _ =
    ...
    var o = function (e, t) {
      ...
      d = function (e, t) {
        ...
        if ((console.debug(e), console.debug(p), !(1 > p.length))) {
          var h = [];
          h.push(r(u - 1));
          for (var f in p) h.push(p[f].html);
          h.push(l(u + 1)),
            i.html(h.join("")).show(),
...
(FC_member.prototype.setData = function (e) {
  ...
  (TEMPLATE_MODAL.fcAutopayChargeModal = function (e) {
    console.log("TEMPLATE_MODAL.fcAutopayChargeModal"), console.log(e);
    var t = e.pay_info,
      a = e.pay_method;
    if (0 == isDefined(t.idx)) return "";
    var i = parseInt(
        100 * ((t.prime_price - t.real_pay_price) / t.prime_price)
      ),
      n = cehckIsFcMember(),
      s = "";
    (s +=
      '<div class="modal" id="fcAutopayChargeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">'),
      (s += '	<div class="modal-dialog center_style type5">'),
      (s += '		<div class="pop_layer charge">'),
      (s += '			<input type="hidden" name="charge_point" id="charge_point">'),
      (s +=
        "			<h1>ì§ì  ë¹êµí´ ë³´ì¸ì! <span>íì¼ìºì¤í¸ ì ì¡ì  ì´ì©ê¶ì ì´ëë³´ë¤ë ì ë ´</span>í©ëë¤.</h1>"),
      (s += '			<div class="c_top type1">'),
      (s +=
        '				<p class="c_use">ì íí ì´ì©ê¶ : <span class="txt_orange">ì ê¸° ê²°ì  30ì¼ ë¬´ì í ì´ì©ê¶ (ë§¤ì ê°í¸ ê²°ì )</span></p>'),
      (s += '				<ul class="explain">'),
      (s += "					<li>- 24ìê° ë¬´ì í ì´ì©íì¤ ì ììµëë¤.</li>"),
      (s += "					<li>- ë§¤ë¬ " + i + "% ì ë ´í ê°ê²©ì¼ë¡ ì´ì©ì´ ê°ë¥í©ëë¤.</li>"),
      (s += "					<li>- í¸ë¦¬í ë§¤ì ê°í¸ ê²°ì ìëë¤.</li>"),
      (s += "				</ul>"),
      (s += "			</div>"),
      (s += '			<div class="c_btm type1">'),
      (s += '				<div class="c_choice_wrap">'),
      (s += '					<div class="total">'),
      (s +=
      ...
      (s += "					</div>"),
      (s += '					<div class="c_choice">'),
      (s += "						<p>ê²°ì  ë°©ë²ì ì íí´ ì£¼ì¸ì!</p>");
    for (var o = 0; a.length > o; o++)
      "1" == a[o].is_test
        ? 1 == n &&
          (s +=
            '						<span class="phone" onclick="WEB_CHARGE.autoPayGo(' +
            a[o].idx +
            ", " +
            t.idx +
            ');">T:' +
    ...
    (s += "					</div>"),
      (s += '					<div class="agree">'),
      (s += "						<p>ì ê°í¸ ê²°ì  ì´ì©ì½ê´ì ëìí©ëë¤.</p>"),
      (s +=
        '						<span class="check" id="autopay_button" onclick="WEB_CHARGE.autopayAgree();"></span>'),
      (s += "					</div>"),
      (s += "				</div>"),
      (s += "				<ul>"),
      (s += "					<li>- ìí êµ¬ë§¤ì ë¶ê°ì¸ 10%ê° ë³ë ì²­êµ¬ë©ëë¤.</li>"),
      (s += "					<li>- êµ¬ë§¤íì  ìíì í ì¬ì´í¸ìì ì´ì©íì¤ ì ììµëë¤.</li>"),
      (s +=
        "					<li>- ì¶ê° ê²°ì ì ë²ê±°ë¡ì ìì´ ì ì²­íì  ë¤ì ë¬ ë¶í° ì´ì©ìê¸ì´ ìëì¼ë¡ ê²°ì ë©ëë¤.</li>"),
      (s += "					<li>- ì ê² ìê°ìë ìë¹ì¤ê° ì¼ì ì¤ì§ë  ì ììµëë¤.</li>"),
      (s +=
        "					<li>- ìë¹ì¤ í´ì§ë¥¼ ìíì¤ ê²½ì° ê³ ê°ì¼í°ë¡ ìì²­íìë©´ ì·¨ìê° ê°ë¥í©ëë¤</li>"),
      (s += "				</ul>"),
      (s += "			</div>"),
      (s += '			<a class="btn_close hand" data-dismiss="modal"></a>'),
      (s += "		</div>"),
      (s += "	</div>"),
      (s += "</div>");
    try {
  ...
  GO_MENU = function (e, t, a) {
    ...
    switch (e) {
      ...
      case "logout":
        ...
        break;
      case "fileUpload":
        var f = jQuery("#memberValidUploader").val();
        if ("1" != f) {
      ...
      case "country":
        ...
        var E = "KR";
        1 == isDefined(t) && (E = t), FC_MODAL_OPEN("fcGlobalConnect", !1, E);
        break;
      case "adult":
...
(WEB_CHARGE.DATA = {}),
  ...
  (WEB_CHARGE.onClickPointCharge = function (e) {
    ...
    jQuery("#moneyIdx").val(t), WEB_CHARGE.chargeLayerCommon(e, a, "P");
  }),
  ...
  (WEB_CHARGE.onClickAutoPayCharge = function (e) {
    ...
    var t = jQuery(e).data("idx"),
      a = jQuery(e).data("group");
    jQuery("#moneyIdx").val(t), WEB_CHARGE.chargeLayerCommon(e, a, "A");
  }),
  (WEB_CHARGE.chargeLayerCommon = function (e, t, a) {
    console.log("WEB_CHARGE.chargeLayerCommon:" + t),
      0 == isDefined(a) && (a = "P");
    var i = new FC_APP();
    if (0 == fc_check_login()) return GO_MENU("login", "modal"), void 0;
    var n = jQuery(e).data("idx"),
      s = t;
    0 == isDefined(s) && (s = jQuery("#fcChargePageTypeName").val());
    var o = { pay_idx: n, group_idx: s, pay_code: a },
      r = function (e) {
        if (
          (console.log("successFunCharageInfo"),
          console.debug(e),
          1 == isDefined(e.member) && i.setMember(e.member),
          ...
          if (
            ...
            var a = TEMPLATE_MODAL.fcChargeModaComon(e);
            jQuery("#fc-web-modal-first-div").html(a),
            ...
            var a = TEMPLATE_MODAL.fcFlatChargeModalNew(e);
            jQuery("#fc-web-modal-first-div").html(a),
              TEMPLATE_MODAL_FUN.setModalOnEvent(
            ...
            var a = TEMPLATE_MODAL.fcAutopayChargeModal(e);
            jQuery("#fc-web-modal-first-div").html(a),
              TEMPLATE_MODAL_FUN.setModalOnEvent(
      ...
      l = {
        server: i.DEFINE.SERVER_PROTOCOL,
        uri: i.PROTOCOL.URL.CHARGE.PAY_REF_INFO,
        success: r,
        error_type: !1,
        loading_bar: !1,
        params: o,
      };
    i.PROTOCOL.ajaxCall(l, i);
  }),
...
(WEB_CONTENTS.DATA = {
  ...
  (WEB_CONTENTS.VIEW.drawDonutGraph = function (e, t, a) {
    if (0 != supports_canvas_text()) {
      ...
      if (
        ...
        var f = "age-donut-graph" == a ? "ì°ë ¹ë³" : "ì±ë³";
        d3
          .select("#" + a)
          .append("text")
          .attr("class", "name")
  ...
  (WEB_CONTENTS.VIEW.setPurchaseGraph = function () {
    console.log("WEB_CONTENTS.VIEW.setPurchaseGraph");
    var e = jQuery("#purchase_stat").val();
    if ((console.debug(e), 0 == isDefined(e)))
      return jQuery("#view_donut").hide(), !1;
    if (((e = JSON.parse(e)), console.debug(e), 1 > e.cnt))
      return jQuery("#view_donut").hide(), !1;
    var t = e.sort_age,
      a = e.gender;
  ...
  (Contentsview.prototype.setViewData = function (e) {
    for (var t in e)
      this[t] = jQuery.inArray(t, this.psase_int) >= 0 ? parseInt(e[t]) : e[t];
  }),
  (Contentsview.prototype.setOtherData = function (e) {
    1 == isDefined(e.bbs_new_time) && (this.bbs_new_time = e.bbs_new_time),
      1 == isDefined(e.bbs) &&
        (this.view_bbs = new Contentslist(e.bbs, this.bbs_new_time, 0, 1)),
      1 == isDefined(e.member) &&
        (this.view_member = new FC_member(e.member, !1)),
      1 == isDefined(e.bbs_purchase_stat) &&
        (this.view_bbs_purchase_stat = e.bbs_purchase_stat),
      1 == isDefined(e.broadcast) && (this.view_broadcast = e.broadcast),
      1 == isDefined(e.fc_event) && (this.fc_event = e.fc_event),
      this.setViewInfo(),
      this.setFileInfo();
  }),
  (Contentsview.prototype.setViewInfo = function () {}),
  (Contentsview.prototype.setFileInfo = function () {}),
  (Contentsview.prototype.getShowHtml = function () {
    console.log("Contentsview.prototype.getShowHtml"), console.debug(this);
    var e = "";
    (e +=
      '<div id="contentsViewDetail" class="view_wrap1" style="border-radius: 8px;">'),
      (e += '	/* <a name="view_top"></a>*/'),
      (e += "	/* bbs info -*/"),
      (e += '	<div id="fc-contents-view-info-div">'),
      (e += '		<div class="" id="nonClickViewWrap">'),
      (e += "			/* view_l */"),
      (e += '		    <input type="hidden" id="memberUserId" value="35907">'),
      (e += '		    <input type="hidden" id="memberFlagAdult" value="1">'),
      (e += '		    <input type="hidden" id="memberAdultPreviewTtype" value="0">'),
      (e += '		    <input type="hidden" id="bbsBoardIdx" value="6565307">'),
      (e += '		    <input type="hidden" id="bbsOwenerIdx" value="317440">'),
      (e += '		    <input type="hidden" id="bbsViewType" value="2">'),
      (e += '		    <input type="hidden" id="isAdultOpen" value="1">'),
      (e += '		    <input type="hidden" id="bbsCategoryMain" value="2">'),
      (e += '		    <input type="hidden" id="bbsCategorySub" value="2007">'),
      (e += '		    <input type="hidden" id="bbsViewCashPrice" value="740">'),
      (e += '			<input type="hidden" id="web-seo-view-partner" value="sitemap">'),
      (e +=
        '			<input type="hidden" id="purchase_stat" value="{&quot;cnt&quot;:0}">'),
      (e +=
        '			<div class="view_tit1 clist round " id="contents-view-top-title" style="top: 0px; margin-left: 0px; border-radius: 8px 8px 0px 0px;">'),
      (e +=
        '				<span class="list_sumimg"><img src="http://pic.filecast.co.kr/4a/21/4a216545ab24af75a309c792b503091a.gif" alt="" onerror=""></span>'),
      (e += '				<span class="ico adult"></span>'),
      (e +=
        '				<span class="txt">[ë¯¸ë] ìíë¼ë¸ì¤(The Sopranos) ìì¦6 01í-21í(ì) íìíµí©ìë§ ë§í¼ì mcq</span>'),
      (e +=
        '				<span class="btn_close hand" id="btn-modal-closed" data-dismiss="modal"></span>'),
      (e += "			</div>"),
      (e += '			<div class="filecast_banner" id="filecast_link">'),
      (e +=
        '					<img src="http://filecast.co.kr/static/_img/banner/filecast1607.png" alt="">'),
      (e += "			</div>"),
      (e += '			<div class="file_list1">'),
      (e +=
        '				<p><span class="ico folder">ico</span><span class="tit">6/</span></p>'),
      (e += "			"),
      (e += '				<div class="tbl_style21">'),
      (e += '					<table summary="íì¼ ì ë³´">'),
      (e += '						<caption class="blind">íì¼ ì ë³´</caption>'),
      (e += "						<thead>"),
      (e += "							<tr>"),
      (e += '								<th scope="col">íì¼ëª</th>'),
      (e += '								<th scope="col">ì©ë</th>'),
      (e += '								<th scope="col">ì¬ììê°</th>'),
      (e += '								<th scope="col">í´ìë</th>'),
      (e += "							</tr>"),
      (e += "						</thead>"),
      (e += "						<tbody>"),
      (e += '							<tr class="fc-view-filelist-tr " style="table-row;">'),
      (e += '								<td class="type1">'),
      (e +=
        '									<span class="ico avi"></span><span class="file_name">The.Sopranos.S06E01.HDTV.XviD-.avi</span>'),
      (e += "								</td>"),
      (e += '								<td class="type2">350.8 M</td>'),
      (e += '								<td class="type3">00:50:32</td>'),
      (e += '								<td class="type4">608x336</td>'),
      (e += "							</tr>"),
      (e += '							<tr class="fc-view-filelist-tr " style="table-row;">'),
      (e += '								<td class="type1">'),
      (e +=
        '									<span class="ico smi"></span><span class="file_name">The.Sopranos.S06E01.HDTV.XviD-.smi</span>'),
      (e += "								</td>"),
      (e += '								<td class="type2">173.4 K</td>'),
      (e += '								<td class="type3">-</td>'),
      (e += '								<td class="type4">-</td>'),
      (e += "							</tr>"),
      (e +=
        '							<tr class="fc-view-filelist-tr second-tr" style="display: none;">'),
      (e += '								<td class="type1">'),
      (e +=
        '									<span class="ico smi"></span><span class="file_name">The.Sopranos.S06E21.HDTV.XviD-NoTV.smi</span>'),
      (e += "								</td>"),
      (e += '								<td class="type2">192 K</td>'),
      (e += '								<td class="type3">-</td>'),
      (e += '								<td class="type4">-</td>'),
      (e += "							</tr>"),
      (e += '							<tr onclick="WEB_CONTENTS.VIEW.onclickMoreFileList(this);">'),
      (e +=
        '								<td class="file_more" colspan="4" style="display: table-cell;"><span>ì´ <span>36</span>ê°ì íì¼ì´ ë ììµëë¤.</span> <span class="btn_more">íì¼ ë ë³´ê¸°<span></span></span></td>'),
      (e += "							</tr>"),
      (e += '							<tr onclick="WEB_CONTENTS.VIEW.onclickReturnFileList(this);">'),
      (e +=
        '								<td class="file_return" colspan="4" style="display: none;"><span class="btn_more">ë¦¬ì¤í¸ ì ê¸°<span></span></span></td>'),
      (e += "							</tr>"),
      (e += "						</tbody>"),
      (e += "					</table>"),
      (e += "				</div>"),
      (e += "			</div>"),
      (e += '			<div class="file_info1">'),
      (e += "				<ul>"),
      (e += '					<li class="l1">'),
      (e += '						<span class="info_tit">ë²í¸</span>'),
      (e += '						<span class="txt_block"><b>6565307</b></span>'),
      (e += "					</li>"),
      (e += '					<li class="l2">'),
      (e += '						<span class="info_tit">ë¶ë¥</span>'),
      (e += '						<span class="txt_block"><b>ë°©ì¡ &gt; ë¯¸ë</b></span>'),
      (e += "					</li>"),
      (e += '					<li class="l3">'),
      (e += '						<span class="info_tit">íë§¤ì</span> <br>'),
      (e += "						<span><b>ë¯¸ëì´íë¸</b></span>"),
      (e += '						<span class="seller_btn">'),
      (e +=
        '							<a onclick="WEB_NOTE.sendNoteLayer(\'ë¯¸ëì´íë¸\');" class="btn_memo"><span>ìª½ì§</span></a>'),
      (e +=
        "							<a onclick=\"GO_MENU('seller_file','%EB%AF%B8%EB%94%94%EC%96%B4%ED%81%90%EB%B8%8C');\" class=\"btn_data\"><span>ìë£ì¤</span></a>"),
      (e += "						</span>"),
      (e += "					</li>"),
      (e += '					<li class="l4">'),
      (e += '						<span class="info_tit">ì´ì©ë</span>'),
      (e += '						<span class="txt_block"><b>7.2 G</b></span>'),
      (e += "					</li>"),
      (e += '					<li class="price_w  l5">'),
      (e += '						<span class="info_tit">ê°ê²©</span>'),
      (e += '						<span class="txt_blue txt_block">'),
      (e += '						<span class="ico_partner ">ì í´</span>'),
      (e += "						<b>740</b> P"),
      (e += "						</span>"),
      (e += "					</li>"),
      (e += "				</ul>"),
      (e += '				<div class="btn_etc">'),
      (e +=
        '					<a class="install" onclick="GO_MENU(\'charge\');"><span class="btn_install"><span></span>ì¶©ì íê¸°</span></a>'),
      (e +=
        '					<a><span data-idx="6565307" class="btn_report" data-mobile="0" onclick="CONTENTS_FUN.contentsBadReport(this);"><span></span>ì ê³ íê¸°</span></a>'),
      (e += "				</div>"),
      (e += "			</div>"),
      (e += '			<div class="install_guide">'),
      (e += '				<div id="fc-warning-guid-install" style="display: none;">'),
      (e += '					<div class="bg-warning1 fc-view-guide-install">'),
      (e += "						<h3>ë¤ì´ë¡ë íë¡ê·¸ë¨ì´ ì¤ì¹ëì´ìëì§ íì¸í´ì£¼ì¸ì!</h3>"),
      (e +=
        '						<p class="ad_txt"> ActiveX(ì¡í°ë¸ìì¤)ë¥¼ ì¬ì©íì§ ìì, ë¹ ë¥´ê³  ìì í©ëë¤.</p>'),
      (e += '						<span onclick="FILE_FN.startDownloaderInstaller(this);">'),
      (e += '							<a class="install">'),
      (e += "								<span>"),
      (e += '									<span class="b_txt">íì¼ìºì¤í¸ ë¤ì´ë¡ë ì¤ì¹íê¸°</span>'),
      (e += '									<span class="s_txt">ëª¨ë  ë¸ë¼ì°ì  í¸í ì©ë 17MB</span>'),
      (e += "								</span>"),
      (e += "							</a>"),
      (e += "						</span>"),
      (e +=
        '						<span class="btn_exit" onclick="FILE_FN.setDownloaderInstallOk(true);">'),
      (e += '							<a class="install type1">'),
      (e += "								<span>"),
      (e +=
        '									<span class="b_txt">ë´ PCë ì´ë¯¸ íì¼ìºì¤í¸ê° ì¤ì¹ëì´ììµëë¤.</span>'),
      (e +=
        '									<span class="s_txt">ì¤ì¹ í ë¤ì´ë¡ëê° ëì§ ìëë¤ë©´ ì¬ì¤ì¹ë¥¼ ê¶ì¥í©ëë¤.</span>'),
      (e += "								</span>"),
      (e += "							</a>"),
      (e += "						</span>"),
      (e +=
        '						<p class="explain">â» <span class="txt_yellow">ActiveXì ì ëì¨ì´ê° ìë íì¼ìºì¤í¸ë ë¹ ë¥´ê³  ê°ë³ìµëë¤.</span> ë¤ì´ë¡ëê° ëì§ ìëë¤ë©´ ë°ëì íì¼ìºì¤í¸ë¥¼ ì¤ì¹í´ì£¼ì¸ì.</p>'),
      (e += "					</div>"),
      (e += "				</div>"),
      (e +=
        '				<div id="fc-warning-guid-install-allways" style="display: none;">'),
      (e += '					<div class="bg-warning">'),
      (e +=
        "						<p>ë¤ì´ë¡ë ì  ë¤ì íë² íì¸í´ì£¼ì¸ì. ë¤ì´ë¡ëë¥¼ íë ¤ë©´ <b>ë¤ì´ë¡ë ì ì© íë¡ê·¸ë¨ì´ ì¤ì¹</b>ëì´ ìì´ì¼í©ëë¤.</p>"),
      (e +=
        '						<span onclick="FILE_FN.startDownloaderInstaller(this);"><a id="fc-warning-guid-install-allways-shake" class="install fc-view-guide-install">íì¼ìºì¤í¸ ë´ë ¤ë°ê¸° íë¡ê·¸ë¨ ë¤ì´ë¡ë</a></span>'),
      (e += "					</div>"),
      (e += "				</div>"),
      (e += "			</div>"),
      (e +=
        '			<div class="v_btn_wrap1" id="contents-view-top-btn-list" style="margin-top: 0px; position: relative; background: rgb(215, 217, 218); transition: background-color 300ms;">'),
      (e +=
        '				<input id="fc-custum-protocol-input" value="" placeholder="custom protocol" style="width:0px;border:0px;position: absolute;left: 0;  display:none;  background: #d7d9da;">'),
      (e +=
        '				<span class="re_down btn-view-redown" data-alam="0" data-file="" data-cate1="2" data-is_adult="0" data-copy="" data-dcount="0" onclick="FILE_FN.checkFileDownloader(6565307, this);" data-type="REDOWN_CONTENTS" data-down="0" style="display: none;">ë¤ìë°ê¸°</span>'),
      (e +=
        '				<span class="down btn-view-down " data-alam="0" data-file="" data-cate1="2" data-is_adult="0" data-copy="" data-dcount="0" onclick="FILE_FN.checkFileDownloader(6565307, this);" data-type="TRY" data-down="0">ë¤ì´ë¡ë </span>	'),
      (e +=
        '				<span class="coupon" data-alam="0" data-file="" data-copy="" data-dcount="0" onclick="FILE_FN.checkFileDownloader(6565307, this);" data-type="COUPON" data-down="0">ì¿ í° ì¬ì©</span>'),
      (e +=
        '				<span class="like" onclick="WEB_CONTENTS.VIEW.onclickFavoritesContents(this);" data-idx="6565307" data-mobile="0">ì°íê¸°</span>'),
      (e += "			</div>"),
      (e += '			<div id="video-info" style="display: none;"></div>'),
      (e += '			<div style="position: relative;">'),
      (e +=
        '				<div class="non-editor-view-div preview_wrap1" id="view-preview-wrap-div">'),
      (e += '					<div class="preview_top">'),
      (e += "						<h2>íì¼ìºì¤í¸ 1ë¶ ë¯¸ë¦¬ë³´ê¸°</h2>"),
      (e +=
        "						<p>íì¼ìºì¤í¸ë ì¸ì ì´ëìë <span>ëª¨ë°ì¼ë¡ ì¤ìê° ê°ìì´ ê°ë¥</span>í©ëë¤.</p>"),
      (e +=
        '                    	<span id="streamMovicInfo" data-url="' +
        this.file_stram +
        '" data-img="' +
        this.view_bbs.stream_bestimg +
        '" data-target="view-video-js-preview-contents"></span>'),
      (e += "					</div>"),
      (e +=
        '					<div class="preview_content" id="view-video-js-preview-contents">'),
      (e +=
        '						<input type="hidden" name="video-prev-src-input" id="video-prev-src-input" value="' +
        this.file_stram +
        '"/>'),
      (e +=
        '							<video id="video-container" width="898" height="400" id="preview_player" preload="none" poster="' +
        this.view_bbs.stream_bestimg +
        '" style="margin: auto;height: 400px;">'),
      (e +=
        '								<source type="application/x-mpegURL" src="http://static.filecast.co.kr/_lib/mediaelement/media/playlist.m3u8" />'),
      (e += "								ì§ìíì§ ìë ë¸ë¼ì°ì ¸ìëë¤."),
      (e += "							</video>"),
      (e += "					</div>"),
      (e += '					<div class="preview_btm">'),
      (e +=
        "						<p>1ë¶ ë¯¸ë¦¬ë³´ê¸° ììì ìíììì¼ë¡ íì§ì ì¤ì  ìë³¸ê³¼ ì°¨ì´ê° ììµëë¤. <span>ê³ íì§ ì ì²´ê°ìì ë¤ì´ë¡ë í ì´ì©í´ì£¼ì¸ì!</span></p>"),
      (e += "					</div>"),
      (e += "				</div>"),
      (e +=
        '				<div class="not-login-contents preview_wrap1 hand ' +
        this.prev_overlayer_class +
        '" id="view-preview-wrap-div-notlogin" style="position: absolute; top: 0px;left: 0px;" onclick="GO_MENU(\'login\', \'modal\');"></div>'),
      (e += "			</div>");
    var t = "";
    1 == isDefined(this.view_bbs_purchase_stat) &&
      this.view_bbs_purchase_stat.stat.cnt > 0 &&
      ((t =
        this.view_bbs_purchase_stat.stat.most_year_txt +
        " " +
        this.view_bbs_purchase_stat.most_gender),
      (e +=
        '			<div class="view_donut" id="new-view-contents-pur-graph" style="width:898px;height: 305px;">'),
      (e +=
        '				<h2>ì´ ì½íì¸ ë¥¼ êµ¬ë§¤í íì¼ìºì¤í¸ íìì? <span class="s_txt">íì¼ìºì¤í¸ íìëë¤ì êµ¬ë§¤ íìë¥¼ ê¸°ë°ì¼ë¡ 5ë¶ ì£¼ê¸°ë¡ ìë°ì´í¸ë©ëë¤.</span></h2>'),
      (e += '				<div class="donut_area" style="height: 167px;">'),
      (e += '					<div class="donut_l">'),
      (e += '						<div class="grade">'),
      (e +=
        '							<p class="men most"><span class="ico"></span><span class="num">ë¨ì± <span class="size">' +
        this.view_bbs_purchase_stat.man_percent +
        "</span><span>%</span></span></p>"),
      (e +=
        '							<p class="woman most"><span class="ico"></span><span class="num">ì¬ì± <span class="size">' +
        this.view_bbs_purchase_stat.woman_percent +
        "</span><span>%</span></span></p>"),
      (e += "						</div>"),
      (e += '						<div class="chart_area" id="gender-graph">'),
      (e += '							<svg id="gender-donut-graph"></svg>'),
      (e += "						</div>"),
      (e += "					</div>"),
      (e += '					<div class="donut_r">'),
      (e += '						<div class="grade">'),
      (e +=
        '							<p class="age t40 most"><span class="color_area"></span><span class="txt">40ë ì´ì<span class="per">' +
        this.view_bbs_purchase_stat.sort_age[40] +
        "<span>%</span></span></span></p>"),
      (e +=
        '							<p class="age t30 most"><span class="color_area"></span><span class="txt">30ë<span class="per">' +
        this.view_bbs_purchase_stat.sort_age[30] +
        "<span>%</span></span></span></p>"),
      (e +=
        '							<p class="age t20 most"><span class="color_area"></span><span class="txt">20ë<span class="per">' +
        this.view_bbs_purchase_stat.sort_age[20] +
        "<span>%</span></span></span></p>"),
      (e +=
        '							<p class="age t10 most"><span class="color_area"></span><span class="txt">10ë<span class="per">' +
        this.view_bbs_purchase_stat.sort_age[10] +
        "<span>%</span></span></span></p>"),
      (e += "						</div>"),
      (e += '						<div class="chart_area" id="age-graph">'),
      (e += '							<svg id="age-donut-graph"></svg>'),
      (e += "						</div>"),
      (e += "					</div>"),
      (e += "				</div>"),
      (e +=
        '				<p class="d_txt">ì´ <span>' +
        this.view_bbs_purchase_stat.stat.cate_txt +
        '</span> <span class="t_red">' +
        t +
        "</span>ìê² ê°ì¥ ì¸ê¸°ë§ì ì½íì¸ ìëë¤.</p>"),
      (e += "			</div>")),
      (e += '			<div class="non-editor-view-div data_content1">'),
      (e += '                <div class="view-contetns-p">'),
      (e +=
        '                	<p><img itemprop="image" class="fc-view-img-lazy" style="max-width:800px;" onerror="utility.ui.onErrorImgLoadViewContents(this);" src="http://pic.filecast.co.kr/64/33/6433e6912bdc29f1734f19aaea17ec3a.jpg" =700="" border="0"></p><p style="PADDING-BOTTOM: 4px"></p><p><img itemprop="image" class="fc-view-img-lazy" style="max-width:800px;" onerror="utility.ui.onErrorImgLoadViewContents(this);" src="http://pic.filecast.co.kr/87/68/87683765e7b075c0769d8fa11095c868.jpg" =700="" border="0"></p><p style="PADDING-BOTTOM: 4px"></p><p><img itemprop="image" class="fc-view-img-lazy" style="max-width:800px;" onerror="utility.ui.onErrorImgLoadViewContents(this);" src="http://pic.filecast.co.kr/c9/a8/c9a87e82b77b438591c9838147c67c8e.jpg" =700="" border="0"></p><p style="PADDING-BOTTOM: 4px"></p><p><img itemprop="image" class="fc-view-img-lazy" style="max-width:800px;" onerror="utility.ui.onErrorImgLoadViewContents(this);" src="http://pic.filecast.co.kr/ad/6e/ad6eec959de24f6948dee9e9e1b798f6.jpg" =700="" border="0"></p><p style="PADDING-BOTTOM: 4px"></p><p><img itemprop="image" class="fc-view-img-lazy" style="max-width:800px;" onerror="utility.ui.onErrorImgLoadViewContents(this);" src="http://pic.filecast.co.kr/c8/ac/c8ac679844bf9aec7997c9809dc96fcd.jpg" =700="" border="0"></p><p style="PADDING-BOTTOM: 4px"></p>                </div>'),
      (e += "			</div>"),
      (e += '			<div class="adult_explain show">'),
      (e += '				<div class="adult_logo"></div>'),
      (e +=
        '				<p class="style1">ìë ì²­ìë ì´ì©ìëë¬¼ì ì ì/ë°°í¬/ìì§ì <b>ìë ì²­ìëì ì±ë³´í¸ì ê´íë²ë¥  11ì¡°</b>ì ë°ë¼ <b>íì¬ì²ë²</b>ì ë°ì ì ììµëë¤.</p>'),
      (e += "			</div>"),
      (e += "		</div>"),
      (e += "	</div>"),
      (e += "	/* //bbs info -*/"),
      (e += '	<div class="non-editor-view-div another_like">'),
      (e += "		<h2>íë§¤ìì ë¤ë¥¸ìë£ ë³´ê¸°</h2>"),
      (e += "		/* contents list */"),
      (e +=
        '		<ul class="otherList" id="view-seller-other-contents-list"><li class=" hand " data-cate1="2" data-idx="6565312" onclick="WEB_CONTENTS.VIEW.getContentsViewFromOtherList(this);">  <div class="clist  l1">		<span class="list_sumimg"><img onerror="utility.ui.onErrorImgLoad(this);" src="http://pic.filecast.co.kr/e9/99/e9997793cefb5e600c16a3fa96df7f95.gif" style="width:45px;height:45px;"></span>		<span class="ico adult"></span><span class="tit view-seller-contents-list">[ë¯¸ë] ìì¹´ê³ íì´ì´(Chicago Fire) ìì¦1 01í-24í(ì) íìíµí©ìë§ ìë°©ê´ mcq.</span>	    <span class="ico hot">Hot</span><span class="ico new">new</span><span class="ico hd">hd</span>  </div>  <div class="l2">ë°©ì¡&gt; ë¯¸ë</div></li><li class=" handbg " data-cate1="2" data-idx="6565310" onclick="WEB_CONTENTS.VIEW.getContentsViewFromOtherList(this);">  <div class="clist  l1">		<span class="list_sumimg"><img onerror="utility.ui.onErrorImgLoad(this);" src="http://pic.filecast.co.kr/13/6e/136e0c8bac8352759d95a1d915d00754.gif" style="width:45px;height:45px;"></span>		<span class="ico adult"></span><span class="tit view-seller-contents-list">[ë¯¸ë] ì¤ìì¹ëì³ë²ì¤(Switched at Birth) ìì¦2 01í-21í(ì) íìíµí©ìë§ mcq.</span>	    <span class="ico hot">Hot</span><span class="ico new">new</span><span class="ico hd">hd</span>  </div>  <div class="l2">ë°©ì¡&gt; ë¯¸ë</div></li><li class=" hand " data-cate1="2" data-idx="6565308" onclick="WEB_CONTENTS.VIEW.getContentsViewFromOtherList(this);">  <div class="clist  l1">		<span class="list_sumimg"><img onerror="utility.ui.onErrorImgLoad(this);" src="http://pic.filecast.co.kr/97/df/97dfe1844a386f507857b3dffdcb244e.gif" style="width:45px;height:45px;"></span>		<span class="ico adult"></span><span class="tit view-seller-contents-list">[ë¯¸ë] ì¤ìì¹ëì³ë²ì¤(Switched at Birth) ìì¦1 01í-30í(ì) íìíµí©ìë§ mcq.</span>	    <span class="ico hot">Hot</span><span class="ico new">new</span><span class="ico hd">hd</span>  </div>  <div class="l2">ë°©ì¡&gt; ë¯¸ë</div></li><li class=" handbg " data-cate1="2" data-idx="6565305" onclick="WEB_CONTENTS.VIEW.getContentsViewFromOtherList(this);">  <div class="clist  l1">		<span class="list_sumimg"><img onerror="utility.ui.onErrorImgLoad(this);" src="http://pic.filecast.co.kr/ba/20/ba202daf5c2193cf444ff0d5ca189d49.gif" style="width:45px;height:45px;"></span>		<span class="ico adult"></span><span class="tit view-seller-contents-list">[ë¯¸ë] ìíë¼ë¸ì¤(The Sopranos) ìì¦4 01í-13í(ì) íìíµí©ìë§ ë§í¼ì mcq.</span>	    <span class="ico hot">Hot</span><span class="ico new">new</span><span class="ico hd">hd</span>  </div>  <div class="l2">ë°©ì¡&gt; ë¯¸ë</div></li><li class=" hand " data-cate1="2" data-idx="6565278" onclick="WEB_CONTENTS.VIEW.getContentsViewFromOtherList(this);">  <div class="clist  l1">		<span class="list_sumimg"><img onerror="utility.ui.onErrorImgLoad(this);" src="http://pic.filecast.co.kr/ed/af/edafa1765980bdcc46f60e21b8bd3aef.gif" style="width:45px;height:45px;"></span>		<span class="ico adult"></span><span class="tit view-seller-contents-list">[ë¯¸ë] ëëì´í¸ì¬íí¸(The Night Shift) ìì¦1 01í-08í(ì) íìíµí©ìë§ mcq.</span>	    <span class="ico hot">Hot</span><span class="ico new">new</span><span class="ico hd">hd</span>  </div>  <div class="l2">ë°©ì¡&gt; ë¯¸ë</div></li></ul>'),
      (e +=
        '		<span class="more_data hand" id="view-more-seller-contents-list" onclick="WEB_CONTENTS.VIEW.onclickMoreSellerContents(this);"><span class="bg"></span>ìë£ ë ë³´ê¸°</span>'),
      (e += "		/* paging */"),
      (e += '		<div id="contentsDetailEndDiv" class="empty-2px"></div>'),
      (e += "	</div>   			"),
      (e += "    /* comment_wrap */"),
      (e += "	<div>"),
      (e +=
        '		<form id="writeBbsCommentForm" name="writeBbsCommentForm" novalidate="novalidate">'),
      (e += '           <input type="hidden" name="bbs_idx" value="6565307">'),
      (e +=
        '           <input type="hidden" name="gift" id="comment-write-input-gift" value="5">'),
      (e += '           <input type="hidden" name="depth" value="1">'),
      (e += '           <input type="hidden" name="thread" value="0">'),
      (e += '           <input type="hidden" name="type" value="bbs">'),
      (e += '			 <div class="non-editor-view-div v_comment_wrap">'),
      (e += "				<h2>ëê¸/íê°</h2>"),
      (e +=
        "				<p>í¡í¡ íë ëê¸íì ë¨ê²¨ì£¼ìë©´ íë§¤ìê° <b>ë¬´ë£ ë¤ì´ë¡ë ì¿ í°ì ì ë¬¼</b>ë¡ ëë¦½ëë¤..</p>"),
      (e += '				<div class="v_comment_input">'),
      (e +=
        '					<textarea name="comments" id="comment-write-textarea-comments" placeholder="íê°ê¸ì 5ì ì´ì ìì± ì ë±ë¡ ê°ë¥í©ëë¤. ë³ì ë§ ì íí  ê²½ì°, ê¸°ë³¸ íê°ê¸ì´ ë±ë¡ë©ëë¤."></textarea>'),
      (e += '					<div class="input_inner">'),
      (e += '						<dl class="star_wrap">'),
      (e += "							<dt>ì½íì¸  íê°íê¸°</dt>"),
      (e += '							<dd class="star_score style1">'),
      (e +=
        '								<span id="star1" class="case view-comment-star on"></span><span id="star2" class="case view-comment-star on"></span><span id="star3" class="case view-comment-star on"></span><span id="star4" class="case view-comment-star on"></span><span id="star5" class="case view-comment-star on"></span>'),
      (e +=
        '								<em><span><strong class="cnt">5</strong>/5</span> <strong class="txt">ì ë§ì¢ìì</strong></em>'),
      (e += "							</dd>"),
      (e += "						</dl>"),
      (e += '						<button type="submit" class="btn_register">ë±ë¡</button>'),
      (e += "					</div>"),
      (e += "				</div>"),
      (e += "			 	/* commentArea */"),
      (e += '				<div class="commentArea" id="bbs-contetns-comment-list"></div>'),
      (e +=
        '				<div style="display: none;" class="more_reply hand" id="bbs-comment-get-more" data-type="bbs" data-page="1" data-limit="20" data-tota_page="0" data-tota_count="0" onclick="WEB_CONTENTS.getBbsMoreAllCommentList(this);"><a><span class="bg"></span>ëê¸ <span class="c_count"></span>ê° ë ë³´ê¸°</a></div>'),
      (e += "			</div>"),
      (e += "		</form>"),
      (e += "    </div>"),
      (e += "    /* comment_wrap */"),
      (e +=
        '	<span onclick="utility.ui.modalTop();" class="btn_v_top" id="btn_v_top" style="top: 836px;">topë²í¼</span>'),
      (e += "</div>");
    try {
      return e;
    } finally {
  ...
  (Contentsview.prototype.showPurchaseStat = function () {
    if (
      (console.log("showPurchaseStat"),
      console.debug(this.view_bbs_purchase_stat),
      0 != isDefined(this.view_bbs_purchase_stat))
    ) {
      if (1 > this.view_bbs_purchase_stat.stat.cnt)
        return (
          alert("hide stat"),
          jQuery("#new-view-contents-pur-graph").hide(),
          void 0
        );
      var e = this.view_bbs_purchase_stat.stat.sort_age,
        t = this.view_bbs_purchase_stat.stat.gender;
      WEB_CONTENTS.VIEW.drawDonutGraph(
        e,
        this.view_bbs_purchase_stat.stat.most_year_per,
        "age-donut-graph"
      ),
        WEB_CONTENTS.VIEW.drawDonutGraph(
          t,
          this.view_bbs_purchase_stat.stat.most_gender_per,
          "gender-donut-graph"
        ),
        jQuery("#new-view-contents-pur-graph").show();
    }
  }),
  (WEB_CONTENTS_VIEW_FUN = {}),
  (WEB_CONTENTS_VIEW_FUN.openContentsView = function (e) {
    console.log("WEB_CONTENTS_VIEW_FUN.openContentsView"), console.debug(e);
    var t = new FC_APP(),
      a = function (a) {
        console.log("successHttpGetViewAjaxData"),
          console.log(a),
          WEB_CONTENTS_VIEW_FUN.setContentsView(a, t, e);
      },
      i = {
        server: t.DEFINE.SERVER_PROTOCOL,
        uri: t.PROTOCOL.URL.CONTENTS.AJAX_VIEW,
        success: a,
        error_type: !1,
        loading_bar: !0,
        params: e,
  ...
  (WEB_CONTENTS_VIEW_FUN.setContentsView = function (e) {
    console.log("WEB_CONTENTS_VIEW_FUN.setContentsView");
    var t = new Contentsview(e);
    console.debug(t),
      jQuery("#loadViewContents").empty(),
      jQuery("#loadViewContents").html(t.getShowHtml()),
      t.showPurchaseStat(),
      1 == jQuery("#contentsViewModal").hasClass("in")
        ? (console.log("modal yet"),
          setTimeout(function () {
...
(WEB_EVENT.DATA = { ORDER: 0, CALENDAR: null, FORM: null }),
  ...
  (WEB_EVENT.attend_new.load = function () {
    if ((console.log("WEB_EVENT.attend.load"), null == APP))
      var e = new FC_APP();
    else var e = APP;
    WEB_EVENT.attend_new.setAttendCalendar(e, !0);
  }),
  (WEB_EVENT.attend_new.getPageData = function () {}),
  (WEB_EVENT.attend_new.setAttendCalendar = function (e, t) {
    console.log("setAttendCalendar"),
      parseInt(jQuery("#memberLoginOk").val()),
      parseInt(jQuery("#memberValidAauthentic").val());
    var a = null,
      ...
      n = function (e) {
        ...
        var a = t.data("type");
        return "today" == a
          ? (WEB_EVENT.attend_new.onclickJoinAttend(), void 0)
          : void 0;
      },
      s = function (e) {
        console.log("myNavFunction");
      ...
      o = function (t) {
        if (
          ...
          var n = t[34],
            s = jQuery(".zabuto_calendar").attr("id"),
            o = s.split("_"),
            r = null;
          if ((o.length > 2 && (r = o[2]), isDefined(n.event_data))) {
            var l = n.event_data,
              c = 1;
            for (var d in l) {
              if (
                (1 == l[d] &&
                  jQuery(".new-yearevent-day-" + c).addClass("active"),
                null != r)
              ) {
                var u = "#zabuto_calendar_" + r + "_2017-01-" + d + "_day";
                jQuery(u).find(".ico_attend").addClass("lucky"),
                  jQuery(u).find(".attend-check").addClass("lucky");
              }
              jQuery(".new-yearevent-day-" + c)
                .find(".click_area")
                .data("days", d),
                c++;
            }
  ...
  (WEB_EVENT.attend_new.onclickJoinAttendEvent = function (e) {
    console.log("WEB_EVENT.attend_new.onclickJoinAttendEvent");
    var t = new Date(),
      a = t.getDate(),
      i = jQuery(e).data("days");
    return (
      console.log("toDays:" + a),
      console.log("clickDays:" + i),
      a != i
        ? (alert("ì¤ë ë ì§ì ì´ë²¤í¸ë§ ì°¸ì¬ ê°ë¥í©ëë¤."), void 0)
        : (WEB_EVENT.attend_new.onclickJoinAttend(), void 0)
    );
  }),
    ...
    var a = new FC_APP(),
      i = function (e) {
        console.log("successHttpJoinAttendEvent"),
          ...
          jQuery(".today-div").parent().addClass("event active");
        var t = e.log_data.cash,
          i = "ì´ë²¤í¸ì ì°¸ì¬í´ ì£¼ìì ê°ì¬í©ëë¤.\n" + t + "pê° ì§ê¸ëììµëë¤.";
        if (1 == isDefined(e.new_year_event)) {
          var n = e.new_year_event,
            s = jQuery(".zabuto_calendar").attr("id"),
            o = s.split("_"),
            r = null;
          if (
  ...
  (WEB_FRIEND.friendList = function (e, t, a, i) {
    ...
    var h = function (e) {
        ...
        if (
          ...
          for (var f = 0; u > f; f++) {
            var p = e.f_list.list[f],
              h = new Friendlist(
                p,
                Number(e.f_list.total_count - t * (i - 1) - f),
                _
              );
            c.push(h.webListHtml());
          }
...
(WEB_SEARCH.DATA = null),
  ...
  (WEB_SEARCH.setSearchListAjaxData = function (e) {
    ...
    if (
      ...
      var f = e.bbs_data.cate1;
      1 == isDefined(e.cate_count_list) &&
        WEB_SEARCH.setSearchResultCategoryCount(APP, e.cate_count_list, f);
    }
...
/*
page: http://www.filecast.kr/
url: http://static.filecast.co.kr/__release/js/web.01.24.05.filecast.min.js
*/
