...
!(function (e) {
    ...
    function n(e) {
      ...
      switch (
        ...
        case "us.boohoo.com":
          return "[[_US_]]";
        default:
          switch (e.page.location().pathname.split("/")[1]) {
            case "aus":
              return "[[_AU_]]";
            case "newz":
              return "[[_NZ_]]";
  ...
  function (e, t, n) {
    ...
    var r = n(63),
      ...
      a = n(66),
      u = {
        email: ["input[type=email]", "#dwfrm_profile_customer_email"],
        firstName: [
          "#first_name",
        ...
        phone: {
          landline: ["#landline"],
          mobile: ["#mobile", ".input-text.lastName.required"],
        },
      ...
      s = (function () {
        ...
        return (
          ...
          (e.prototype.isPurchaseComplete = function () {
            ...
            return (
              !(
                !this.api.strings.includes(e, "step=orderreceipt") &&
                !this.api.strings.includes(e, "/checkout/onepage/success")
              ) ||
              (this.api.strings.includes(e, "/cosummary-submit") &&
                this.api.fluent.querySelector(".confirmation-message").exists())
            );
          }),
          (e.prototype.scrapers = function () {
            ...
            return {
              ...
              customer: function () {
                var t = e.fluent.querySelector(u.optIn);
                return {
              ...
              order: function () {
                ...
                if (n || r) {
                  var o = n ? window.dataLayer : window.GTM_dataLayer,
                    i = a.correctIndex(o, "orderId", "f"),
                    u = i > -1 ? o[i] : null;
                  if (o && u && "string" == typeof u.orderId)
                    return { id: u.orderId };
                }
                var s = e.fluent.querySelector(".main a");
                ...
                var c = e.fluent.querySelector(".js-ohordnum");
                if (c.exists()) return { id: c.textContent().done() };
  ...
  function (e, t, n) {
    ...
    function r(e) {
      ...
      return (
        (n.items = t
          ...
          .map(function (e) {
            var t = e.getTextContent(".sku .value").done(),
              ...
              v = e.getTextContent(".is-in-stock").exists(),
              g = e
        ...
        a && n.keywords.push("hasPremierDelivery"),
        n
      );
    }
    var o = n(22);
