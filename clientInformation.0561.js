!(function (e) {
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.getTextContent("p.subtotal").replace(/\s/g, "").done();
      if (t && t.indexOf(":") > -1) {
        var n = t.split(":");
    ...
    function r(e, t) {
      var n = e.fluent.querySelectorAll("#cart-sidebar li.item").done().length;
      return (
        !t.exists() ||
        e.fluent.request.url().includes("/checkout/cart", !0) ||
        0 === n
      );
    }
    function o(e, t) {
      return (
        !t.exists() || !e.fluent.request.url().includes("/checkout/cart", !0)
      );
    }
    (t.calcMiniCartSubtotal = n),
      (t.isMiniCartPage = r),
      (t.isMainCartPage = o);
  },
  function (e, t) {
      ...
      s = (function () {
        ...
        return (
          (e.prototype.client = function () {
            return {
              apiKey: "67C50458-5818-4F73-98CC-4AB231E910CE",
              v1Id: 19341,
              v2Id: 1852,
            };
          }),
          (e.prototype.isPurchaseComplete = function () {
            return this.api.fluent.request
              .url()
              .includes("/checkout/onepage/success", !0);
          }),
          (e.prototype.scrapers = function () {
            ...
            return {
              ...
              order: function () {
                return { id: e.fluent.getTextContent(".col-main p a").done() };
              },
              product: function () {
                return i.default(e);
              },
          ...
          (e.prototype.osr = function () {
            ...
            return {
              ...
              templateHelper: function (t, n) {
                if (4321 === t) return new a.OSR4321(e, n);
              },
            };
          }),
          e
  ...
  function (e, t, n) {
    ...
    var r = n(63),
      o = (function () {
        function e(e, t) {
          (this.api = e), (this.contentDiv = t), (this.templateId = 4321);
        }
        return (
          (e.prototype.scrapers = function () {
            var e = this.api,
            ...
            return {
              email: function () {
                var n = t.getStringValue("input.emb-sc").done();
          ...
          (e.prototype.preScrapers = function () {
            var e = this.api.fluent.querySelector(
  ...
  function (e, t, n) {
    ...
    function r(e) {
      var t = {},
        n = e.fluent.querySelector("#shopping-cart-table");
      if (o.isMainCartPage(e, n)) return null;
      var r = e.fluent.querySelector("#shopping-cart-totals-table"),
        i = r
          .getTextContent("tr:nth-child(3) .price")
          .replace(/\s/g, "")
          .done();
      return (
        (t.costs = { subtotal: i }),
        (t.tagBag = { abt: i }),
        (t.items = n
          .querySelectorAll("tr.odd")
          .map(function (e) {
            var t = e.getTextContent("span.supplierref").done(),
              n = e.getTextContent("div.model-name").done(),
              r = e
                .querySelector("h2.product-name a")
                .getAttribute("href")
                .done(),
              o = e.getTextContent("p.product-sku span").done(),
              i = e
                .getStringValue(".product-cart-actions input.qty")
                .toInt()
                .done(),
              a = e
                .getTextContent(".product-cart-price span.price")
                .replace(/\s/g, "")
                .done(),
              u = e
                .getTextContent(".product-cart-total span.price")
                .replace(/\s/g, "")
                .done(),
              s = e
                .querySelector(".product-cart-image img")
                .getAttribute("src")
                .done(),
              c = !0;
            return {
  ...
  function (e, t, n) {
    "use strict";
    function r(e) {
      var t = e.fluent.querySelector("#header-cart"),
        n = {};
      if (i.isMiniCartPage(e, t)) return null;
      var r = o.calcMiniCartSubtotal(e);
      return (
        ...
        (n.items = t
          ...
          .map(function (e) {
            var t = e
                .getTextContent(".product-details .price")
                .replace(/\s/g, "")
                .done(),
              n = e.getTextContent(".product-sku").done(),
              r = e.querySelector("img").getAttribute("src").done(),
              o = !0,
              i = e.getTextContent("span.supplierref").done(),
              a = e.getTextContent("div.model-name").done(),
              u = e
                .querySelector(".product-name a")
                .getAttribute("href")
                .done(),
              s = e.getStringValue(".qty").toInt().done();
            return {
              product: {
                costs: { singleItem: t },
                id: n,
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector(".product-essential");
      if (!t.exists()) return null;
      var n = t.getTextContent(".model-name").done(),
        r = t.getTextContent(".supplierref").done(),
        o = t.getTextContent(".product-sku").done(),
        i = "Disponible" === t.getTextContent(".in-stock .value").done(),
        a = t.getTextContent(".special-price .price").replace(/\s/g, "").done(),
        u = t.getTextContent(".regular-price .price").replace(/\s/g, "").done(),
        s = t
          .querySelector([".swiper-slide-active img", ".product-img-box img"])
          .getAttribute("src")
          .done();
      return (
        s &&
          s.indexOf("thumbnail/120x") > -1 &&
          s.replace("thumbnail/120x", "image/800x"),
        {
          costs: {
            singleItem: a ? a : u,
            previous: a
              ? e.fluent
                  .getTextContent(".old-price .price")
                  .replace(/\s/g, "")
                  .done()
              : null,
          },
...
/*
page: http://www.group-digital.fr/
url: http://d16fk4ms6rqz1v.cloudfront.net/capture/groupdigital.js
*/
