!(function (e) {
        ...
        if ("string" == typeof e.html || "" === e.html) {
          ...
          try {
            (r = decodeURIComponent(e.stylesheet)),
              (i = decodeURIComponent(e.ie9stylesheet));
          } catch (e) {
            u.noop();
          }
          var a = o.document();
          return (
            f(
              { css: r, defaultCSS: decodeURIComponent(e.defaultCSS), ie9: i },
              a
            ),
            t.createOverlay(a),
            d(n, a)
          ...
          return i
            ...
            .then(function (e) {
              if (e)
                return (
                  (n.metricData = e),
                  v(r.preScrape.showTrends, n).then(function (o) {
                    if (o) {
            ...
            .then(function () {
              var o = p();
              return !!o && (m(t, n, e, r, a), !0);
            });
        var u = p();
        return !!u && (m(t, n, e, r, a), !0);
      });
    };
  },
  function (e, t, n) {
    ...
    var o = n(1),
      ...
      f = function (e) {
        ...
        o.on(
          ...
          function (t) {
            !t.target ||
              (t.target.className.indexOf(s.substring(1)) === -1 &&
                t.target.className.indexOf(u.substring(1)) === -1) ||
              a.invokeEvent(n, t, e);
          },
          t
        );
        ...
        return o
          ...
          .then(function (n) {
            if (n) {
              ...
              var d = c(f);
              a.default(n.config, e, t, d), s.default(e, n, f, d, r);
            }
          })
          .catch(function (e) {
            return i.noop();
  ...
  function (e, t, n) {
    ...
    var I = function (e, t) {
      var n = y(e, t);
      (h[e] = n.frameGuid),
        document.body ? S(n) : (l.push(n), m || ((m = !0), a.on("load", b)));
    };
  ...
  function (e, t, n) {
    ...
    (t.init = function (e, t, n, r) {
      ...
      var o = s.getScrapeFunctions(r),
        ...
        v = c.init(o.subStates, u.subStates),
  ...
  function (e, t, n) {
    ...
    var r = n(74),
      o = n(72),
      i = {
        email: ["#mainPassanger_Email"],
        firstName: ["#Response_Passengers_0__GivenName"],
        lastName: ["#Response_Passengers_0__Surname"],
        phone: { landline: ["#mainPassanger_Telephone"] },
        salutation: ["#title"],
        optIn: "#optIn",
      },
      a = {
        enGB: {
          apiKey: "B5748569-EF86-428B-8FE2-7033D6103336",
          v1Id: 19325,
          v2Id: 1842,
        },
        other: {
          apiKey: "5B5EA624-F847-4C37-A18C-581418F674DB",
          v1Id: 19356,
          v2Id: 0,
        },
      },
      u = (function () {
        ...
        return (
          (e.prototype.client = function () {
            return this.api.fluent.request.url().includes("en-gb", !0)
              ? a.enGB
              : a.other;
          }),
          (e.prototype.isPurchaseComplete = function () {
            return (
              this.api.fluent.request.url().includes("bookingnumber", !0) &&
              this.api.fluent.request.url().includes("confirmed", !0)
            );
          }),
          (e.prototype.scrapers = function () {
            ...
            return {
              ...
              customer: function () {
                var t = e.fluent.querySelector(i.optIn);
                return {
              ...
              order: function () {
                var t = null,
                  n = window.bookingModel,
                  r = e.fluent.querySelector(
                    ".form-section-title .brand-color"
                  );
                return (
                  r.exists() && (t = r.textContent().done()),
                  !t && n && n.BookingNumber && (t = n.BookingNumber),
                  { id: t }
                );
              },
              product: function () {
              ...
              tagBag: function () {
                return {
                  ft3: e.fluent.getTextContent("#msh-from").done(),
                  tt3: e.fluent.getTextContent("#msh-to").done(),
                };
              },
            };
          }),
          ...
          (e.prototype.osr = function () {
            ...
            return {
              ...
              templateHelper: function (t, n) {
                if (4303 === t) return new o.OSR4303(e, n);
              },
            };
          }),
          e
  ...
  function (e, t, n) {
    ...
    var r = n(62),
      o = (function () {
        function e(e, t) {
          (this.api = e), (this.contentDiv = t), (this.templateId = 4303);
        }
        return (
          (e.prototype.scrapers = function () {
            var e = this.api,
            ...
            return {
              ...
              customer: function () {
                ...
                if (!e) throw new r.default("Please enter a valid name");
                var n, o;
                if (e && e.indexOf(" ") >= -1) {
                  var i = e.split(" ");
                  (n = i.shift()), (o = i.join(" "));
                } else n = e;
                return { firstName: n, lastName: o };
              },
            };
          }),
  ...
  function (e, t) {
    ...
    function r(e) {
      if (e.fluent.request.url().includes("en-gb", !0)) return "[[_english_]]";
    }
    function o(e, t, n, r, o, i, a, u, s, c, l) {
      var f;
      return "[[_english_]]" !== t
        ? "https://wizztours.com/"
        : ((f = "https://wizztours.com/en-GB/Travel?search="),
          (f += '{"DepartureDate":"' + n + '",'),
          (f += '"DepartureCode":"' + r + '",'),
          (f += '"ArrivalCode":"' + o + '",'),
          "[[_english_]]" === t && (f += '"ArrivalDate":"' + i + '",'),
          (f += '"Rooms":' + a + ","),
          (f += '"HotelCode":' + u + ","),
          (f +=
            "null" === s
              ? '"PromoCode":' + s + ',"IsPromoCodeValid":' + c + ","
              : '"PromoCode":"' + s + '","IsPromoCodeValid":' + c + ","),
          (f += '"TravellersNumber":' + l + "}"),
    ...
    (t.convertMonthToText = n),
      (t.getLanguageFilter = r),
      (t.getRepopulationLink = o);
  },
  function (e, t, n) {
    "use strict";
    function r(e) {
      var t = {},
        n = e.fluent.querySelector(".room-details"),
        r = e.fluent.querySelector(".room-details-content").done();
      if (!n.exists() || !r) return null;
      var i = o.getLanguageFilter(e);
      null !== i && "[[_english_]]" !== i && (i = "[[_nosend_]]");
      var a,
        u = {
          adults: e.fluent
            .getTextContent(".room-details-content .text-list li")
            .split(" ")
            .getAt(2)
            .toInt()
            .done(),
        ...
        s = e.fluent.querySelector(
          ".room-details-main-image .gallery-preview-container img"
        );
      s.exists() && (a = s.getAttribute("src").done());
      var c = e.fluent
        .getTextContent(".room-details-content .booking-new-price")
        .done();
      t.costs = { subtotal: c, total: c };
      var l,
        f,
        d = e.fluent
          .querySelector(".offer-rating")
          .getAttribute("data-star-score")
          .done(),
        p = e.fluent.getTextContent(".text-list li").done();
      window &&
        window.model &&
        window.model.Hotel &&
        Array.isArray(window.model.Hotel.RoomProfiles) &&
        window.model.Hotel.RoomProfiles[0] &&
        Array.isArray(window.model.Hotel.RoomProfiles[0].Rooms) &&
        window.model.Hotel.RoomProfiles[0].Rooms[0].Description &&
        ((l = window.model.Hotel.RoomProfiles[0].Rooms.length),
        (f = window.model.Hotel.RoomProfiles[0].Rooms[0].Description));
      var h = e.fluent
          .getTextContent("table[data-flight=inbound] tr")
          .split(" ")
          .getAt(5)
          .done(),
        m = e.fluent
          .getTextContent("table[data-flight=outbound] tr")
          .split(" ")
          .getAt(5)
          .done(),
        v = "",
        g = "",
        y = e.fluent.querySelector(".room-title-container h1");
      if (y.exists()) {
        var w = y.textContent().split(" ").done();
        (g = y.textContent().done()), w && "" !== g && (v = g + "-" + c);
      }
      var S = e.fluent.querySelector(".tripadvisor-rating"),
        b = "",
        I = "";
      S.exists() &&
        ((b = S.querySelector("img").getAttribute("src").done() || ""),
        (I =
          S.getTextContent(".tridavisor-comments").replace(/\D+/g, "").done() ||
          ""));
      var E, C;
      return (
        (t.items = n
          .querySelectorAll(".room-details-content .flight-item.hidden-sm")
          .map(function (t, n) {
            var r,
              s = t.getTextContent(".start-date").done(),
              f = "",
              d = "";
            null !== s &&
              s.indexOf("/") > -1 &&
              ((f = s.split("/")[0]),
              (d = s.split("/")[1]),
              (r = o.convertMonthToText(e, d)));
            var h = t.getTextContent("table td").split("    "),
              m = t.getTextContent("table tr:nth-child(2) td").split("    "),
              y = "",
              w = "",
              S = "";
            h.length() >= 2 &&
              ((y = h.getAt(1).done() || ""),
              (w = h.getAt(1).split(/[()]/).getAt(1).done()),
              (S = "" !== y ? h.getAt(1).split(" ").getAt(0).done() : ""));
            var b = "",
              I = "",
              T = "";
            m.length() >= 2 &&
              ((b = m.getAt(1).done() || ""),
              (I = m.getAt(1).split(/[()]/).getAt(1).done()),
              (T = "" !== b ? m.getAt(1).split(" ").getAt(0).done() : ""));
            var _ = y + " - " + b,
              A = t.getTextContent(".flight-item-departure-time").done(),
              O = t.getTextContent(".flight-item-arrival-time").done(),
              k = "";
            if (
              ((k = 0 === n ? "Outbound" : "Inbound"),
              window && window.model && window.model.SearchConditions)
            ) {
              var M = void 0;
              window.model.SearchConditions.ArrivalCode &&
                (M = window.model.SearchConditions.ArrivalCode);
              var x = void 0;
              window.model.SearchConditions.ArrivalDate &&
                (x = window.model.SearchConditions.ArrivalDate);
              var P = void 0;
              window.model.SearchConditions.DepartureCode &&
                (P = window.model.SearchConditions.DepartureCode);
              var R = void 0;
              window.model.SearchConditions.DepartureDate &&
                (R = window.model.SearchConditions.DepartureDate);
              var j = void 0;
              j =
                null === window.model.SearchConditions.HotelCode
                  ? "null"
                  : window.model.SearchConditions.HotelCode;
              var N = void 0;
              N =
                window.model.SearchConditions.IsPromoCodeValid === !1
                  ? "false"
                  : "true";
              var L = void 0;
              null === window.model.SearchConditions.PromoCode
                ? ((L = "null"), (C = ""))
                : ((L = window.model.SearchConditions.PromoCode),
                  (C = window.model.SearchConditions.PromoCode));
              var U = void 0;
              window.model.SearchConditions.Rooms &&
                (U = JSON.stringify(window.model.SearchConditions.Rooms));
              var V = void 0;
              window.model.SearchConditions.TravellersNumber &&
                (V = window.model.SearchConditions.TravellersNumber),
                0 === n &&
                  (E = o.getRepopulationLink(e, i, R, P, M, x, U, j, L, N, V));
            }
            return {
              product: {
                accommodation: {
                ...
                journey: [
                  {
                    direction: k,
                    passengers: { adults: u.adults },
                    start: {
                      when: { date: s, time: A },
                      where: { label: w, value: S },
                    },
                    end: {
                      when: { date: "", time: O },
                      where: { label: I, value: T },
                    },
                    type: "flight",
                  },
                ],
...
/*
page: http://www.wizztours.com/
url: https://d16fk4ms6rqz1v.cloudfront.net/capture/wizztours.js
*/
