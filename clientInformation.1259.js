(function () {
  ...
  try {
    positions["-907024256"] = [
      ...
      "div.TEMPLATE_5 > div.banners > div.row > div:nth-of-type(1)",
    ];
    positions["-1644966624"] = positions["-907024256"];
    positions["2116464192"] = [
      "a.iconnav-fanshop",
      "div#ajax-actueel_fix-pos-1",
      "div#ajax-actueel_fix-pos-2",
      "div#ajax-actueel_fix-pos-3",
      "div#ajax-actueel_fix-pos-4",
      "div#ajax-actueel_fix-pos-5",
      "div#de-toekomst_fix-pos-1",
      "div#de-toekomst_fix-pos-2",
      "div#de-toekomst_fix-pos-3",
      "div#de-toekomst_fix-pos-4",
      "div#de-toekomst_fix-pos-5",
      "div#future-cup_fix-pos-1",
      "div#future-cup_fix-pos-2",
      "div#future-cup_fix-pos-3",
      "div#future-cup_fix-pos-4",
      "div#future-cup_fix-pos-5",
      "div.articleBannerPosition1",
      "div.fix-pos-1",
      "div.fix-pos-2",
      "div.fix-pos-3",
      "div.fix-pos-4",
    ...
    positions["-1979920128"] = positions["2116464192"];
    positions["-652732864"] = positions["2116464192"];
    positions["765366272"] = positions["2116464192"];
    positions["167365344"] = positions["2116464192"];
    positions["502630976"] = positions["2116464192"];
    positions["906275168"] = positions["2116464192"];
    positions["-985074336"] = positions["2116464192"];
    positions["-1319166624"] = positions["2116464192"];
    positions["874983648"] = positions["2116464192"];
    positions["537484384"] = positions["2116464192"];
    positions["173958208"] = positions["2116464192"];
    positions["-65658400"] = positions["2116464192"];
    positions["-305275008"] = positions["2116464192"];
    positions["549473280"] = [
      "a.iconnav-fanshop",
      "div#ajax-actueel_fix-pos-1",
      "div#ajax-actueel_fix-pos-2",
      ...
      "div.fix-pos-3",
      "div.fix-pos-4",
      "div.ng-scope > div:nth-of-type(2) > p:nth-of-type(1)",
    ];
    positions["-710470336"] = [
      "addSCC",
      "confirmSeats",
      "div#wrapper div#main div#content p:last",
      "orderoverview",
    ];
    positions["-1623738208"] = positions["-710470336"];
    positions["344048128"] = positions["-710470336"];
    positions["31376352"] = positions["-710470336"];
    positions["-281295424"] = positions["-710470336"];
    positions["-831289856"] = positions["-710470336"];
    positions["337829920"] = positions["-710470336"];
    positions["1506949696"] = positions["-710470336"];
    positions["-1618897824"] = positions["-710470336"];
    positions["-449778048"] = positions["-710470336"];
    positions["766079136"] = [
      "div.TEMPLATE_1 > div.row > div.col-md-5 > div:nth-of-type(1)",
    ];
    positions["-349490368"] = [
      "div.fix-pos-1",
      "div.fix-pos-2",
    ...
    positions["-1064474464"] = positions["-349490368"];
    positions["735210080"] = positions["-349490368"];
    positions["-1540287424"] = positions["-349490368"];
    positions["372501728"] = positions["-349490368"];
    positions["-707021600"] = positions["-349490368"];
    positions["-751766592"] = positions["-349490368"];
    positions["25193056"] = positions["-349490368"];
    positions["584899936"] = positions["-349490368"];
    positions["551239552"] = positions["-349490368"];
    positions["-1896628096"] = positions["-349490368"];
    positions["-1195265024"] = positions["-349490368"];
    positions["-2104234496"] = positions["-349490368"];
    positions["782531200"] = positions["-349490368"];
    positions["349622368"] = positions["-349490368"];
    positions["-714723552"] = positions["-349490368"];
    positions["1349455584"] = positions["-349490368"];
    positions["-935806112"] = positions["-349490368"];
    positions["-1403276864"] = positions["-349490368"];
    positions["-1662130368"] = ["fix-pos-1", "fix-pos-2", "fix-pos-3"];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://ajax.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.ajax.nl/
url: http://ajax.blueconic.net/frontend/static/javascript/blueconic/blueconic.min.js
*/
