(function () {
  ...
  try {
    positions["214924480"] = [
      "#mini-panel-on_newsstands > div > div > div > div > div > div > div.view-content > div > div.views-field.views-field-php > span > h3",
    ];
    positions["-905569056"] = positions["214924480"];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://robbreport.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.robbreport.com/
url: http://cdn.blueconic.net/robbreport.js
*/
