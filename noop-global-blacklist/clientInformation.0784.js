(function () {
  ...
  try {
    positions["-957907104"] = [
      "#eca-telnr",
      "#header > div > div > nav > div:nth-child(3) > img",
      "#loyalty-wrapper",
      "button#btnPopUp",
      "div#data",
      "div.container-canvas.custombanner",
    ];
    positions["-511043552"] = ["#overzichtBlueConicView"];
    positions["-704265952"] = positions["-511043552"];
    positions["201988224"] = positions["-511043552"];
    positions["-480323904"] = positions["-511043552"];
    positions["-2097160480"] = [
      "#ro1co2ce1",
      "#ro3 span.hide-parent-row",
      "div#ro13 > div",
      "div#ro1co1ce1",
      "div#ro1co2ce1.teaser-box.cell",
      "div#ro1co2ce2.teaser-box.cell",
      "div#ro1co2ce3.teaser-box.cell",
      "div#ro2co1ce1.cell",
      "div#ro3co1",
      "div#ro3co1ce1.cell",
      "div#ro3co2",
      "div#ro4co1ce1 > div.media-object",
      "div.block-call-me-back",
      "div.campagne",
      "div.container.gutters.popular-phones",
      "div.grid-content",
      "div.offcanvas-main-panel > header",
      "div.offcanvas-main-panel > header > a:nth-of-type(2)",
      "div.page-visual",
      "div:nth-of-type(4) > div.row > div:nth-of-type(1)",
      "div:nth-of-type(4) > div.row > div:nth-of-type(2)",
      "div:nth-of-type(4) > div.row > div:nth-of-type(3)",
      "ul.list-block > li:nth-of-type(3) > a.link-call-to-action",
    ];
    positions["1246141184"] = positions["-2097160480"];
    positions["-1374689760"] = positions["-2097160480"];
    positions["2074672000"] = positions["-2097160480"];
    positions["-26691488"] = [
      "div#block-bean-ben-jouw-slimste-keus",
      "div#block-bean-mijn-beste-deal",
      "div#panels-tmobile-content-layout",
      "div.field__item > div > p:nth-of-type(2)",
      "div.l-highlighted",
      "div.l-highlighted > div.container > div.l-region",
      "div.pane-2 > p:nth-of-type(5)",
      "div.pane-faq-blocks-panel-pane-1",
      "div.pane-tmobile-blocks-customer-waiting-time",
      "div.pane-tmobile-blocks-homepage-advantage > h2.pane-title",
      "div.pane-tmobile-blocks-homepage-advantage > ul",
      "div.pane-tmobile-blocks-return-policy > a > img",
      "div.pane-views",
      "div.pane-views > h2.pane-title",
      "div.panel-panel",
      "div.panels-generic-content-top-wrapper",
      "div.views-row-1",
      "div.views-row-2",
      "fieldset#edit-commerce-fieldgroup-pane-group-personal-details > div.fieldset-wrapper",
      "nav#block-system-main-menu",
    ];
    positions["-714058112"] = positions["-26691488"];
    positions["370049696"] = [
      "div.campagne",
      "div:nth-of-type(1) > div.teaser-box",
      "div:nth-of-type(2) > div.teaser-box",
      "div:nth-of-type(3) > div.teaser-box",
    ];
    positions["-1633773312"] = [
      "div.container-canvas > nav > div:nth-of-type(3) > a.btn",
    ];
    positions["-1831164992"] = ["div.custombanner"];
    positions["-1823020032"] = positions["-1831164992"];
  } catch (err) {}
  (function (a) {
    ...
    /* Next pre listener */
    //
    // tmobile_global_listener
    //
    (function () {
      var InteractionTypeImpl = InteractionType.extend({
        PARAMETER_DII_1: "dii_1",
        PARAMETER_DII_2: "dii_2",
        PARAMETER_DII_3: "dii_3",
        PROPERTY_DII_1: "merkvoorkeur_dii",
        PROPERTY_DII_2: "abonnementsvoorkeur_dii",
        PROPERTY_DII_3: "databundelvoorkeur_dii",
        valueMap_dii_1: [],
        valueMap_dii_2: [],
        valueMap_dii_3: [],
        init: function (d, c) {
          this.blueConicClient = d;
          this.context = c ? c : null;
          this.profile = d.profile.getProfile();
          this.valueMap_dii_1.AP = "apple";
          this.valueMap_dii_1.SA = "samsung";
          this.valueMap_dii_1.HU = "huawei";
          this.valueMap_dii_1.SO = "sony";
          this.valueMap_dii_2.SO = "sim only";
          this.valueMap_dii_2.RE = "met telefoon";
          this.valueMap_dii_3["3"] = "3 gb";
          this.valueMap_dii_3["6"] = "6 gb";
          this.valueMap_dii_3["20"] = "20 gb";
        },
        onPrepare: function () {
          var e = this._getUrlParameter(this.PARAMETER_DII_1),
            d = this._getUrlParameter(this.PARAMETER_DII_2),
            f = this._getUrlParameter(this.PARAMETER_DII_3);
          this._setProfileValue(this.PROPERTY_DII_1, e, this.valueMap_dii_1);
          this._setProfileValue(this.PROPERTY_DII_2, d, this.valueMap_dii_2);
          this._setProfileValue(this.PROPERTY_DII_3, f, this.valueMap_dii_3);
        },
        _setProfileValue: function (h, g, e) {
          if (g !== undefined) {
            var f = e[g];
            if (f !== undefined) {
              this.profile.setValue(h, f);
            }
          }
        },
        _getUrlParameter: function (h) {
          var i = decodeURIComponent(window.location.search.substring(1)),
            f = i.split("&"),
            g,
            j;
      ...
      // Register listener 'tmobile_global_listener':
      window.blueConicPreListeners.push({
        id: "tmobile_global_listener",
        interactionType: InteractionTypeImpl,
      });
    })(); // end of interaction type + register interaction type
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://tmobile.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.ben.nl/
url: https://cdn.blueconic.net/tmobile.js
*/
