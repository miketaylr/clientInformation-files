(function () {
  ...
  try {
    positions["842058368"] = [
      "#Article\\2e tile\\2e 4",
      "#ad\\2e rightcolumn\\2e 1",
      "#div_personalization_magazine",
      "#div_personalization_networking",
      "#div_personalization_partners",
      "#div_personalization_programs",
      "div#spotlight > div.container-fluid",
      "div.container-fluid > div:nth-of-type(1) > div.tile",
      "div.container-fluid > div:nth-of-type(2) > div.tile",
    ];
    positions["-1185197280"] = ["#bcfblogin", "#logo-1", "div.grey-bg"];
    positions["490992960"] = positions["-1185197280"];
    positions["-745380544"] = [
      "#div_aboutusmore_zone1",
      "#div_aboutusmore_zone2",
      "#div_aboutusmore_zone3",
      "#div_aboutusmore_zone4",
      "#div_appthankyou_zone1",
      "#div_appthankyou_zone2",
      "#div_appthankyou_zone3",
      "#div_appthankyou_zone4",
      "#div_mentorprofile_zone1",
      "#div_mentorprofile_zone2",
      "#div_mentorprofile_zone3",
      "#div_mentorprofile_zone4",
      "#div_personalization_mag1",
      "#div_personalization_mag2",
      "#div_personalization_mag3",
      "#div_personalization_mag4",
      "#div_personalization_magazine",
      "#div_personalization_networking",
      "#div_personalization_partners",
      "#div_personalization_programs",
      "#div_regthankyou_zone1",
      "#div_regthankyou_zone2",
      "#div_regthankyou_zone3",
      "#div_regthankyou_zone4",
      "#div_rfithankyou_zone1",
      "#div_rfithankyou_zone2",
      "#div_rfithankyou_zone3",
      "#div_rfithankyou_zone4",
    ];
    positions["606344320"] = ["div#content > p:nth-of-type(1)", "div.rh__hero"];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://laureate.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.university-liverpool-online.com/
url: https://cdn.blueconic.net/laureate.js
*/
