(function () {
  ...
  var positions = {};
  try {
    positions["-1821239168"] = [
      "#footer",
      "div.col-xs-12 > h1",
      "div.col-xs-12 > h2",
      "div.signup-benefits",
      "div.signup-head > div.col-xs-12",
    ];
    positions["-1492505568"] = positions["-1821239168"];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://factor75.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.factor75.com/
url: https://cdn.blueconic.net/factor75.js
*/
