(function () {
  var domainGroups = {};
  try {
    domainGroups["b80e6861-6c38-4581-a42b-df285c205457"] = [
      "-1015772256",
      "-1022619456",
      "-1110295200",
      "-1122128608",
    ...
    domainGroups["d6f076de-aeea-4398-accd-4a8e5920d8e0"] = [
      "-1628959776",
      "938609696",
    ];
  } catch (err) {}
  var positions = {};
  try {
    positions["-1030397568"] = [
      "#main",
      "#main > footer",
      ".bc-form",
      ".contactinfo.with-heading",
      ".layout-subhome-study #main>aside",
      ".uniForm ",
      "aside",
      "aside .WUREditableContent",
      "div.WUREditableContent > figure > img",
      "div.body",
      "div.body > h2",
      "div.buttons",
      "div.contactinfo",
      "div.content.bottom div.WUREditableContent div.collection.inverted-background",
      "div.countdown-bar",
      "div.main > header > h1",
      "div.page > header",
      "header.title",
      "li.show > div.slide > div.caption > a > h3",
      "nav.site-wide",
      "section.list > ul.links > li:nth-of-type(1) > a.normal",
    ];
    positions["1358238528"] = positions["-1030397568"];
    positions["1102712512"] = positions["-1030397568"];
    positions["246683104"] = positions["-1030397568"];
    positions["-205149664"] = positions["-1030397568"];
    positions["564927072"] = positions["-1030397568"];
    positions["2134764192"] = positions["-1030397568"];
    positions["1928699360"] = positions["-1030397568"];
    positions["-656154208"] = positions["-1030397568"];
    positions["-1738441024"] = positions["-1030397568"];
    positions["2124533504"] = positions["-1030397568"];
    positions["-719047648"] = positions["-1030397568"];
    positions["-1997845856"] = positions["-1030397568"];
    positions["-1905575200"] = positions["-1030397568"];
    positions["1054187072"] = positions["-1030397568"];
    positions["-1274424000"] = positions["-1030397568"];
    positions["482693632"] = positions["-1030397568"];
    positions["1938147168"] = positions["-1030397568"];
    positions["1966989440"] = positions["-1030397568"];
    positions["58103360"] = positions["-1030397568"];
    positions["-1083422016"] = positions["-1030397568"];
    positions["-2021701184"] = positions["-1030397568"];
    positions["710340800"] = positions["-1030397568"];
    positions["-41678944"] = positions["-1030397568"];
    positions["1960960832"] = positions["-1030397568"];
    positions["766552224"] = positions["-1030397568"];
    positions["932378272"] = positions["-1030397568"];
    positions["695448480"] = positions["-1030397568"];
    positions["1775222432"] = positions["-1030397568"];
    positions["-1029946272"] = positions["-1030397568"];
    positions["1805891808"] = positions["-1030397568"];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://wageningenur.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.wageningenur.nl/
url: http://wageningenur.blueconic.net/frontend/static/javascript/blueconic/blueconic.min.js
*/
