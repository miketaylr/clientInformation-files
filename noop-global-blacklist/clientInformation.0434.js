(function () {
  ...
  try {
    positions["948213312"] = [
      ...
      ".wrapper",
      "a.add",
      "div#stel_zelf_de_uitvaartverzekering_samen_repeat_repeat0 > div:nth-of-type(3) > div:nth-of-type(3)",
      "div.block-assembler-totals > button.icon",
      "div.block-frameless > a.icon",
      "div.funnel.funnel-buttons",
      "div.header--button",
      "div.header--info",
      "div.header-img",
      "li:nth-of-type(11) > div.faq__answer > p:nth-of-type(2)",
    ];
    positions["2087136608"] = positions["948213312"];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://yarden.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.yarden.nl/
url: https://yarden.blueconic.net/frontend/static/javascript/blueconic/blueconic.min.js
*/
