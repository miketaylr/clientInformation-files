(function () {
  ...
  try {
    positions["90780096"] = [
      "#social-share",
      "div#columns > aside > section:nth-of-type(1)",
      "div#columns > aside > section:nth-of-type(2)",
      "div.block-content > form > fieldset > ol",
      "div.block-content > p:nth-of-type(5)",
      "div.clear",
      "div.colpos-normal > section:nth-of-type(1) > div.block-content",
      "div:nth-of-type(5) > div.pagination",
      "input[name='search[s]']",
      "section#carousel-home",
      "section:nth-of-type(1) > section.block",
      "section:nth-of-type(2) > div.tx-troshighlight-pi1 > section.block > h3.block-header",
      "section:nth-of-type(3)",
      "ul#menumain > li:nth-of-type(2)",
      "ul.newsletter",
      "ul.populair",
      "ul.sitemap:nth-child(3) > li:nth-child(1)",
    ];
    positions["1985394048"] = positions["90780096"];
    positions["1263566592"] = positions["90780096"];
    positions["-1064147776"] = positions["90780096"];
    positions["1402758688"] = positions["90780096"];
    positions["1990875232"] = positions["90780096"];
    positions["-1525974496"] = [".content-tertiary", "div.join-now"];
    positions["-597734912"] = [
      "article#musicalMail > div",
      "article#tcm17_333203 > a.boxlink",
      "article#tcm17_334820 > a.boxlink",
      "article#tcm17_335195 > a.boxlink",
      "div.grid-2-3.box.spotlight",
      "fieldset#stap0 > legend",
      "section#ident",
    ...
    positions["388205056"] = positions["-597734912"];
    positions["1081336544"] = positions["-597734912"];
    positions["1774468032"] = positions["-597734912"];
    positions["1681318272"] = [
      "article.page > header > h1",
      "div.grid-small-12 > div.text > p.block-text",
      "div.text > div > p.block-text",
      "li#powermail_fieldwrap_1533",
    ];
    positions["-2061285664"] = positions["1681318272"];
    positions["1106018208"] = [
      "div.cLeft > div.block",
      "div.news-single-item",
      "div.s-100",
      "p:nth-of-type(32)",
    ];
    positions["1718727328"] = positions["1106018208"];
    positions["1742685536"] = [
      "div.content > section.teasers",
      "div.newsletter-widget-footer",
      "div.small:nth-child(1) > div:nth-child(1)",
      "div.top-bar > div.row",
      "div:nth-of-type(3) > aside > div:nth-of-type(1)",
      "div:nth-of-type(3) > aside > div:nth-of-type(2)",
      "div:nth-of-type(3) > dl:nth-of-type(1) > dd:nth-of-type(2) > a",
      "div:nth-of-type(5) > aside > div:nth-of-type(2)",
      "form[name='field']",
      "section.tags > h1.small-heading",
      "ul.meta",
    ];
    positions["-989158656"] = positions["1742685536"];
    positions["387428544"] = ["form#onestepcheckout-form"];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://avrotros.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.avrotros.nl/
url: http://cdn.blueconic.net/avrotros.js
*/
