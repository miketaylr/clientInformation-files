(function () {
  ...
  var positions = {};
  try {
    positions["-634220032"] = ["aside.right-content", "div.sidebar"];
    positions["-1234189728"] = positions["-634220032"];
    positions["-75873440"] = [
      "div:nth-of-type(2) > div.daily-homepage-content > section.daily-container > section.daily-header-container > h2.daily-header-container__subtitle",
    ];
    positions["-596698880"] = positions["-75873440"];
  } catch (err) {}
  (function (a) {
    ...
    (function () {
      var InteractionTypeImpl = InteractionType.extend({
        ...
        onPrepare: function () {
          var a = this._getParameterByName("e"),
            b = this._getParameterByName("sk");
          a && b && this.profile.addValue("email", a);
        },
        _getParameterByName: function (a) {
          a = a.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
          a = new RegExp("[\\?&]" + a + "=([^&#]*)").exec(window.location);
          return null === a ? "" : decodeURIComponent(a[1].replace(/\+/g, " "));
        },
      });
      // end of interaction type

      // Register listener 'atkprelistener':
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://atk.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.onlinecookingschool.com/
url: https://cdn.blueconic.net/atk.js
*/
