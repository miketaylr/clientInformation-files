(function () {
  ...
  var positions = {};
  try {
    positions["1813164160"] = [
      "div.col-sm-8 > h2.widget-title",
      "div.col-sm-8 > p:nth-of-type(2)",
      "div.col-sm-8 > p:nth-of-type(3)",
      "div.col-sm-8 > p:nth-of-type(4)",
      "div.col-sm-8 > p:nth-of-type(8)",
      "div.image > strong",
      "div.related-links",
      "ul.side-nav > ul",
    ];
    positions["-1937795616"] = positions["1813164160"];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://udayton.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.udayton.edu/
url: https://cdn.blueconic.net/udayton.js
*/
