!(function (e) {
  ...
  function (e, t, n) {
    ...
    (t.init = function (e, t, n, r) {
      ...
      var o = s.getScrapeFunctions(r),
        ...
        v = c.init(o.subStates, a.subStates, n),
  ...
  function (e, t, n) {
    ...
    var r = n(63),
      ...
      u = {
        email: [
          "input[type=email]",
          "input[name=dwfrm_newsletter_email]",
          "#dwfrm_profile_customer_email",
          "#form_signin input[type=email]",
          "#form_emailonly input[type=email]",
          "#dwfrm_login_username_d0jwutjjzpxe",
          "#dwfrm_login_emailAddress_d0gqunknyari",
        ],
        firstName: [
        ...
        phone: {
          landline: ["#dwfrm_profile_customer_phone"],
          mobile: ["#dwfrm_singleshipping_shippingAddress_addressFields_phone"],
        },
        salutation: ["input[name=dwfrm_profile_customer_sex]"],
      },
      a = (function () {
        function e(e) {
          this.api = e;
        ...
        return (
          (e.prototype.client = function () {
            return {
              apiKey: "1BE88EF3-27BF-4242-B0D9-AFA375DA59E9",
              v1Id: 19300,
            };
          }),
          (e.prototype.isPurchaseComplete = function () {
            var e = this.api;
            return e.fluent.request.url().includes("/cocheckout-show/", !0);
          }),
          (e.prototype.scrapers = function () {
            ...
            return {
              ...
              order: function () {
                return {
                  id: e.fluent
                    .querySelector("div.order_number span.value")
                    .value()
                    .done(),
                };
              },
          ...
          (e.prototype.triggers = function () {
            ...
            return (
              ...
              { events: { change: e }, watch: [{ selector: ".topbar" }] }
            );
          }),
          e
        );
  ...
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("#cart_table");
      if (!t.exists()) return null;
      var n = {};
      n.items = t
        .querySelectorAll(".cart_row")
        .map(function (e) {
          var t = "",
            n = "",
            r = e
              .getTextContent(
                "td.item_details div.product_list_item div.product_name a"
              )
              .done(),
            o =
              e
                .querySelector("td.item_image img")
                .getAttribute("src")
                .between("", "?")
                .done() || "",
            i =
            ...
            u = e
              .getTextContent(
                "td.item_details div.product_list_item div.product_id span.product_id_value"
              )
              .done(),
            a = "",
            s = e
              .querySelector("td.item_quantity span.selectboxit-text")
              .value()
              .toInt()
              .done();
          return (
            (n =
              e
                .querySelector(
                  "td.item_details div.product_list_item div.attribute_color span.value"
                )
                .textContent()
                .done() || ""),
            (t =
              e
                .querySelector(
                  "td.item_details div.product_list_item div.attribute_size span.value"
                )
                .textContent()
                .done() || ""),
            (a = e
              .querySelector("td.item_price div.total span.price_total")
              .exists()
              ? e
                  .querySelector("td.item_price div.total span.price_total")
                  .textContent()
                  .done()
              : e
                  .querySelector("td.item_price span.single_product_price")
                  .textContent()
                  .done()),
            {
              product: {
        ...
        .done();
      var r = e.fluent.querySelector("div.cart_order_totals"),
        o = r
          .querySelector(
            "div.order_totals_block table tbody tr.order_subtotal td:last-child"
          )
          .value()
          .done(),
        i = r
          .getTextContent(
            "div.order_totals_block table tbody tr.order_shipping_discount td:last-child"
          )
          .done(),
        u = r
          .querySelector(
            "div.order_totals_block table tbody tr.order_total td:last-child"
          )
          .value()
          .done();
      return (
        (n.costs = { subtotal: o, total: u }), (n.shipping = { cost: i }), n
      );
    }
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = n);
  },
  function (e, t) {
    "use strict";
    function n(e) {
      var t = e.fluent.querySelector("#minicart");
      if (!t.exists()) return null;
      var n = {};
      n.items = t
        .querySelectorAll(".mini_cart_product")
        .map(function (e) {
          var t = "",
            n = "",
            r = e.getTextContent("div.mini_cart_name a").done(),
            o =
              e
                .querySelector("div.mini_cart_image img")
                .getAttribute("src")
                .between("", "?")
                .done() || "",
            i =
              e
                .querySelector("div.mini_cart_name a")
                .getAttribute("href")
                .done() || "",
            u = i.substr(i.lastIndexOf("/") + 1, i.lastIndexOf(".html")),
            a = "",
            s = "",
            c = e
              .querySelector("div.mini_cart_pricing span.mini_cart_price")
              .exists()
              ? e
                  .getTextContent("div.mini_cart_pricing span.mini_cart_price")
                  .done()
              : null,
            l = e
              .querySelector("div.mini_cart_pricing select.quantity_select")
              .value()
              .toInt()
              .done();
          if (
            ((t =
              e
                .querySelector(
                  "div.mini_cart_attributes div.attribute_color span.value"
                )
                .textContent()
                .done() || ""),
            (n =
              e
                .querySelector(
                  "div.mini_cart_attributes div.attribute_size span.value"
                )
                .textContent()
                .done() || ""),
            1 !== l && null !== c)
          ) {
            (a = c), (s = a.substr(a.indexOf("Â£") + 1, a.lastIndexOf("")));
            var f = "Â£",
              d = Number(s) / l;
            c = f.concat(d.toFixed(2).toString());
          }
          return {
            product: {
              color: { value: t },
        ...
        .done();
      var r = e.fluent
        .getTextContent("div.mini_cart_subtotals span.value")
        .done();
  ...
  function (e, t, n) {
    "use strict";
    function r(e) {
      var t = e.fluent.querySelector("#pdp_section_about");
      if (!t.exists()) return null;
      var n = "",
        r = !0,
        i = window.dataLayer,
        u = t
          .querySelector("div.pdp_top_content_wrapper .product_name")
          .textContent()
          .done(),
        a = t.querySelector("div.price p.product_price").textContent().done(),
        s = t
          .querySelector("div.product_primary_image #wrap img.primary_image")
          .getAttribute("src")
          .done(),
        c = e.fluent.request.url(),
        l = c.done();
      if (("N/A" === a && (r = !1), i)) {
        var f = o.getCorrectIndex(i, "ecommerce", "f");
        f > -1 &&
          null != i[f] &&
          null != i[f].ecommerce &&
          null != i[f].ecommerce.detail &&
          null != i[f].ecommerce.detail.products &&
          null != i[f].ecommerce.detail.products[0] &&
          null != i[f].ecommerce.detail.products[0].id &&
          (n = i[f].ecommerce.detail.products[0].id);
      }
      return {
        costs: { singleItem: a },
        id: n,
...
/*
page: http://www.yslbeauty.co.uk/
url: http://d16fk4ms6rqz1v.cloudfront.net/capture/ysl.js
*/
