...
eval(
  (function (p, a, c, k, e, d) {
    ...
    "7{8 1=2.6('a');1.4='3://5.9.h/1/g.1';2.f('e')[0].c(1)}d(i){}",
    19,
    19,
    "|js|document|http|src|images|createElement|try|var|ofweek|script|me|appendChild|catch|head|getElementsByTagName|ofw|com|r".split(
      "|"
    ),
    0,
    {}
...
window.jQuery_1_8_3 = window.jQuery_1_8_3 || jQuery.noConflict(true);
window.WJQ = window.WJQ || jQuery_1_8_3;
eval(
  (function (p, a, c, k, e, d) {
    e = function (c) {
      return (
    ...
    '!6(a){6 g(a,b){9 d,c=7.E||{};q(d u c)o(a.D(b?c[d]:d))5!0;5!1}6 h(){9 a,b;5 e||"F"!=G 7.I?"":(a="v"u k.r("v"),b=7.8&&7.8.n?C.H(7.8.n).s:0,g(/^l/i,0)?"l":g(/^j/i,0)?"j":7.m&&7.m.t&&7.m.t.s>2?"8":a?b>1?"w":"x":"")}6 i(){q(9 a=3,b=k.r("p"),c=b.J("i");b.B="/*[o A z "+ ++a+"]><i></i><![y]*/",c[0];);5 a>4?a:0}9 b=7.K,c=k.T,d=i()||c||0,e=b||c,f=h();a.P={Q:6(){5!!d}(),O:6(){5 d}(),N:6(){5"8"===f}(),L:6(){5"x"===f}(),M:6(){5"w"===f}(),R:6(){5"j"===f}(),U:6(){5"l"===f}(),W:6(){5"V"===f}()}}(S);',
    59,
    59,
    "|||||return|function|window|chrome|var||||||||||liebao|document|sogou|clientInformation|webstore|if||for|createElement|length|languages|in|track|360ee|360se|endif|IE|gt|innerHTML|Object|test|external|undefined|typeof|keys|scrollMaxX|getElementsByTagName|ActiveXObject|is360se|is360ee|isChrome|ieVersion|shell|isIE|isLiebao|WJQ|documentMode|isSogou|qq|isQQ".split(
      "|"
    ),
    0,
    {}
...
/*! jQuery Sticky 1.0 by Steven | 2014-10-23 */
!(function (a) {
  function k(b) {
    (this.options = b || {}),
      (this.elem = a(this.options.element)),
  ...
  function l(b, c, d) {
    return (
      a.isPlainObject(c) || (c = { top: c }),
      void 0 === c.top && void 0 === c.bottom && (c.top = 0),
      new k({ element: b, position: c, callback: d }).render()
    );
  }
  function m() {
    return !h;
  ...
  function n() {
    ...
    if (
      ((a = b[0].body),
      b[0].createElement && a && a.appendChild && a.removeChild)
    ) {
      for (
        e = b[0].createElement("div"),
          f = function (a) {
            return window.getComputedStyle
              ? window.getComputedStyle(e).getPropertyValue(a)
              : e.currentStyle.getAttribute(a);
          },
          a.appendChild(e),
          h = 0;
        h < d.length &&
        ((e.style.cssText = "position:" + d[h] + "sticky;visibility:hidden;"),
        !(c = -1 !== f("position").indexOf("sticky")));
        h++
      ) {}
      return e.parentNode.removeChild(e), c;
    }
  }
  function o() {
    return (
  ...
  var b = a(document),
    ...
    g = -1 !== f.indexOf("msie"),
    h = -1 !== f.indexOf("msie 6"),
    i = n(),
    j = m();
  (k.prototype._prepare = function () {
    var b,
      a = this.elem.offset();
    (this._originTop = a.top),
      (this._originLeft = a.left),
      this.position.top === Number.MAX_VALUE &&
        ((this._callFix = !0), (this.position.top = this._originTop)),
      (this._originStyles = {
        position: null,
        top: null,
        bottom: null,
    ...
    for (b in this._originStyles) {
      this._originStyles.hasOwnProperty(b) &&
        (this._originStyles[b] = this.elem.css(b));
    }
  }),
    (k.prototype.render = function () {
      ...
      if (
        ...
        (this.adjust = function () {
          b._restore();
          var a = b.elem.offset();
          (b._originTop = a.top), (b._originLeft = a.left), e.call(b);
        }),
        l.isPositionStickySupported && !this._callFix)
      ) {
        for (e = this._supportSticky, f = "", g = 0; g < d.length; g++) {
          f += "position:" + d[g] + "sticky;";
        }
        void 0 !== this.position.top &&
          (f += "top: " + this.position.top + "px;"),
          void 0 !== this.position.bottom &&
            (f += "bottom: " + this.position.bottom + "px;"),
          (this.elem[0].style.cssText += f),
          (this.adjust = function () {
            e.call(b);
          });
      } else {
        l.isPositionFixedSupported
          ? (e = this._supportFixed)
          : ((e = this._supportAbsolute),
            a(
              '<style type="text/css">* html{background:url(null) no-repeat fixed;}</style>'
            ).appendTo("head"));
      }
      return (
        e.call(this),
        c.on("scroll.sticky" + this._stickyId, function () {
          b.elem.is(":visible") && e.call(b);
        }),
        c.on(
          "resize.sticky" + this._stickyId,
          p(function () {
            b.adjust();
          }, 120)
        ),
    ...
    (k.prototype._getTopBottom = function (a, b) {
      var d, e;
      return (
        void 0 !== this.position.top && (d = b - a <= this.position.top),
        void 0 !== this.position.bottom &&
          (e =
            a + c.height() - b - this.elem.outerHeight() <=
            this.position.bottom),
        { top: d, bottom: e }
      );
    }),
    (k.prototype._supportFixed = function () {
      var c = this.elem.data("sticked"),
        d = this._getTopBottom(b.scrollTop(), this._originTop);
      !c && ((void 0 !== d.top && d.top) || (void 0 !== d.bottom && d.bottom))
        ? (this._addPlaceholder(),
          this.elem.css(
            a.extend(
              { position: "fixed", left: this._originLeft },
              d.top
        ...
        : !c || d.top || d.bottom || this._restore();
    }),
    (k.prototype._supportAbsolute = function () {
      var a = b.scrollTop(),
        d = this.elem.data("sticked"),
        e = this._getTopBottom(a, this.elem.offset().top);
      e.top || e.bottom || this._callFix
        ? (d ||
            (this._addPlaceholder(),
            this.elem.data("sticked", !0),
            this.callback.call(this, !0)),
          this.elem.css({
            ...
            top: this._callFix
              ...
              : e.top
              ? this.position.top + a
              : a + c.height() - this.position.bottom - this.elem.outerHeight(),
          }))
        : !d || e.top || e.bottom || this._restore();
    }),
    (k.prototype._supportSticky = function () {
      var a = this.elem.data("sticked"),
        c = this._getTopBottom(b.scrollTop(), this.elem.offset().top);
      !a && ((void 0 !== c.top && c.top) || (void 0 !== c.bottom && c.bottom))
        ? (this.elem.data("sticked", !0), this.callback.call(this, !0))
        : !a ||
          c.top ||
          c.bottom ||
          (this.elem.data("sticked", !1), this.callback.call(this, !1));
    }),
    (k.prototype._restore = function () {
      this._removePlaceholder(),
        this.elem.css(this._originStyles),
        this.elem.data("sticked", !1),
        this.callback.call(this, !1);
    }),
    (k.prototype._addPlaceholder = function () {
      var b = !1,
        c = this.elem.css("position");
      ("static" === c || "relative" === c) && (b = !0),
        "block" !== this.elem.css("display") && (b = !1),
        b &&
          ((this._placeholder = a(
            '<div style="visibility:hidden;margin:0;padding:0;"></div>'
          )),
          this._placeholder
            .width(this.elem.outerWidth(!0))
            .height(this.elem.outerHeight(!0))
            .css("float", this.elem.css("float"))
            .insertAfter(this.elem));
    }),
    (k.prototype._removePlaceholder = function () {
      this._placeholder && this._placeholder.remove();
    }),
    (k.prototype.destroy = function () {
      this._restore(),
        this.elem.data("bind-sticked", !1),
        c.off("scroll.sticky" + this._stickyId),
        c.off("resize.sticky" + this._stickyId);
    }),
    (l.stick = l),
    (l.fix = function (a) {
      return new k({
        element: a,
        position: { top: Number.MAX_VALUE },
      }).render();
    }),
    (l.isPositionStickySupported = i),
    (l.isPositionFixedSupported = j),
    (a.sticky = l);
})(WJQ);
...
(function ($) {
  ...
  $(function () {
    var $body = $("body");
    $("html[id]").length || $("html").attr("id", "steven");
    $(".w-menu").hover(
      function () {
        var $ths = $(this),
          $menu_text = $ths.find(".w-menu-text"),
          pos = $menu_text.position(),
          pos_left = pos.left,
          pos_top = pos.top + $menu_text.height(),
          $submenu = $ths.find(".w-menu-submenu");
        if ($submenu.find("a").length > 12) {
          $submenu.addClass("two-cols");
        }
        $submenu.css({ top: pos_top, left: pos_left, display: "block" });
        if (isIE6) {
      ...
      function () {
        var $ths = $(this);
        $ths.find(".w-menu-submenu").hide();
        if (isIE6) {
          $("select").css("visibility", "visible");
        }
      }
    );
    var tips_success_timer;
    $("#retrieve-password form").submit(function () {
      var $ths = $(this),
        url = $ths.attr("action"),
        datas = $ths.serialize(),
        $tips_error = $ths.find(".w-tips-error"),
        $tips_success = $ths.find(".w-tips-success"),
        $email = $("#email"),
        $code = $("#code");
      if ($email.val() === "") {
        $tips_error
      ...
      $.post(url, datas, function (d) {
        if (d === 1) {
          $tips_error
            .text("æ±æ­ï¼ä½¿ç¨æ­¤Emailçä¼åä¸å­å¨,ä¸è½ä½¿ç¨ååå¯ç åè½")
            .show()
            .delay(1500)
            .fadeOut("slow");
        } else {
          if (d === 2) {
            $tips_error
              .text(
                "æ±æ­ï¼æ¨å¡«åçè´¦æ·èµæä¸å¹éï¼ä¸è½ä½¿ç¨ååå¯ç åè½ï¼å¦æçé®è¯·ä¸ç®¡çåèç³»"
              )
              .show()
              .delay(1500)
              .fadeOut("slow");
            ...
            $tips_success.show();
            tips_success_timer = setTimeout(function () {
              window.location = "http://www.ofweek.com/";
            }, 2000);
          }
        }
      });
    ...
    $("#retrieve-password").on("click", ".w-tips-closer", function () {
      $(this).parent().hide();
      clearTimeout(tips_success_timer);
    });
    if (isIE6) {
      $("#g-topbar")
        .find(".g-topbar-dropmenu")
        .hover(
          function () {
            $(this).addClass("g-topbar-drop");
          },
          function () {
            $(this).removeClass("g-topbar-drop");
          }
        );
  ...
  $(function () {
    ...
    $(".G-catsm1").on("click", ".x-icon", function (e) {
      $(e.delegateTarget)
        .find(".x-icon")
        .toggleClass("x-icon-unfold")
        .next(".G-catsm1-list")
        .toggle();
      return false;
    });
    ...
    function scroller($obj) {
      ...
      var marginTop = $obj.find("li").css("marginTop");
      $obj.find("li:lt(3)").animate({ marginTop: -height }, 600, function () {
        $(this).css("margin-top", marginTop).appendTo($obj);
      });
    }
  });
})(WJQ);
function addFavorite(url, title) {
  try {
    ...
    try {
      ...
      alert("æ¨çæµè§å¨ä¸æ¯æä¸é®æ¶èï¼è¯·æ Ctrl+D æå¨æ·»å ï¼");
    }
  }
}
/*
page: http://www.ofweek.com/
url: http://images.ofweek.com/js/ofw-global-steven.js
*/
