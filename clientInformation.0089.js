...
function FST_CheckForPreview(a, e, f, j, k, n, m, l) {
  ULShpi:;
  e = encodeURIComponent(e);
  var b = "FST_previewWindow_" + a,
    g = "FST_previewDiv_" + a,
    i = "FST_previewIcon_" + a,
    h = "FST_previewIconDiv_" + a,
    o = "FST_previewLink_" + a;
  if (document.getElementById(b) != null) {
    document.getElementById(b).style.height = j + "px";
  ...
  if (f.FST_startsWith("DO")) {
    ...
    q.getPreviewImagesDoc(null, i, h, a, g, e, c, k, l);
  }
  if (f.FST_startsWith("PP")) {
    var p = new FST_PPTPresentation();
    p.getPreviewImagesPpt(o, i, h, a, g, e, c, k, n, m, l);
  }
}
...
/*
page: http://www.datarecognitioncorp.com/
url: http://www.datarecognitioncorp.com/_layouts/search.js?rev=jVFJXbMq%2BMZOs11kluPWwQ%3D%3D
*/
