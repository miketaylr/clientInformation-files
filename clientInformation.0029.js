  ...
  try {
    ...
    if (
      ...
      if (
        ...
        var d = c.lastIndexOf(".");
        if (d > -1)
          if (c.substring(d + 1, d + 4).toLowerCase() == "pdf")
            if (window.ActiveXObject) {
              var e = new ActiveXObject("PdfFile.OpenDocuments");
              if (e != null)
                if (e.ViewDocument2(window, c)) {
                  b.returnValue = false;
...
/*
page: http://www.faculdadepitagoras.com.br/
url: http://www.faculdadepitagoras.com.br/_layouts/search.js?rev=BjP0%2BmPXUFhF7kDZmHIaVg%3D%3D
*/
