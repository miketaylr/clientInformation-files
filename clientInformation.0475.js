(function () {
  ...
  var positions = {};
  try {
    positions["-2102508032"] = [
      "#main div.properties",
      "#main-inner .block-nba.breakout",
      "article.article-default > div.editableContainer > div > div:nth-of-type(2)",
      ...
      "div#displayWindow",
      "div#displayWindow_0",
      "div#mainContent div.left-column > div.box:nth-of-type(1)",
      "div#mainContent div.left-column > div.box:nth-of-type(2)",
      "div#mainContent div.right-column > div.box:nth-of-type(1)",
      "div#mainContent div.right-column > div.box:nth-of-type(2)",
      "div#motivations > div.box:nth-of-type(1)",
      "div#p_customerservice",
      "div.modiv-galleryitem > div.wrapper > div:nth-of-type(1)",
      "div.three-columns > div.dummy",
      "div.three-columns > h2:nth-of-type(1)",
      "html > body > div.container > div.alpha",
      "html > body > div.container > div.beta",
      "section.etalage",
    ];
    positions["1583547904"] = positions["-2102508032"];
    positions["2062947360"] = positions["-2102508032"];
    positions["-65835744"] = positions["-2102508032"];
  } catch (err) {}
  (function (a) {
    ...
    (function () {
      var InteractionTypeImpl = InteractionType.extend({
        INBOUND_COOKIE_NAME: "ibc",
        INBOUND_COOKIE_PROFILE_PROPERTY: "inboundid",
        COOKIE_NR_NAME: "s_vi",
        COOKIE_NR_PROFILE_PROPERTY: "cookie_nr",
        EMPLOYEE_COOKIE_NAME: "IntSegmentInfo",
        EMPLOYEE_PROFILE_PROPERTY: "userType",
        EMPLOYEE_STATIC_VALUE: "SNS Bank medewerker",
        INTERACTION_GROUP_PROFILE_PROPERTY: "interactiongroup",
        INTERACTION_GROUP_COOKIE_NAME: "bc_igc",
        INTERACTION_GROUP_ARRAY: ["A", "B", "C"],
        init: function (a, b) {
          this.blueConicClient = a;
        ...
        onPrepare: function () {
          var a = this.blueConicClient.util.cookie.getCookie(
            this.INTERACTION_GROUP_COOKIE_NAME
          );
          a ||
            ((a = this.INTERACTION_GROUP_ARRAY[
              Math.floor(Math.random() * this.INTERACTION_GROUP_ARRAY.length)
            ]),
            this.blueConicClient.util.cookie.setCookie(
              this.INTERACTION_GROUP_COOKIE_NAME,
              a
            ));
          this.profile.setValue(this.INTERACTION_GROUP_PROFILE_PROPERTY, a);
          this.blueConicClient.util.cookie.getCookie(
            this.EMPLOYEE_COOKIE_NAME
          ) &&
            this.profile.setValue(
              this.EMPLOYEE_PROFILE_PROPERTY,
              this.EMPLOYEE_STATIC_VALUE
            );
          (a = this.blueConicClient.util.cookie.getCookie(
            this.INBOUND_COOKIE_NAME
          )) && this.profile.setValue(this.INBOUND_COOKIE_PROFILE_PROPERTY, a);
          (a = this.blueConicClient.util.cookie.getCookie(
            this.COOKIE_NR_NAME
          )) && this.profile.setValue(this.COOKIE_NR_PROFILE_PROPERTY, a);
          if ((a = this._getParameterByName("cmp")))
            this.profile.setValue("current_cmp_code", a),
              this.profile.addValue("cmp_code", a);
        },
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://sns.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.snsbank.nl/
url: https://sns.blueconic.net/frontend/static/javascript/blueconic/blueconic.min.js
*/
