...
(function (r) {
  ...
  var f = function (M, O, A, F) {
    ...
    x.set("js", c);
    if (v.checkAdsCounterLu(q, window)) {
      return;
    }
    x.set("w", O);
    x.set("h", A);
  ...
  var p = function (Q, T, z) {
    ...
    window.setTimeout(
      "(function(){if(!document.sogou_ads" +
        D +
        '_loaded){var a=new Image();a.src = "http://eff.lu.sogou.com/answer?asid=' +
        sogou_ad_id +
        "&r=" +
        x.get("rnd") +
...
/*
page: http://www.mahaixiang.cn/
url: http://images.sohu.com/cs/jsfile/js/l.js
*/
