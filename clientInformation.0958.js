(function () {
  ...
  var positions = {};
  try {
    positions["1592886752"] = [
      "#ad_bigbox1",
      "#continue-reading-waypoint",
      "#email-login",
      "#main > div.mod.bg-home-lead > div.col.bg-col-ab > div > div > div.group-alt.p-less > div:nth-child(6)",
      "#main > div.mod.bg-home-sub > div.col.bg-col-c > div:nth-child(3)",
      "#meter-limit-met-popup",
      "#newsletter-form",
      "#popular-paywall",
      "#smartbar",
      "#smartbar > a.bg-header__smartbar--message",
      "#social-login",
      ".bg-home-lead > div:nth-child(2) > div:nth-child(3) > div:nth-child(1) > h2:nth-child(1)",
      ".continue-text",
      ".subscribe-btn--regular",
      ".subscribe-btn--small",
      ".subscribe-btn--takeover",
      "contentitem#disclaimer",
      "div#contain > header > aside.bg-header__pop-up",
      "div#infinite-paywall > div.infinite-modal__black-bar > div.infinite-modal__wrapper",
      "div#social-login-thanks",
      "div.article-body",
      "div.bg-footer__top",
      "div.bg-home-lead > div.bg-col-c",
      "div.bg-newsletter-signup",
      "div.box",
      "div.inlineNewsletter__wrapper",
      "div.lead",
      "div.meter-modal-block",
      "div.mod-a > a > img",
      "div.new-articles",
      "div.recirc > div:nth-of-type(6) > div.bg-rundown",
      "div:nth-of-type(2) > div > h3",
      "fieldset.calls-to-action",
      "footer.article-footer",
      "footer.bg-footer",
      "h2.hed-section:nth-child(5)",
      "h3.hed-section",
      "html > body > div#contain > div#main > div.bg-home-lead > div.bg-col-c > div#globe-iframe-graphic--Boston-2011-2020-WebGraphics-Sports-BostonGlobe.com-2016-sports_tout-sports-tout > iframe",
      "nav.utils > ul",
      "p.bg-copy",
    ];
    positions["-1043196864"] = positions["1592886752"];
    positions["29172000"] = positions["1592886752"];
    positions["1748308800"] = [
      "#blueconic-homepage",
      "#blueconic-homepage-design1",
      "#blueconic-teal",
      ".content-newsletter-cta",
      ".content-toaster",
      ".content-well--main .grid .disabled-because-contains-blueconic-homepage-design1-position",
      ".event-list__header",
      ".headline-list--bcom",
      ".headline-list--bcom-and-bglobe",
      ".headline-list--bglobe",
      ".most-popular--bglobe",
      ".most-popular:first",
      ".newsletter-modal",
      ".well:first",
      ...
      "div.bdc-hat",
      "div.button",
      "div.grid__6-primary-content-homepage--left > div.image-tease",
      "div.grid__6-primary-content-homepage--left > div.image-tease > a.image-tease__link > div.image-tease__text",
      "div.image-tease__section",
      "div.page-footer__content",
      "div.page-header__logo",
      "div:nth-of-type(1) > div.grid > div:nth-of-type(2) > div.grid--12",
      "div:nth-of-type(2) > div.image-tease > a.image-tease__link > div.image-tease__image-container > img.content-media__image",
      "div:nth-of-type(3) > div.grid > div.grid__row > div.grid__12-sidebar > div.widget",
      "div:nth-of-type(4) > div.grid > div:nth-of-type(1)",
      "li:nth-of-type(1) > a.headline-list__link > div.headline-list__section",
      "li:nth-of-type(6) > a.section-subnav--link",
      "li:nth-of-type(7) > a.section-subnav--link",
    ];
    positions["-2019763616"] = positions["1748308800"];
    positions["-515788416"] = [
      "#blueconic-homepage",
      "#blueconic-homepage-design1",
      "#blueconic-teal",
      ...
      ".well:nth-of-type(2)",
      "div.bdc-hat",
      "div.bdc-page-content > h1",
      "div.content-well--wide",
      "div.event-list__editorial",
      "div.page-footer__content",
      ...
      "div:nth-of-type(3) > div.grid > div.grid__row > div.grid__12-sidebar > div.widget",
      "li:nth-of-type(7) > a.section-subnav--link",
      "span.event-filters__date",
    ];
    positions["-1052007648"] = ["#blueconic-homepage-design1"];
    positions["1087008096"] = positions["-1052007648"];
    positions["-1440742912"] = positions["-1052007648"];
    positions["49444512"] = [
      "#email-login",
      "#main > div.mod.bg-home-sub > div.col.bg-col-c > div:nth-child(2)",
      ".bg-header__subscribe",
      "div.bg-footer__top",
      "div.recirc > div:nth-of-type(6) > div.bg-rundown",
      "footer.bg-footer",
    ];
    positions["1384513248"] = [".newsletter-modal"];
    positions["1589509824"] = [".offer__title", "div.offer"];
    positions["1951880384"] = [
      "article#post-28575 > div.article-inner > div.text-content > a.post-title > span",
      "article#post-29388",
    ];
    positions["-562608032"] = positions["1951880384"];
    positions["-1698270496"] = [
      "contentitem#disclaimer",
      "contentitem#headline",
      "contentitem#sub-footer",
      "div#btmHelp",
      "div#listOption",
      "div#section_0",
      "div.disclaimer > p",
    ...
    positions["-936814560"] = ["div.bg-footer__top"];
    positions["-1168776928"] = ["div.main", "div:nth-of-type(1) > h2"];
    positions["713324896"] = positions["-1168776928"];
  } catch (err) {}
  (function (a) {
    ...
    (function () {
      InteractionTypeImpl = InteractionType.extend({
        ...
        onPrepare: function () {
          var B = blueConicClient.profile.getProfile();
          var A = new Date();
          var C = this._getTimeFrame(A.getHours());
          B.setValue("currenttimeofday", C);
        },
        getPreloadProperties: function () {
          return ["devicetype"];
        },
        onLoad: function () {
          var A = new Date();
          var C = this._getTimeFrame(A.getHours());
          this.blueConicClient.event.publish("currentHour", [C]);
          if (A.getDay() == 0 || A.getDay() == 6) {
            this.blueConicClient.event.publish("weekendDayCurrentHour", [C]);
          } else {
            this.blueConicClient.event.publish("weekDayCurrentHour", [C]);
          }
          var B = this.context.getProfile().getValue("devicetype");
          if (B != "Pc") {
            B = window.innerWidth < 810 ? "Phone" : "Tablet";
          }
          this.blueConicClient.event.publish("currentDevice", [B]);
        },
        _getTimeFrame: function (A) {
          return this._getHour(A) + " - " + this._getHour(A + 1);
        },
        _getHour: function (B) {
          var A = B >= 12 ? "PM" : "AM";
          B = B % 12;
      ...
      // Register listener 'engagement_input':
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://b.bostonglobemedia.com";
    var PROTOCOL =
...
/*
page: http://www.bostonglobe.com/
url: http://cdn.blueconic.net/bostonglobemedia.js
*/
