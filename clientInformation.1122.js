(function () {
  ...
  var positions = {};
  try {
    positions["-1663992032"] = [
      "#footer",
      "#personal-selection",
      "div#wrapper > section:nth-of-type(1) > div.column-row > div.column1",
      "div#wrapper > section:nth-of-type(3)",
      "div.bc-items",
      "div.top-side",
    ];
    positions["-1863531232"] = positions["-1663992032"];
    positions["-107236480"] = positions["-1663992032"];
    positions["-199112544"] = ["section:nth-of-type(1) > h2.h"];
  } catch (err) {}
  (function (a) {
  ...
  (function (
    ...
    var VERSION = "2.2.0";
    var BC_URL = "https://drukwerkdeal.blueconic.net";
    var PROTOCOL =
...
/*
page: http://www.drukwerkdeal.nl/
url: https://cdn.blueconic.net/drukwerkdeal.js
*/
